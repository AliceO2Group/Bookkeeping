 ...
 */
func UpdateRun(runNumber int32, runQuality sw.RunQuality, timeO2Start int64, timeO2End int64, timetrgStart int64, timeTrgEnd int64) (sw.RunResponse, *http.Response, error) {
