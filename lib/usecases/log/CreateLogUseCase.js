...
class CreateLogUseCase {
    ...
    async execute(dto) {
        ...
        const { tags: tagsTexts, runNumbers: serializedRunNumbers, environments, lhcFills: serializedLhcFills } = body;
        ...
        try {
            return { result: await logService.create(body, runNumbers, tagsTexts || [], environments || [], lhcFills || [], files || []) };
        } catch (e) {
            return {
                error: {
                    status: '400',
