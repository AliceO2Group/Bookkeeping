...
class UpdateRunUseCase {
    ...
    async execute(dto) {
        ...
        try {
            const { eorReasons, tags: tagsTexts, detectorsQualities, calibrationStatusChangeReason, detectorsQualitiesChangeReason } = body;
            ...
            const run = await runService.update(
                { runNumber, runId },
                {
                    ...
                    metadata: { calibrationStatusChangeReason, detectorsQualitiesChangeReason },
                },
            );
