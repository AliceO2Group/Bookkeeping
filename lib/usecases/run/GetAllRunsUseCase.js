    ...
    async execute(dto = {}) {
        ...
        if (filter) {
            ...
            if (aliceL3Current) {
                 ...
                 */
                const computedColumn = ({ literal }) => literal("alice_l3_current * (1 - 2 * (`alice_l3_polarity` = 'NEGATIVE'))");
            ...
            if (aliceDipoleCurrent) {
                 ...
                 * @return {Object} the object representing the column
                 */
                const computedColumn = ({ literal }) => literal("alice_dipole_current * (1 - 2 * (`alice_dipole_polarity` = 'NEGATIVE'))");
