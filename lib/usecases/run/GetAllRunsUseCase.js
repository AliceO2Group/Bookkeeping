    ...
    async execute(dto = {}) {
        ...
        if (filter) {
            ...
            if (muInelasticInteractionRate) {
                ...
                /**
                 * The mu of inelastic interaction rate computed from its absolute value and polarity
                 *
                 * @param {function} literal function to create an object representing a database literal expression
                 * @return {Object} the object representing the column
                 */
            ...
            for (const [property, operatorAndValue] of Object.entries(inelFilters)) {
                if (operatorAndValue) {
                    for (const [operator, value] of Object.entries(operatorAndValue)) {
