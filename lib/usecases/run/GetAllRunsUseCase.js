...
class GetAllRunsUseCase {
    ...
    async execute(dto = {}) {
        ...
        if (filter) {
            ...
            if (definitions) {
                queryBuilder.where('definition').oneOf(...definitions);
            }
        ...
        queryBuilder.include({ association: 'lhcFill' });
        queryBuilder.include({ association: 'tags' });
        queryBuilder.include({ association: 'detectors' });
