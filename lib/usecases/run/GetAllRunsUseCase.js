...
class GetAllRunsUseCase {
    ...
    async execute(dto = {}) {
        ...
        if (filter) {
            ...
            if (definitions) {
                const physics = definitions.includes('physics');
                const cosmic = definitions.includes('cosmic');
                const technical = definitions.includes('technical');
                const synthetic = definitions.includes('synthetic');
