...
class GRPCServer {
     ...
     * @param {O2TokenService} [o2TokenService] if specified, gRPC request will require token authentication
     */
    constructor(o2TokenService) {
        ...
        const preProcessors = [];
        if (o2TokenService) {
            preProcessors.push(new AuthenticationPreProcessor(o2TokenService));
            preProcessors.push(new AuthorizationPreProcessor());
        }
