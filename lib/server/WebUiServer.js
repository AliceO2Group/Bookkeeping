...
class WebUiServer {
    ...
    async setupStaticPaths() {
        ...
        // const capp = express();
        const capp = this.http.routerStatics;
        ...
        // vite.middlewares.use(this.http.app);
        vite.middlewares.use(this.http.routerStatics);
        // vite.listen();
        this.http.app.use(vite.middlewares);
        // capp.use(vite.middlewares);
        // capp.use('/', async (req, res, next) => {
