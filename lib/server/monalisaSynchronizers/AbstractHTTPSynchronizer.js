...
class AbstractHTTPSynchronizer {
    ...
    async syncPerEndpoint(url, context = {}) {
        return await jsonRequest(url, this.httpOptions)
    ...
    /**
     * ProcessRawResponse - used to preprocess response to custom format, remove unnecessary data
     * @abstractMethod
