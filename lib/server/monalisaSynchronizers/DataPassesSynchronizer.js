...
class DataPassesSynchronizer {
     ...
     * @param {DataPass} dataPass data pass data
     ...
     */
    _needToUpdateDataPass(dataPass, lhcPeriod, context) {
     ...
     * @param {object} context context of synchronization
     * @return {[Partial<DataPass>, Partial<LhcPeriod>][]} adjusted data
     */
    async _processRawResponse(rawResponse, context) {
        return Object.entries(rawResponse)
            ...
            .filter(([dataPass, lhcPeriod]) => this._needToUpdateDataPass(dataPass, lhcPeriod, context))
     ...
     * @param {[Partial<DataPass>, Partial<LhcPeriod>][]} data data passes and correspoding lhc periods list
