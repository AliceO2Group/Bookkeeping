...
class DataPassesSynchronizer {
    /**
     * Constructor
     * @param {URL} baseUrl url to fetch data from
     * @param {byte[]} pfx bytes of pkcs12 certificate
     * @param {string} passphrase to the certificate
     * @param {number} yearLowerLimit indicates how old data are accepted,
     ...
     * Fetch lastRun information tellling whether some data pass need to be updated
