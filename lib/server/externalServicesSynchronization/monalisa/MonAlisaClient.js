 ...
 * @property {number} reconstructedEvents
 ...
 * @property {string} anchor_production
 * @property {string} anchor_pass
 * @property {string} runList
 * @property {string} generator
 * @property {string} requested_events
 * @property {string} generated_events
 * @property {string} output_size
 */

/**
 * @typedef SimulationPassAssociations
 * @property {string[]} lhcPeriods
 * @property {string[]} dataPassesSuffixes
 * @property {number[]} runNumbers
 */
...
class MonAlisaClient {
     ...
     * @param {Agent} [configuration.agent] HTTPs agent to use when sending requests
     */
    constructor({
        dataPassesUrl,
        dataPassDetailsUrl,
     ...
     *  and from LHC Periods not older than specified by yearLowerLimit options of constructor
     *
