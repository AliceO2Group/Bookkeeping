...
module.exports = {
    ...
    children: [
        ...
        },
        {
            method: 'get',
            path: 'beamTypes',
            controller: LhcFillsController.listBeamsTypes,
        },
        {
            path: 'stable-beams-ended-within',
            method: 'get',
            controller: LhcFillsController.getAllLhcFillsWithStableBeamsEndedInPeriodHandler,
        },
        {
            path: ':fillNumber',
            children: [
                ...
                },
                {
                    path: 'logs',
                    method: 'get',
                    controller: LhcFillsController.getAllLhcFillLogsHandler,
                },
            ],
        },
    ],
