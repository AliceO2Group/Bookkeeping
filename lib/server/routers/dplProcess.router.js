...
exports.dplProcessRouter = {
    ...
    children: [
        ...
        },
        {
            method: 'get',
            path: '/hosts',
            controller: DplProcessController.getAllHostsWithExecutedProcessByRunAndDetectorHandler,
        },
        {
            method: 'get',
            path: '/executions',
            controller: DplProcessController.getAllProcessExecutionByRunAndDetectorAndHostHandler,
        },
    ],
};
