...
class MonALISASynchronizer {
    ...
    async synchronizeDataPassesFromMonALISA() {
        ...
        try {
            this.dataPassesLastRunNumber = await this._getAllDataPassesLastRunNumber();
            ...
            this.dataPassesLastRunNumber = null;
        }
    }
    ...
    _doesDataPassNeedUpdate(dataPass) {
        const isLastRunNumberSame = dataPass.lastRun && dataPass.lastRun === this.dataPassesLastRunNumber[dataPass.name];
