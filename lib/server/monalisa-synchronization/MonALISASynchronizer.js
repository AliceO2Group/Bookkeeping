        ...
        try {
            ...
            const transactionablePipeline = async (simulationPassData) => {
                const { properties: simulationPassProperties,
                    asociations: { lhcPeriods, dataPassesSuffixes, runNumbers } } = simulationPassData;
                ...
                const simulationPassDB = await SimulationPassRepository.upsert(simulationPassProperties);
