...
class MonAlisaSynchronizer {
        ...
        try {
            ...
            const monAlisaDataPassesVersionsToBeUpdated = allMonAlisaDataPassesVersions
                .filter((monalisaDataPassVersion) =>
                    this._doesDataPassVersionNeedUpdate(monalisaDataPassVersion, descriptionToLastSeenAndId));
    ...
    async _updateDeletedDataPassVersions(descriptionToLastSeenAndId, allMonAlisaDataPassesVersions) {
        const allDBDataPassesVersionsDescriptions = Object.values(descriptionToLastSeenAndId);
        ...
        const deletedDataPassesVersionsIds = deletedDataPassesVersionsDescriptions.map((description) =>
            descriptionToLastSeenAndId[description].id);
