...
class MonAlisaSynchronizer {
    ...
    constructor(monAlisaClient) {
        this.logger = LogManager.getLogger(MonAlisaSynchronizer.name);
    ...
    async _synchronizeDataPassesFromMonAlisa() {
        try {
            ...
            this.logger.debugMessage('Synchronization of Data Passes completed');
        } catch (error) {
    ...
    async _updateDeletedDataPassVersions(descriptionToLastSeenAndId, allMonAlisaDataPassesVersions) {
        ...
        const deletedDataPassesVersionsDescriptions =
            allDBDataPassesVersionsDescriptions.filter((description) => !allFechedDataPassesVersionsDescriptions.has(description));
    ...
    async _synchronizeSimulationPassesFromMonAlisa() {
        try {
            ...
            this.logger.debugMessage('Synchronization of Simulation Passes completed');
        } catch (error) {
