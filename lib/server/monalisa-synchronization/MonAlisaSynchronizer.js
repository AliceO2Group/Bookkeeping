...
class MonAlisaSynchronizer {
    ...
    async _synchronizeDataPassesFromMonAlisa() {
        try {
            ...
            const allDBDataPassesVersionsDescriptions = Object.values(dataPassVersionsLastSeen)
                .flatMap((descriptionToLastSeen) => Object.keys(descriptionToLastSeen));
            const allFechedDataPassesVersionsDescriptions = new Set(monAlisaDataPassesVersions.map(({ description }) => description));
            ...
            const descriptionToId = Object.fromEntries(Object.values(dataPassVersionsLastSeen)
            ...
            await DataPassRepository.updateAll({ deletedFromMl: true }, { where: { id: { [Op.in]: deleteDataPassesVersionsIds } } });
