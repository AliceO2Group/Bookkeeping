 ...
 *
 * @return {Promise<void>} resolve once the environments and runs has been cleaned
 * @deprecated
 */
exports.handleLostRunsAndEnvironments = async () => {
    ...
    if (existingEnvironmentsResponse.ok) {
        ...
        await transitionToErrorLostEnvironments(environmentIdsToKeep, modificationTime);
        await setO2StopOfLostRuns(runNumbersToKeep, modificationTime);
    } else {
