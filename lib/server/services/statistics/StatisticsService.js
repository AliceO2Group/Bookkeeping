...
class StatisticsService {
     ...
     *
     * @param {Period} period the period of statistics to query
     * @return {Promise<{tag: string, count: number}[]>} the resulting histogram
     */
    ...
    /**
     * Return the list of end of runs occurrences in runs
     *
     * @param {Period} period the period of statistics to query
     * @return {Promise<{category: string, title: string, count: number}[]>} the resulting histogram
     */
    ...
    /**
     * Return the list of environment history combinations and their occurrences
     *
     * @param {Period} period the period of statistics to query
     * @return {Promise<{history: string, count: number}[]>} the resulting histogram
     */
