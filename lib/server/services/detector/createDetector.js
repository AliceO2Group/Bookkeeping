 ...
 * @param {boolean} skipDuplicateCheck if true, no check will be done to see if the given detector already exists
 ...
 */
exports.createDetector = async (detector, skipDuplicateCheck = false) => {
    const { name } = detector;
