 ...
 */
exports.formatEcsEosReportTypeSpecific = async ({ environments, runComments }) => formatEcsSpecificEosReport(environments.length > 0
    ? environments.map((environment) => formatEnvironment(environment, runComments)).join('\n\n')
    : '-');
 ...
 */
const formatEnvironment = (environment, runComments) => {
