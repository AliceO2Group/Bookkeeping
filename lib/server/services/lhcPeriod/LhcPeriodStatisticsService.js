...
const { NonPhysicsProductionsNamesWords } = require('../../../domain/enums/NonPhysicsProductionsNamesRoles.js');
...
class LhcPeriodStatisticsService {
    ...
    async getAllForPhysicsRuns({
        ...
        if (filter) {
            const { ids, names, years, pdpBeamTypes } = filter;
            if (ids) {
                ...
                const targetIds = (await LhcPeriodStatisticsRepository.findAll({
                    ...
                    include: {
                        ...
                        include: {
                            ...
                            required: true,
                            where: {
                                pdpBeamType: { [Op.in]: pdpBeamTypes },
    ...
    prepareQueryBuilder() {
        return dataSource.createQueryBuilder()
            ...
            .includeAttribute({
                query: (sequelize) => sequelize.fn(
                    'COUNT',
                    sequelize.fn('DISTINCT', sequelize.col('lhcPeriod->dataPasses->anchoredSimulationPasses.id')),
                ),
            ...
            .include({
                ...
                include: [
                    ...
                    },
                    {
                        ...
                        where: {
                            name: { [Op.and]: [
                                { [Op.notLike]: `%${NonPhysicsProductionsNamesWords.TEST}%` },
                                { [Op.notLike]: `%${NonPhysicsProductionsNamesWords.DEBUG}%` },
                            ] },
                        },
