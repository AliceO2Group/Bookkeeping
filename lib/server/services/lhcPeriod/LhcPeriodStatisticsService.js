 ...
 */
const DISTINCT_ENERGIES_IN_STATISTICS_QUERY = `
...
const PDP_BEAM_TYPES_IN_STATISTICS_QUERY = `
...
class LhcPeriodStatisticsService {
    ...
    async getByIdentifier({ id, name }) {
        ...
        queryBuilder.includeAttribute({
            query: DISTINCT_ENERGIES_IN_STATISTICS_QUERY,
            alias: 'distinctEnergies',
        });
        queryBuilder.includeAttribute({
            query: PDP_BEAM_TYPES_IN_STATISTICS_QUERY,
            alias: 'beamType',
        });
    ...
    async getAllForPhysicsRuns({
            ...
            for (const property in sort) {
                ...
                switch (property) {
                    ...
                    case 'year':
                        ...
                        break;
                    case 'beamType':
                        expression = (sequelize) => sequelize.literal(PDP_BEAM_TYPES_IN_STATISTICS_QUERY.query);
                        break;
                    default:
        ...
        if (filter) {
            ...
            if (beamTypes) {
                queryBuilder.literalWhere(
                    `${PDP_BEAM_TYPES_IN_STATISTICS_QUERY} IN (:beamTypes)`,
                    { beamTypes },
                );
            }
        }
