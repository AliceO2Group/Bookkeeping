...
class LhcPeriodStatisticsService {
    ...
    async getById({ id, name }) {
        ...
        return lhcPeriodStatisticsAdapter.toEntity(await LhcPeriodStatisticsRepository.findOne({ where: criteria }));
    }

    /**
     * Get all lhc periods with statistics
     * @param {Object} query definition of request
     * @returns {CountedData} result
     */
    async getAllForPhysicsRuns(query = {}) {
