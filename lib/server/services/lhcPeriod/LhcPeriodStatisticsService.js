...
const { repositories: { LhcPeriodStatisticsRepository }, sequelize } = require('../../../database');
        ...
        return dataSource.createQueryBuilder()
            ...
            .include((sequelize) => ({
                ...
                include: [
                    {
                        association: 'runs',
                        attributes: [[sequelize.fn('count', sequelize.fn('distinct', sequelize.col('lhcPeriod->runs.run_number'))), 'count']],
                        where: {
            ...
            .groupBy((sequelize) => sequelize.literal('LhcPeriodStatistics.id'));
    }
}
