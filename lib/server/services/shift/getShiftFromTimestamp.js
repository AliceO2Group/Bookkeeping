...
const PARSABLE_DATE_FORMAT = 'fr-CH';
...
const getShifterToUTCOffset = (date) => {
    const shifterLocaleDate = date.toLocaleString(PARSABLE_DATE_FORMAT, { timeZone: SHIFTER_TIMEZONE });
 ...
 */
const getShifterHour = (date) => parseInt(date.toLocaleTimeString(PARSABLE_DATE_FORMAT, { timeZone: SHIFTER_TIMEZONE }).slice(0, 2), 10);
