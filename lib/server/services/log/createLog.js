...
const { NotificationService, LogManager } = require('@aliceo2/web-ui');
...
const logger = LogManager.getLogger('log-creation');

/**
 * @type {NotificationService|null}
 */
const notification = KafkaConfig.brokers ? new NotificationService(KafkaConfig) : null;
