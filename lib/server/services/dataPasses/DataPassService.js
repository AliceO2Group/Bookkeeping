 ...
 * @return {void}
 * @throws {AccessDeniedError} when roles don't suffice
 */
...
class DataPassService {
     ...
     * @param {object} relations information related to setting of GAQ detectors
     * @param {string[]} relations.user.roles roles of the user setting GAQ detectors
