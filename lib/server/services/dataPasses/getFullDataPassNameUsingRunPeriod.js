 ...
 *
 * @param {*} passNameWithoutLhcPeriod data pass name suffix, e.g. apass1, cpass0
 * @param {*} runNumber run number
 * @return {string} data pass name
 */
exports.getFullDataPassNameUsingRunPeriod = async (passNameWithoutLhcPeriod, runNumber) => {
    ...
    return `${lhcPeriods.name}_${passNameWithoutLhcPeriod}`;
};
