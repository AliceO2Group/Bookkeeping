...
class RunService {
    ...
    async create(newRun, relations) {
        ...
        newRun.userIdO2Start = await processUser(userO2Start);
        newRun.userIdO2Stop = await processUser(userO2Stop);
    ...
    async update(identifier, payload) {
        ...
        // Update the users for the run
        runPatch.userIdO2Start = await processUser(userO2Start);
        runPatch.userIdO2Stop = await processUser(userO2Stop);
