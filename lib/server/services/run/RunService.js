...
class RunService {
     ...
     * @param {string} [payload.relations.lhcPeriod] if not null, the name of lhc period for which the run should be assigned
    ...
    async update(identifier, payload) {
        ...
        const { tagsTexts = null, eorReasons = null, runTypeName = null,
            userIdentifier = {}, detectorsQualities = [], lhcPeriod: lhcPeriodName = null } = relations;
