...
const { getRunDefinition, RunDefinition } = require('../../../services/getRunDefinition.js');
...
exports.updateRun = async (identifier, runPatch, tags, eorReasons, user) => {
    ...
    const runModel = await getRunOrFail(identifier, (queryBuilder) => queryBuilder.include('lhcFill'));
