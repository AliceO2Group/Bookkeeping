...
class QualityControlFlagService {
    ...
    async createVerification({ qualityControlFlagId, comment, userId, externalUserId }) {
        ...
        // Insert
        return QualityControlFlagVerificationRepository.insert({
    ...
    async create(parameters) {
        ...
        // Insert
        return QualityControlFlagRepository.insert({
            timeStart,
            timeEnd,
            comment,
            provenance,
     ...
     * @return {Promise<{count: number, rows: QualityControlFlag[]}>} promise
     */
