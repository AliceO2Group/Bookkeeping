...
/**
 * Detectors which are not physcial, but which for QC flag can be created
 */
const VIRTUAL_DETECTORS_FOR_ASYNC_QC = {
    GLO: 'GLO',
};
        ...
        const runInclude = [
            {
                ...
                through: { attributes: [] },
                attributes: [],
                required: dplDetectorName !== VIRTUAL_DETECTORS_FOR_ASYNC_QC.GLO,
            },
        ];
