...
class QcFlagService {
    ...
    async delete(id) {
        return dataSource.transaction(async () => {
            ...
            const adaptedQcFlag = qcFlagAdapter.toEntity(qcFlag);
            this._logger.infoMessage(`Delete QC flag with parameters: ${JSON.stringify(adaptedQcFlag)}`);

            return adaptedQcFlag;
        });
    }
