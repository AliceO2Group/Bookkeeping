...
class QcFlagService {
    ...
    async createForDataPass(parameters, relations = {}) {
        ...
        return dataSource.transaction(async () => {
            ...
            if (fromTime && (fromTime < targetRun.timeTrgStart.getTime() || targetRun.timeTrgEnd.getTime() < fromTime)
                || toTime && (toTime < targetRun.timeTrgStart.getTime() || targetRun.timeTrgEnd.getTime() < toTime)) {
                // eslint-disable-next-line max-len
