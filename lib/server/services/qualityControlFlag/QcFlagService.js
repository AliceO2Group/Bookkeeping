...
class QcFlagService {
    ...
    /**
     * Update given effective periods of some QC flags
     * @param {Period} intersectingPeriod newer QC flag period
     * @param {QcFlagEffectivePeriod} periods periods to updated or discarded
    ...
    async delete(id) {
        return dataSource.transaction(async () => {
            ...
            // Update effective periods of older flags
