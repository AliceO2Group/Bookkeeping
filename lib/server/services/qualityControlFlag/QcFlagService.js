 ...
 * @property {boolean} mcReproducible - states whether some Limited Acceptance MC Reproducible flag applies
 */
...
/**
 * Id of flag type in DB
 */
const LIMITED_ACCEPTANCE_MC_REPORODUCIBLE_FLAG_TYPE_ID = 5;
    ...
    async getQcFlagsSummary({ dataPassId, simulationPassId }) {
        ...
        queryBuilder
            ...
            .set('attributes', (sequelize) => [
                ...
                [
                    sequelize.literal(`SUM( \`QcFlag\`.flag_type_id = ${LIMITED_ACCEPTANCE_MC_REPORODUCIBLE_FLAG_TYPE_ID} ) > 0`),
                    'mcReproducible',
                ],
            ])
            .groupBy('runNumber')
