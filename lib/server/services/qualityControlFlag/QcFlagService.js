...
class QcFlagService {
     ...
     * @param {DataPassIdentifier} [scope.dataPassIdentifier] associated dataPass' id
     * @param {SimulationPassIdentifier} [scope.simulationPassIdentifier] associated dataPass' id
