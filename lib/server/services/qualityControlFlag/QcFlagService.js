 ...
 * @property {boolean} limitedAcceptanceMcReproduciblePresent - states whether some Limited Acceptance MC Reproducible flag applies
 */
const QC_SUMMARY_PROPERTIES = {
    ...
    limitedAcceptanceMcReproduciblePresent: 'limitedAcceptanceMcReproduciblePresent',
};
    ...
    async getQcFlagsSummary({ dataPassId, simulationPassId }) {
        ...
        queryBuilder
            ...
            .set('attributes', (sequelize) => [
                ...
                [
                    sequelize.literal('SUM( `QcFlag`.flag_type_id = 5 ) > 0'),
                    'limitedAcceptanceMcReproduciblePresent',
                ],
            ])
            .groupBy('runNumber')
        ...
        const runDetectorSummaryList = (await QcFlagRepository.findAll(queryBuilder))
            .map((summaryDb) =>
                ({
                    ...
                    limitedAcceptanceMcReproduciblePresent: Boolean(summaryDb.get('limitedAcceptanceMcReproduciblePresent')),
                }));
        ...
        for (const runDetectorSunmmary of runDetectorSummaryList) {
            ...
            summary[runNumber][dplDetectorId][QC_SUMMARY_PROPERTIES.limitedAcceptanceMcReproduciblePresent] =
                summary[runNumber][dplDetectorId][QC_SUMMARY_PROPERTIES.limitedAcceptanceMcReproduciblePresent]
                    || limitedAcceptanceMcReproduciblePresent;
