        ...
        return dataSource.transaction(async () => {
            ...
            while (flagsCreatedBeforeRemovedFlag.length) {
                ...
                for (const potentiallyOverlapingFlag of [...flagsCreatedBeforeRemovedFlag, ...flagsCreatedAfterRemovedFlag]) {
                    const { from, to, createdAt, runNumber, dplDetectorId } = potentiallyOverlapingFlag;
                    ...
                    await this._removeEffectivePeriodsAndPeriodIntersection(potentiallyOverlapingFlag, overlapingEffectivePeriods);
                }
            }
            ...
            for (const newestFlagToBeUpdatedIndex in flagsCreatedBeforeRemovedFlag) {
                ...
                for (const updatingFlag of [...updatingFlagsCreatedBefore, ...flagsCreatedAfterRemovedFlag]) {
                    ...
                    await this._removeEffectivePeriodsAndPeriodIntersection(updatingFlag, effectivePeriods);
                }
            }
