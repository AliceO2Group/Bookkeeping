...
const { qcFlagTypesSummary } = require('../../views/qcFlagTypes/summary.js');
...
class QcFlagTypeService {
    ...
    async getAll({ filter, sort, limit, offset } = {}) {
        ...
        queryBuilder.selectAttributes([...qcFlagTypesSummary.attributes]);
        queryBuilder.includeAll([...qcFlagTypesSummary.include]);
        ...
        return { count, rows: rows.map(qcFlagTypeAdapter.toSummary) };
    }
