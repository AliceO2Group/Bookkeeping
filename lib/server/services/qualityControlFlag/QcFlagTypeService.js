...
class QcFlagTypeService {
     ...
     * @param {object} [options] options - filtering, sorting, pagination
     * @param {object} [options.filter] filtering configuration object that is to be applied
    ...
    async getAll({ filter, sort, limit, offset } = {}) {
        ...
        if (filter) {
            /**
             * @typedef {Object} QcFlagTypeFilter
             * @property {number[]} [options.filter.ids] quality control flag ids to filter with
             * @property {boolean} [options.filter.bad] quality control flag boolean to filter bad or not-bad QC flags
             * @property {boolean} [options.filter.archived] quality control flag boolean to filter archived or not-archived QC flags
             * @property {string[]} [options.filter.names] quality control flag type name to filter with, single token is treated as pattern
             * @property {string[]} [options.filter.methods] quality control flag type method to filter with, single token is treated as pattern
             *
             */
