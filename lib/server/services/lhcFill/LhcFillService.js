...
const { getAllLhcFillsByLogId } = require('./getAllLhcFillsByLogId.js');
...
class LhcFillService {
    ...
    async getAllByLogId(logId) {
        ...
        const lhcFill = await getAllLhcFillsByLogId(id);
        return lhcFill ? lhcFill.map((env) => lhcFillAdapter.toEntity(env, false)) : null;
    }
