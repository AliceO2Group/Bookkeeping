...
class LhcFillService {
    ...
    /**
     * Return the list of LHC fills with stable beam that ended in the given period
     *
     ...
     */
    async getAllWithStableBeamsEndedInPeriod(period) {
        const fillNumbers = await LhcFillRepository.getFillNumbersWithStableBeamsEndedInPeriods(period);
