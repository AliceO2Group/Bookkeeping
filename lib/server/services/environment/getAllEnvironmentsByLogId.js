...
/**
 * Find and return an environment model by its log id
 *
 * @param {string} logId the log id to find environments
 ...
 */
exports.getAllEnvironmentsByLogId = (logId, qbConfiguration = null) => {
    const queryBuilder = new QueryBuilder();

    queryBuilder.where('log_id').is(logId);
