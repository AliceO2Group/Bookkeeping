...
const { utilities: { QueryBuilder } } = require('../../../database/index.js');
...
/**
 * Find and return a detector model by its id or name
 *
 ...
 */
exports.getDetector = ({ detectorId, detectorName }) => {
    ...
    if (detectorId) {
        ...
        throw new BadParameterError('Can not find without detector id or name');
    }
