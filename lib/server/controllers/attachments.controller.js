 ...
 */
const { attachment: { CreateAttachmentUseCase } } = require('../../usecases');
const { dtos: { CreateAttachmentDto } } = require('../../domain');
const { dtoValidator } = require('../utilities');

/**
 * Find all Attachments tah belong to a certain log item
 *
 ...
 * @returns {undefined}
 */
const attachmentOfLog = (request, response, next) => {
