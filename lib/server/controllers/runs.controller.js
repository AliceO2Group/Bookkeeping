...
const { convertRunLhcPeriod, convertNestedRunLhcPeriod } = require('../utilities/convertRunLhcPeriod');
...
const listRuns = async (request, response) => {
    ...
    convertNestedRunLhcPeriod(runs, 'run');
...
const getLogsByRunId = async (request, response, next) => {
    ...
    const logs = await new GetLogsByRunUseCase()
        .execute(value);
    convertNestedRunLhcPeriod(logs, 'log');
...
const getFlpsByRunId = async (request, response, next) => {
    ...
    convertNestedRunLhcPeriod(flps, 'flp');
