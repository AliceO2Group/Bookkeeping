...
/**
 * Set express response status and body to inform the client that no runs was found with the given identifier.
 * @param {object} response The *response* object represents the HTTP response that an Express app sends when it gets an
 *                          HTTP request.
 * @param {RunIdentifier} runIdentifier run identifier
 * @return {void}
 */
