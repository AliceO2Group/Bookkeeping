...
/**
 * Send error to client that run with given identifier was not found.
 * @param {object} response The *response* object represents the HTTP response that an Express app sends when it gets an
 *                          HTTP request.
 * @param {number} [runIdentifier.runId] run id
 * @param {number} [runIdentifier.runNumber] run number
 * @return {void}
 */
