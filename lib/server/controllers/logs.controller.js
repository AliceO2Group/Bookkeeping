 ...
 * @returns {undefined}
 */
const createLog = async ({ body, params, query }, response, next) => {
    const { value, error } = CreateLogDto.validate({ body, params, query });
 ...
 * @returns {undefined}
 */
const listLogs = async ({ body, params, query }, response, next) => {
    const { value, error } = GetAllLogsDto.validate({ body, params, query });
 ...
 * @returns {undefined}
 */
const getLogById = async ({ body, params, query }, response, next) => {
    const { value, error } = GetLogDto.validate({ body, params, query });
