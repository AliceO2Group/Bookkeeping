...
const getRootLogs = async (request, response) => {
    ...
    if (value) {
        try {
            ...
            const { count, logs } = await logService.getAllRootLogs({ ...value, query: { ...value.query, page: { limit } } });
