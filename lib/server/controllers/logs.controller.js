...
const { convertNestedRunLhcPeriod } = require('../utilities/convertRunLhcPeriod');
...
const createLog = async (request, response) => {
    ...
    convertNestedRunLhcPeriod(result, 'log');
    if (error) {
...
const getLogTree = async (request, response, next) => {
    ...
    convertNestedRunLhcPeriod(log, 'log');
    log?.children?.forEach((childLog) => convertNestedRunLhcPeriod(childLog, 'log'));
