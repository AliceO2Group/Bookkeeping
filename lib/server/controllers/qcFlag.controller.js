    ...
    if (validatedDTO) {
        try {
            ...
            for (const flag of flags) {
                ...
                if (createdFlag && flag.verify) {
                    const verifiedFlag = await qcFlagService.verifyFlag({ flagId: createdFlag.id, comment: null }, relations);
                    createdFlags.push(verifiedFlag);
                } else {
