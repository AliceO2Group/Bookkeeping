...
class GRPCRunController {
    ...
    async Update(runPatchRequest) {
        ...
        /*
         *TODO: error with postman: object expected for user_o2_start, why?
         *But it is updating the fields.
         *
         *TODO: then do this for create as well, see RunService.update how it is handled there.
         */
        ...
        return this.runToGRPC(await this.runService.update(
            { runNumber },
            {
                ...
                relations: {
                    ...
                    user_o2_start: relations.user_o2_start,
                    user_o2_stop: relations.user_o2_stop,
                },
            },
        ));
    }
    ...
    gRPCToRunAndRelations(gRPCRunRequest) {
        ...
        if (gRPCRunRequest.user_o2_start) {
            relations.user_o2_start = gRPCRunRequest.user_o2_start;
            delete gRPCRunRequest.user_o2_start;
        }
        if (gRPCRunRequest.user_o2_stop) {
            relations.user_o2_stop = gRPCRunRequest.user_o2_stop;
            delete gRPCRunRequest.user_o2_stop;
        }
