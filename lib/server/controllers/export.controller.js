...
const GetAllLhcFillsDto = require('../../domain/dtos/GetAllLhcFillsDto.js');
...
const exportData = async (request, response) => {
    ...
    switch (value.query.exportComponent) {
        case ExportComponents.LHC_FILLS:
            ...
            // Set query of childRequest to the exportDTOQuery of the parent request.
            childRequest.query = request.query.exportDTOQuery ?? {};
            // Remove export specific query parameters from child request.
            delete childRequest.query.exportDTOQuery;
            delete childRequest.query.exportComponent;
            delete childRequest.query.exportFormat;
            console.log(childRequest.query);
            break;
