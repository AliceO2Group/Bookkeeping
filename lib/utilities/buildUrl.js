...
exports.buildUrl = (baseURL, parameters) => {
    ...
    const formatAndPushQueryParameter = (key, value) => {
        ...
        if (typeof value === 'object' && value !== null) {
            for (const [subKey, subValue] of Object.entries(value).sort(([a], [b]) => a.localeCompare(b))) {
    ...
    for (const [key, parameter] of Object.entries(parameters).sort(([a], [b]) => a.localeCompare(b))) {
