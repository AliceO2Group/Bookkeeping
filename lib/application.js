...
class BookkeepingApplication {
    ...
    constructor() {
        ...
        this.monALISASynchronizer = null;
    }
    ...
    async run() {
        ...
        try {
            ...
            if (monalisaConfig.enableSynchronization) {
                this.monALISASynchronizer = await this.createMonALISASynchronizer();
                this.scheduledProcessesManager.schedule(
                    () => this.monALISASynchronizer.synchronizeDataPassesFromMonALISA(),
                    {
                        wait: 10 * 1000,
    ...
    /**
     * Houskeeping method, it wraps @see handleLostRunsAndEnvironments and log its results
