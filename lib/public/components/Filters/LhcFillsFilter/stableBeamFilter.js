 ...
 */
export const toggleStableBeamOnlyFilter = (toggleFilterModel, name, radioButtonMode = false) => {
    if (radioButtonMode) {
    ...
    return switchInput(toggleFilterModel.isToggled(), (newState) => toggleFilterModel.toggle(newState), { labelAfter: name });
};
