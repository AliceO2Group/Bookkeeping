...
export class TimeRangeFilterModel extends FilterModel {
    ...
    constructor(value, configuration) {
        ...
        this._fromTimeInputModel.observe(() => {
            this._toTimeInputModel.min = this._fromTimeInputModel.value ? this._fromTimeInputModel.value + TIME_STEP : undefined;
        });
        ...
        this._toTimeInputModel.observe(() => {
            this._fromTimeInputModel.max = this._toTimeInputModel.value ? this._toTimeInputModel.value - TIME_STEP : undefined;
        });
    ...
    get normalized() {
        return {
            from: this._fromTimeInputModel.value,
            to: this._toTimeInputModel.value,
        };
    }

    /**
     * States if the filter value is value
     *
