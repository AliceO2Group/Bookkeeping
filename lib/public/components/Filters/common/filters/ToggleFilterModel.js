...
export class ToggleFilterModel extends SelectionModel {
     ...
     * @returns {boolean} true if the current toggle state is equal to the default toggle state.
     */
    get isEmpty() {
        return this.current === this._toggledByDefault;
    }
}
