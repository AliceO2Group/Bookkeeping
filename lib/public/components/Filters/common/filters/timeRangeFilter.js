 ...
 *
 * @param {function} onChange function called with the clicked period
...
export const timeRangeFilter = (timeRangeFilterModel) => dropdown(
    ...
    h('.flex-row.time-range-selector', [
        ...
        h(
            ...
            [
                yearsOptions({ onChange: (period) => timeRangeFilterModel.setValue(period) }),
                monthsOptions({ onChange: (period) => timeRangeFilterModel.setValue(period) }),
                h(
