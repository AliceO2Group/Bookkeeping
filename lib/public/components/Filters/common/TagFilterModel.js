 ...
 */
import { PickerModel } from '../../common/picker/PickerModel.js';
...
export class TagFilterModel extends Observable {
     ...
     * @constructor
     *
     * @param {SelectionOption[]} defaultSelection the list of tags selected by default
    ...
    constructor(defaultSelection = [], defaultCollapse = true, defaultCombinationOperator = CombinationOperation.AND) {
        super();
        this._pickerModel = new PickerModel(defaultSelection, defaultCollapse);
