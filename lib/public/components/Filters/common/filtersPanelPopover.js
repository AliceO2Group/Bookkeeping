 ...
 * @param {bool} [filteringModel=false] if the component is rendered as a regular button with text or as a component with an 'X' icon
...
const resetFiltersButton = (filteringModel, isIcon = false) => {
    ...
    return isIcon
        ? h('.clear-filter-icon.b1.b-danger.btn-group-item.last-item', attributes, 'X')
