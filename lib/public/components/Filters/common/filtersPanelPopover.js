        ...
        Object.entries(columns)
            .filter(([_, column]) => {
                ...
                return column.filter
                    && (applyProfile(column, appliedProfile, columnProfiles)
 ...
 * @param {string} [configuration.profile] specify for which columns filtering is enabled using active columns profiles
