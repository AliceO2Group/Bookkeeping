...
import { PopoverPreConfiguration } from '../../common/popover/popoverPreConfigurations.js';
...
const filtersToggleContent = (filteringModel, columns) => h('.w-l.h-100.scroll-y', [
    ...
    Object.entries(columns).reduce((accumulator, [columnKey, column]) => {
        if (column.filter) {
            accumulator.push([
