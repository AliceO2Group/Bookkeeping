 ...
 */
const filtersToggleContent = (filteringModel, columns) => h('.w-l.scroll-y', h('.pv2', [
    h('.flex-row', [
        h('.f4.ph3.pv2', 'Filters'),
        filteringModel.isAnyFilterActive() ? h('.ph3', h('button#reset-filters.btn.btn-danger.mt2', {
