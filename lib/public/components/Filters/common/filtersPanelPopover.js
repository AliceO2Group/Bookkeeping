 ...
 * @param configuration.classes css classes
 * @return {Component} the filters section
 */
export const filtersSection = (filteringModel, columns, { profile: appliedProfile = profiles.none } = {}) =>
    h('.flex-column.g2', [
...
const filtersToggleContent = (
    ...
    filtersSection(filteringModel, columns, configuration),
]);
