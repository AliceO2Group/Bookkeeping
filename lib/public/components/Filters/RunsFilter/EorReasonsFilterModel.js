...
export class EorReasonFilterModel extends Observable {
    ...
    getFilterQueryParams() {
        return {
            ...this.filterEorReason.category !== '' && { 'filter[endOfRunReason][category]': this.filterEorReason.category },
            ...this.filterEorReason.title !== '' && { 'filter[endOfRunReason][title]': this.filterEorReason.title },
            ...this.filterEorReason.description !== '' && { 'filter[endOfRunReason][description]': this.filterEorReason.description },
        };
    }
