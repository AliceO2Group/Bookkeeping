    ...
    return h('', [
        ...
        h('input.w-50.mv1', {
            ...
            onchange: (e) =>{
                ...
                model.runs.setO2startFilter('FromTime', e.target.value, e.target.validity.valid);
            },
            oninput: (e) => model.runs.setO2startFilterWithDebounce('FromTime', e.target.value, e.target.validity.valid),
        ...
        h('input.w-50.mv1', {
            ...
            placeholder: TIME_FORMAT,
            max: o2from == o2to ? o2fromTime : '00:01',
            min: today == o2from ? now : '23:59',
            value: o2toTime,
            onchange: (e) => model.runs.setO2startFilter('ToTime', e.target.value, e.target.validity.valid),
            oninput: (e) => model.runs.setO2startFilterWithDebounce('ToTime', e.target.value, e.target.validity.valid),
        }, ''),
    ]);
};
