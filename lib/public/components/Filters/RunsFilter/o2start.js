    ...
    return h('', [
        ...
        h('input.w-50.mv1', {
            ...
            oninput: (e) => {
                ...
                if (!o2from) {
                    ...
                    model.runs.setO2startFilterWithDebounce('FromTime', time, e.target.value <= now);
                } else {
                    model.runs.setO2startFilterWithDebounce('FromTime', time, e.target.validity.valid);
                }
            },
        ...
        h('input.w-50.mv1', {
            ...
            oninput: (e) => {
                ...
                model.runs.setO2startFilterWithDebounce('ToTime', time, e.target.validity.valid);
            },
        }, ''),
    ]);
};
