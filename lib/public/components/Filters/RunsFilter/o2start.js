...
const o2startFilter = (model) => {
    ...
    return h('', [
        ...
        h('input.w-50.mv1', {
            ...
            max: o2to || today,
            value: o2from,
            oninput: (e) => model.runs.setO2startFilter('From', e.target.value, e.target.validity.valid),
        }, ''),
        h('input.w-50.mv1', {
            type: 'time',
            ...
            oninput: (e) => {
                ...
                if (!o2from) {
                    ...
                    model.runs.setO2startFilter('FromTime', time, e.target.value <= now);
                } else {
                    model.runs.setO2startFilter('FromTime', time, e.target.validity.valid);
                }
            },
        ...
        h('input.w-50.mv1', {
            ...
            max: today,
            value: o2to,
            oninput: (e) => model.runs.setO2startFilter('To', e.target.value, e.target.validity.valid),
        }, ''),
        h('input.w-50.mv1', {
            type: 'time',
            ...
            oninput: (e) => {
                ...
                model.runs.setO2startFilter('ToTime', time, e.target.validity.valid);
            },
        }, ''),
    ]);
};
