 ...
 * @param {EorReasonFilterModel} eorReasonsFilterModel the model responsible for the run details overview.
 * @return {vnode} the appropriate vnode based on the status of remote data.
 */
export const eorReasonsSelection = (eorReasonsFilterModel) => {
