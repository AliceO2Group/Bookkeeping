...
export class GaqFilterModel extends FilterModel {
     ...
     */
    async hydrate(value) {
        const { notBadFraction, mcReproducibleAsNotBad } = value;

        await this._notBadFractionFilterModel.hydrate(notBadFraction);
        this._mcReproducibleAsNotBad = mcReproducibleAsNotBad === 'true';
    }
