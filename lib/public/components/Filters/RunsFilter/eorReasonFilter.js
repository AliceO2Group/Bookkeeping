 ...
 */
export const endOfRunReasonsSelection = (eorReasonsFilterModel) => {
 ...
 */
export const eorReasonFilter = (runModel) => endOfRunReasonsSelection(runModel.eorReasonsFilterModel);
