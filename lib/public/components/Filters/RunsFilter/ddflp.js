 ...
 */
const tagFilterOperationRadioButtons = (model) => h('.form-group-header.flex-row', ['On', 'Off'].map((operation) =>
    h('.form-check.mr2', [
...
//  Return h('.flex-row.items-baseline.ph1', ['On', 'Off'].map((operation)),
export default tagFilterOperationRadioButtons;
