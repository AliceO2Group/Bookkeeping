...
const o2endFilter = (model) => {
    ...
    return h('', [
        ...
        h('input.w-50.mv1', {
            ...
            value: o2fromTime,
            onchange: (e) => model.runs.setO2startFilter('FromTime', e.target.value, e.target.validity.valid),
        ...
        h('input.w-50.mv1', {
            ...
            value: o2toTime,
            onchange: (e) => {
                model.runs.setO2endFilter('ToTime', e.target.value, e.target.validity.valid);
            },
            oninput: (e) => model.runs.setO2endFilterWithDebounce('ToTime', e.target.value, e.target.validity.valid),
        }, ''),
    ]);
};
