...
const o2endFilter = (model) => {
    ...
    return h('', [
        ...
        h('input.w-50.mv1', {
            ...
            max: o2to || today,
            value: o2from,
            oninput: (e) => model.runs.setO2endFilter('From', e.target.value, e.target.validity.valid),
        }, ''),
        h('input.w-50.mv1', {
            type: 'time',
            ...
            oninput: (e) => {
                ...
                if (!o2from) {
                    ...
                    model.runs.setO2endFilter('FromTime', time, e.target.value <= now);
                } else {
                    model.runs.setO2endFilter('FromTime', time, e.target.validity.valid);
                }
            },
        }, ''),
        h('.f6', 'Ended Till:'),
        h('input.w-50.mv1', {
            ...
            max: today,
            value: o2to,
            oninput: (e) => model.runs.setO2endFilter('To', e.target.value, e.target.validity.valid),
        }, ''),
        ...
        h('input.w-50.mv1', {
            ...
            oninput: (e) => {
                ...
                model.runs.setO2endFilter('ToTime', time, e.target.validity.valid);
            },
        }, ''),
    ]);
};
