 ...
 * search
 * @param {RunTypesModel} runTypes The global model object
 ...
 */
const runTypeFilter = (runTypes, listingFilterModel) => {
    const service = runTypes.runTypeOverview;
    return service.runTypes.match({
        NotAsked: () => runTypes.loadOverview(),
        Loading: () => null,
