 ...
 */
const runQuality = (model) => h('input.w-75.mt1', {
    type: 'text',
    id: 'runQualityFilterText',
    value: model.runs.getRunQualityFilter(),
    oninput: (e) => model.runs.setRunQualityFilter(e.target.value),
}, '');
