...
export class EorReasonFilterModel extends Observable {
    ...
    constructor() {
        ...
        this._newEorReason = { category: emptyEorReason.category, title: emptyEorReason.title, description: emptyEorReason.description };
    }
    ...
    getFilterQueryParams() {
        return {
            ...!this.newEorReason.category == '' && { 'filter[eor][category]': this.newEorReason.category },
            ...!this.newEorReason.title == '' && { 'filter[eor][title]': this.newEorReason.title },
            ...!this.newEorReason.description == '' && { 'filter[eor][description]': this.newEorReason.description },
        };
    }
