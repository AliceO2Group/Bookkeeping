 ...
 */
const table = (data, columnsDescriptions, { sortModel = null, filterModel = null } = {}, rowConfigurationCallback = null, rowClasses = '') => {
    let content = data;
    if (Array.isArray(data)) {
        content = RemoteData.success(data);
    }

    const columnsCount = Object.values(columnsDescriptions).filter((columnDescription) => columnDescription.visible).length;
