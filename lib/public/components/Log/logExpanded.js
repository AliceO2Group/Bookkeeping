 ...
 * @param {function} onCopyLog function called when the url to the log should be copied to clipboard
 ...
 */
export const logExpanded = (log, highlight, showLogTitle, onCollapse, onCopyLog, authenticationToken) => {
