 ...
 * @param {function} onCopyUrlSuccess a callback to the model when the link button needs rerendering
 ...
 */
export const logExpanded = (log, highlight, showLogTitle, onCollapse, onCopyUrlSuccess, authenticationToken) => {
