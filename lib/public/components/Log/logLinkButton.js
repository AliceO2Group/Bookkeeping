...
class CopyToClipboardComponent {
    ...
    view(vnode) {
        ...
        const {
            ...
            // We need a callback that notify the model when we update the content, to trigger the re-rendering
            // A component shows the view of the system state at a fixed point in time, it do not change between renders (this is why you
            // should not call stuff like document.getElementById)
            onSuccess = () => {
            },
        } = attrs;
