...
export class PaginationModel extends Observable {
     ...
     * @param {number} maxItemsPerPage the value to use as maximum items per page
     *
     * @return {void}
     */
    provideDefaultItemsPerPage(defaultItemsPerPage, maxItemsPerPage = undefined) {
        if (defaultItemsPerPage !== this._defaultItemsPerPage) {
            this._defaultItemsPerPage = defaultItemsPerPage;
            defaultItemsPerPage = defaultItemsPerPage >= 5 ? defaultItemsPerPage : 5;
            this.itemsPerPage = maxItemsPerPage !== undefined && defaultItemsPerPage >= maxItemsPerPage ? maxItemsPerPage : defaultItemsPerPage;
            this.notify();
        }
    }
