...
import { iconCaretTop } from '@aliceo2/web-ui/Frontend/js/src/index.js';
...
const mapAmounts = (paginationModel) => {
    ...
    return [
        ...
        h(
            '.ph3',
            {
                oncreate: () => documentClickTaggedEventRegistry.addListenerForAnyExceptTagged(
                    dismissAmountSelector,
                    CLICK_ON_AMOUNT_SELECTOR_EVENT_TAG,
                ),
                onremove: () => documentClickTaggedEventRegistry.removeListener(dismissAmountSelector),
            },
...
const amountSelector = (paginationModel) =>
    h(
        '#amountSelector',
        {
            onclick: (e) => documentClickTaggedEventRegistry.tagEvent(e, CLICK_ON_AMOUNT_SELECTOR_EVENT_TAG),
            class: [
                'dropup',
