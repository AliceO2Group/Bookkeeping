 ...
 */
const dropdownSubMenu = (dropdownButtonContent, entries, isOpened, onclick, { menuAttributes, isSelected } = {}) =>
...
function navBar(model) {
    ...
    return h('.flex-row.justify-between.items-center.p2.shadow-level2.level2.bg-gray-light', [
        ...
        h('.btn-group', [
            ...
            dropdownSubMenu('LHC', model.isDropdownOpened('LHC'), () => model.toggleDropdown('LHC'), [
            ...
            dropdownSubMenu('Overview', model.isDropdownOpened('overview'), () => model.toggleDropdown('overview'), [
        ...
        h('.flex-row.g2', [
            ...
            dropdownSubMenu(iconPerson(), model.isDropdownOpened('account'), () => model.toggleDropdown('account'), [
