...
const aliFlpReferencesConf = {
    main: {
        name: 'ALI FLP',
        href: 'https://ali-flp.cern.ch',
    },
    other: [
        {
            name: 'QC GUI',
            href: 'https://ali-qcg.cern.ch/',
        },
        {
            name: 'AliECS GUI',
            href: 'https://ali-ecs.cern.ch',
        },
    ],
};
...
const navBar = (model) => {
    ...
    return h('.flex-row.justify-between.items-center.p2.shadow-level2.level2.bg-gray-light', [
        ...
        aliFlpReferencesTab(model, aliFlpReferencesConf),
        h('.btn-group', [
