...
const aliFlpTab = (model) => h('.btn-group', [
    h(`.navbar-dropdown${model.dropdownMenu === 'ali-flp-overview' ? '.dropdown-open' : ''}`, aliFlpReferencesConf.other?.length > 0 ? [
    ...
    absoluteFrontLink(
        aliFlpReferencesConf.home.name,
        aliFlpReferencesConf.home.href,
        {
            class: 'btn btn-tab',
            target: '_blank',
