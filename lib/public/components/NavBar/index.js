...
const aliFlpReferenceTab = (conf) => {
    ...
    return mainPageAnchor;
};

const btnGroupsDelimiter = [
    h('.ph1', { style: {
        'border-rigth': 'medium groove',
    } }), h('.ph1', { style: {
...
const navBar = (model) => {
    ...
    return h('.flex-row.justify-between.items-center.p2.shadow-level2.level2.bg-gray-light', [
        h('.flex-row', h('.f4.gray-darker', 'Bookkeeping')),
        h('.btn-group', [
            aliFlpReferenceTab(getAliFlpReferencesConfiguration()),
            btnGroupsDelimiter,
