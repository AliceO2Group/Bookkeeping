...
import { getQcDetectorExpertRoleName } from '../../utilities/getQcDetectorExpertRoleName.js';
...
const detectorExpertRolesSelectionModel = new SelectionDropdownModel({
    availableOptions: ['CPV', 'EMC', 'FDD', 'FT0', 'FV0', 'HMP', 'ITS', 'MCH', 'MFT', 'MID', 'PHS', 'TOF', 'TPC', 'TRD', 'ZDC', 'GLO']
        .map((detectorName) => getQcDetectorExpertRoleName(detectorName))
        .map((roleName) => ({
            value: roleName,
            label: roleName,
        })),
