 ...
 */
const dropdownSubMenu = (dropdownButtonContent, isOpened, onclick, entries, { menuAttributes, isSelected } = {}) =>
...
function navBar(model) {
    ...
    return h('.flex-row.justify-between.items-center.p2.shadow-level2.level2.bg-gray-light', [
        ...
        h('.btn-group', [
            ...
            dropdownSubMenu('LHC', model.isDropdownOpened('LHC'), () => model.toggleDropdownMenu('LHC'), [
            ...
            dropdownSubMenu('Overview', model.isDropdownOpened('overview'), () => model.toggleDropdownMenu('overview'), [
        ...
        h('.flex-row.g2', [
            ...
            dropdownSubMenu(iconPerson(), model.isDropdownOpened('account'), () => model.toggleDropdownMenu('account'), [
