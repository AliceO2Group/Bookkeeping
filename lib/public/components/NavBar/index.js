...
import { aliFlpIndexPageUrl } from '../../services/externalRouting/aliFlpIndexPageUrl.js';
 ...
 * @param {String} [aliFlpIndexUrl] ali flp index url
 * @returns {vnode} returns tab
 */
const aliFlpLinkTab = (aliFlpIndexUrl) => absoluteFrontLink(
    'ALI FLP',
    aliFlpIndexUrl,
    {
        class: 'btn btn-tab',
...
const navBar = (model) => {
    ...
    return h('.flex-row.justify-between.items-center.p2.shadow-level2.level2.bg-gray-light', [
        ...
        h('.btn-group', [
            aliFlpLinkTab(aliFlpIndexPageUrl),
            btnGroupsDelimiter,
