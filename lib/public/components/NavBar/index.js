...
const navBar = (model) => {
    ...
    return h('.flex-row.justify-between.items-center.p2.shadow-level2.level2.bg-gray-light', [
        ...
        h('.btn-group', [
            ...
            h(`.navbar-dropdown${model.dropdownMenu === 'LHC' ? '.dropdown-open' : ''}`, [
                h('button#LHC', {
                    class: `btn btn-tab ${page === 'lhc-fill-overview' || page === 'lhc-period-overview' ? 'selected' : ''}`,
                    onclick: () => model.toggleDropdownMenu('LHC'),
                }, 'LHC'),
            ...
            h(`.navbar-dropdown${model.dropdownMenu === 'overview' ? '.dropdown-open' : ''}`, [
                h('button#overviews', {
                    ...
                    onclick: () => model.toggleDropdownMenu('overview'),
                }, 'Overview'),
                h('.dropdown-menu', { style: 'width: max-content;' }, [
        ...
        h('.flex-row.g2', [
            ...
            h('.navbar-dropdown', {
                ...
                h('button.btn', { onclick: () => model.toggleDropdownMenu('account') }, iconPerson()),
                h('.dropdown-menu', [
