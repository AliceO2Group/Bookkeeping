 ...
 */
const basePageMenuLink = (content, page, onclick) => frontLink(
    content,
    page,
    null,
    {
...
function navBar(model) {
    ...
    const pageTab = (page, content) => basePageTab(page, content, () => model.clearDropdownMenu(), model.router.params.page === page);
    // eslint-disable-next-line require-jsdoc
    const pageMenuLink = (content, page) => basePageMenuLink(content, page, () => model.clearDropdownMenu());
    // eslint-disable-next-line require-jsdoc
    ...
    return h('.flex-row.justify-between.items-center.p2.shadow-level2.level2.bg-gray-light', [
        ...
        h('.btn-group', [
            ...
            dropdownSubMenu(model, 'LHC', 'LHC', [
                pageMenuLink('LHC Fills', 'lhc-fill-overview', true),
