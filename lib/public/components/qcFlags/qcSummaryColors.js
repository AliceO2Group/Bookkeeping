...
export const QC_SUMMARY_COLORS = {
    ...
    /**
     * In case run all assigend flags are bad and at least one of them is of type Limited Acceptance MC reproducible
     *
     ...
     */
    NO_GOOD_AND_LIMITED_ACCEPTANCE_MC_REPRODUCBILE: '#BB9D30',

    /**
     * In case coverage is uncalculatable
     */
    UNCALCULABTABLE_COVERAGE: 'var(--color-gray)',
};
