...
export class QcFlagTypesSelectionDropdownModel extends SelectionDropdownModel {
    ...
    _initialize() {
        ...
        const updateAvailableOptionsOnProviderNotification = () => this.setAvailableOptions(qcFlagTypesProvider.notArchived$.getCurrent().apply({
        ...
        qcFlagTypesProvider.notArchived$.observe(updateAvailableOptionsOnProviderNotification);
        updateAvailableOptionsOnProviderNotification();
    }
}
