                ...
                return remoteRun.match({
                    ...
                    Success: (run) => isRunNotSubjectToQc(run)
                        ...
                        : h('div.qc-flag-container', [
                            h('style', `
                                .qc-flag-container { display: flex; align-items: center; gap: 8px; padding-right: 5px }
                                .qc-link-wrapper { pointer-events: auto; }
                                .select-multi-flag { cursor: pointer; transform: scale(1.5); pointer-events: auto; }
                            `),
