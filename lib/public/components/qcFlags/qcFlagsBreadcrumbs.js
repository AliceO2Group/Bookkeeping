 ...
 * @param {number} [qcBreadcrumbsElements.dataPass] data pass -- exclusive with `remoteSimulationPass`
 * @param {object} [qcBreadcrumbsElements.simulationPass] simulation pass -- exclusive with `remoteDataPass`
 * @param {Run} qcBreadcrumbsElements.run run
 * @param {number} [qcBreadcrumbsElements.detector] dpl remote data
