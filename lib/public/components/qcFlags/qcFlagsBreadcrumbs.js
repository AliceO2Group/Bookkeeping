 ...
 * @param {Run} qcBreacrumbsElements.remoteRun run remote data
 * @param {number} [qcBreacrumbsElements.remoteDataPass] data pass remote data -- exclusive with `remoteSimulationPass`
 * @param {object} [qcBreacrumbsElements.remoteSimulationPass] simulation pass remote data -- exclusive with `remotedataPass`
 * @param {number} qcBreacrumbsElements.remoteDplDetector dpl detector remote data
