 ...
 * @param {string} parentSelector the css selector of the parent node e.g. "button.btn"
 * @param {Component} children components
 * @return {Component} the children components wrapped in the clipboardTarget
 */
export const clipboardTarget = (copyText, parentSelector, children) => h(parentSelector, { onclick: (e) => {
    e.preventDefault();
