 ...
 * @param {function} onSuccess callback to notify the parent the url was successfully copied
 * @return {Component} the children components wrapped in the clipboardTarget
 */
export const clipboardTarget = (copyText, children, onSuccess) => h('div', { onclick: () => {
