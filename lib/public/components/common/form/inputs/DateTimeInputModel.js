...
export class DateTimeInputModel extends Observable {
    ...
    constructor(configuration) {
        super();
        const { defaults = {}, required = false, min = null, max = null } = configuration;
    ...
    update({ date, time }) {
        ...
        try {
            this._value = this.extractTimestampFromHTMLInput(this._raw.date, this._raw.time);
        } catch (_) {
            this._value = undefined;
        }
     ...
     *
     * @param {number|undefined} value the new value
     */
    set value(value) {
     ...
     *
     * @return {(Partial<{date: string, time: string}>|string)} the min values
     */
    get inputsMin() {
        if (this._min === null) {
            return null;
     ...
     *
     * @return {(Partial<{date: string, time: string}>|string)} the max values
     */
    get inputsMax() {
        if (this._max === null) {
            return null;
