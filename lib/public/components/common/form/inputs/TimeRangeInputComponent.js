 ...
 * @property {string|Component|null} label label for input, if null default label is rendered
 */
 ...
 * @property  {TimeInputConfiguration} fromInputConfiguration `from` input additional configuration
