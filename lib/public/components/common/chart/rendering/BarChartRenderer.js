...
import { ChartRenderer, X_VARIABLE_NAME } from './ChartRenderer.js';
...
export class BarChartRenderer extends ChartRenderer {
    ...
    constructor(configuration, data) {
        ...
        const getBarLength = ({ x, y }) => {
            if (this._independentVariable === X_VARIABLE_NAME) {
                if (Array.isArray(y)) {
        ...
        this._barPropertiesProvider = {
            ...
            getWidth: this._independentVariable === X_VARIABLE_NAME
                ? getBarThickness
                : getBarLength,
            getHeight: this._independentVariable === X_VARIABLE_NAME
                ? getBarLength
                : getBarThickness,
        };
    }
