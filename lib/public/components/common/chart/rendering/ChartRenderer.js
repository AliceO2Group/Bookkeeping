...
export class ChartRenderer {
    ...
    constructor(configuration, data) {
        ...
        const dependentVariable = this.isXIndependentVariable ? Y_VARIABLE_NAME : X_VARIABLE_NAME;
    ...
    get independentVariableScale() {
        return this.isXIndependentVariable ? this._xScale : this._yScale;
    }
