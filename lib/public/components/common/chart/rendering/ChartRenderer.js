...
export class ChartRenderer {
    ...
    constructor(configuration, data) {
        ...
        const dependentVariable = this._independentVariable === X_VARIABLE_NAME ? Y_VARIABLE_NAME : X_VARIABLE_NAME;
    ...
    get independentVariableScale() {
        return this._independentVariable === X_VARIABLE_NAME ? this._xScale : this._yScale;
    }
