...
export const X_VARIABLE_NAME = 'x';
export const Y_VARIABLE_NAME = 'y';
...
export class ChartRenderer {
    ...
    constructor(configuration, data) {
        ...
        const {
            ...
            forceZero = false,
            axis = {},
            independentVariable = X_VARIABLE_NAME,
            renderGrid = true,
            datasets: configurationDatasets = {},
        } = configuration;

        if (independentVariable !== X_VARIABLE_NAME && independentVariable !== Y_VARIABLE_NAME) {
            throw new Error(`Independent variable can be only '${X_VARIABLE_NAME}' or '${Y_VARIABLE_NAME}'` +
                `, it cannot be '${this._independentVariable}'`);
        }
        ...
        const dependentVariable = this.isXIndependnetVariable ? Y_VARIABLE_NAME : X_VARIABLE_NAME;
    ...
    get independentVariableScale() {
        return this.isXIndependnetVariable ? this._xScale : this._yScale;
    }

    /**
     * States whther x is independnet variable
     * @return {boolean} true if x is independent variable, false otherwise
     */
    get isXIndependnetVariable() {
        return this._independentVariable === X_VARIABLE_NAME;
    }
