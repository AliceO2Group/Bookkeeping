...
/**
 * @callback pointToProperty
 * @param {Point} point
 * @return {string|number} point property
 */

/**
 * @typedef BarsPropertiesProvider
 * @property {pointToCoordinate} getX function to extract the horizontal coordinate of a given point
 * @property {pointToCoordinate} getY function to extract the vertical coordinate of a given point
 * @property {pointToProperty} getLength
 * @property {pointToProperty} getWidth
 * @property {pointToProperty} getFill
 * @property {pointToProperty} getStroke
 */
