...
import { PointBasedChartRenderer } from '../rendering/PointBasedChartRenderer.js';
 ...
 * @property {PointBasedChartConfiguration} [chartConfiguration] the line chart configuration
...
class LineChartClassComponent {
    ...
    constructor({ attrs: { points, configuration, notify } }) {
        ...
        this._chartRenderer = new PointBasedChartRenderer(configuration.chartConfiguration, points);
        this.svgNode = null;
    }
...
export const lineChartComponent = (points, configuration) => points.length
    ...
    : h('.w-100.h-100.flex-row.items-center.justify-center', h('', this.configuration.placeholder || 'No data'));
