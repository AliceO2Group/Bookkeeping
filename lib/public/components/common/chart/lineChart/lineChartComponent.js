 ...
 * @template P
 * @param {P} coordinates the coordinates of the point the tooltip refers to
...
class LineChartClassComponent {
    /**
     * Constructor
     * @param {{attrs: {points: T, configuration: LineChartComponentConfiguration, notify: function}}} the component's vnode
     */
    ...
    render(svgElement) {
         ...
         *
         * @param {T} coordinates the domain coordinates of the point being hovered
