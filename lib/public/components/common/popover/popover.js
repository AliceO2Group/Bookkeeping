...
class PopoverComponent extends StatefulComponent {
     ...
     * @param {object} parameters.attrs the component attributes
     * @param {Component} parameters.attrs.trigger the trigger component
     * @param {Component} parameters.attrs.content the popover component
     * @param {PopoverConfiguration} parameters.attrs.configuration the popover options
     */
        ...
        return [
            ...
            createPortal(h('', {
                class: [
                    ...
                    'br2',
                    'bg-white',
                    ...this._scroll ? ['scroll-x', 'scroll-y'] : [],
