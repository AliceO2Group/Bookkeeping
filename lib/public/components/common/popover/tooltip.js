 ...
 * @param {object} configuration popover configuration
 * @param {PopoverAnchors} [configuration.anchor = PopoverAnchors.TOP_MIDDLE] popover's anchor localisation
 * @return {Component} the resulting trigger and popover
 */
export const tooltip = (trigger, content, { anchor = PopoverAnchors.TOP_MIDDLE } = {}) => popover(trigger, content, {
