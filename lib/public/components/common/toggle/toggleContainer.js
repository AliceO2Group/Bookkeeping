    ...
    return h(
        '',
        {
            ...
            oncreate: function () {
                ...
                documentClickTaggedEventRegistry.addListenerForAnyExceptTagged(() => {
                    this.hideToggleable();
            ...
            onremove: function () {
                ...
                documentClickTaggedEventRegistry.removeListener(this.hideToggleable);
            ...
            onclick: (e) => {
                ...
                documentClickTaggedEventRegistry.tagEvent(e, toggleModel.closeEventTag);
