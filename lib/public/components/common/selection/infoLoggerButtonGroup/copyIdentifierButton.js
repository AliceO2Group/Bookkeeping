 ...
 * @param {boolean} showCopySuccessContent an indicator as to whether to display feedback to the user that the identifier was copied
 * @param {function} onCopySuccess a callback to the model so it can rerender the page
 * @return {clipboardTarget} the copyIdentifierButton component wrapped in a clipboardTarget
 */
export const copyIdentifierButton = (key, value, showCopySuccessContent, onCopySuccess) => {
