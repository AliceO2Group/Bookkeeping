...
import { copyIdentifierButton } from './copyIdentifierButton.js';
 ...
 *
 * @param {Model} model the model for which the infoLoggerButtonGroup is rendered
 ...
 */
export const infoLoggerButtonGroup = (model, parameters) => {
        ...
        [
            ...
            dropdown(
                ...
                h(
                    '.flex-column.p2.g3',
                    [
                        copyIdentifierButton(Object.keys(key)[0], value, model.showCopySuccessContent, () => model.onCopySuccess()),
