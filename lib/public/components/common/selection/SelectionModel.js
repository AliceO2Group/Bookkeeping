...
export class SelectionModel extends Observable {
    /**
     * Constructor
     * @param {Object} [configuration] the model's configuration
     * @param {RemoteData|SelectionOption[]} [configuration.availableOptions=[]] the list of available options
     * @param {SelectionOption[]} [configuration.defaultSelection=[]] the default selection
     * @param {boolean} [configuration.multiple=true] if true, the selection can contain more than one element. Else, any selection will
     *     discard the previous one
     * @param {allowEmpty} [configuration.allowEmpty=true] if true, the selection can be empty. Else, deselect will be cancelled if it leads to
     *     empty selection
     */
