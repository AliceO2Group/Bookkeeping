...
export const table = (
    ...
    // https://salesforce.stackexchange.com/questions/391181/overlapping-problem-in-fixed-header-and-fixed-left-first-column
    return h(`${xScrollable ? '.x-scrollable' : ''}`, h(
        'table.table.table-hover.shadow-level1.no-z-index.x-scrollable',
        {
