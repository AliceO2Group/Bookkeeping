 ...
 * @property {string[]} filterProfiles list of profiles which for a filter should be rendered regardless of column's profiles
 * (by default a filter is rendered when column is displayed)
 ...
 * @property {boolean} horizontalScrollEnabled if true, enable horizontall scroll in case of overflow,
