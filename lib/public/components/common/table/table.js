 ...
 * @param {boolean} [tableConfiguration.horizontalScrollEnabled = false] if true, enable horizontall scroll in case of overflow,
...
export const table = (
    ...
    return h(`${horizontalScrollEnabled ? '.scroll-auto' : ''}`, h(
