...
export const table = (
    ...
    return h(`${horizontalScrollEnabled ? '.scroll-auto.shadow-level1' : ''}.table-max-height`, h(
        `table.table.table-hover.shadow-level1.no-z-index.sticky-top${freezeFirstColumn ? '.freeze-first-column' : ''}`,
        {
