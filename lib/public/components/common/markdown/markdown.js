...
const DEFAULT_SIZE = { width: 'auto', height: 'auto' };
 ...
 * @param {MarkdownBoxSize} [size] the size of the markdown box
 ...
 * @param {MarkdownBoxSize} size the size of the markdown input
 * @return {vnode} the component
 */
