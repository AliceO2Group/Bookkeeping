 ...
 *
 * @param {string|undefined} runDuration run duration to format with formatterDuration
 * @param {string|undefined} efficiency the efficiency to format with formatterEfficiency
 ...
 * @return {vnode} the formatted result as vnode
 */
