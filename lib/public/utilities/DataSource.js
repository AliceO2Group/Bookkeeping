...
export class ExternalDataSource {
     ...
     * @param {ExternalDataSource|Function} pipelineElement next data source in pipeline or
     * function to observe ObservableData of current data source
     * @param {object} [options] options modifying behaviour
     * @param {boolean} [options.setAutoCleaning = true] if true setAutoCleaning of ancestors, @see ExternalDataSource#setAutoCleaning
     * @return {ExternalDataSource} this
     */
    feeds(pipelineElement, { setAutoCleaning = true } = {}) {
        if (pipelineElement instanceof ExternalDataSource) {
     ...
     * @param {ExternalDataSource} dataSource underlying data source
     */
