...
import { permissions as pagePermissions, DEFAULT } from './rbac.js';
...
export const rbacShowComponent = (userRoles, page, componentDescription) => {
    ...
    const componentPermissions = pagePermissions[page];
    const showType = showTypeOfComponent(roles, componentPermissions, componentDescription);
    return showType;
};
