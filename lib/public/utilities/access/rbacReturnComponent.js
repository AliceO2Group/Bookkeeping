...
import { rbacShowFeature } from './rbacShowFeature.js';
import { h } from '/js/src/index.js';

/**
 * Return a link, a disabled button, or a null object based on the user's access roles.
 * If the content of the component is a vnode, include a 'title' attribute that matches rbacShowFeature.
 ...
 * @param {String} onPage the page the component is on
 ...
 */
export const linkOrDisabledOrNull = (roles, onPage, content, toPage, parameters = {}, attributes = {}) => {
    const feature = typeof content === 'string' ? content : attributes.title;
    const showType = rbacShowFeature(roles, onPage, feature);
