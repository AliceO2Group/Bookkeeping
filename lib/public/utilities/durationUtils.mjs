 ...
 *
 * @param {object} duration the duration to merge
 * @param {number} duration.hours the amount of hours
 * @param {number} duration.minutes the amount of minutes
 * @param {number} duration.seconds the amount of seconds
 *
