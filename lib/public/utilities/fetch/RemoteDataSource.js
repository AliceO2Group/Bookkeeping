...
export class RemoteDataSource {
    ...
    async fetch(endpoint, options) {
        ...
        try {
            ...
            const data = await this.getRemoteData(endpoint, options);
     ...
     */
    async getRemoteData(endpoint, options) {
        return getRemoteData(endpoint, { ...options, signal: this._abortController.signal });
    }
}
