...
export const buildUrl = (baseURL, parameters) => {
    ...
    console.log(url, existingParameters, 'existingParameters');

    if (existingParameters) {
        for (const formattedParameter of existingParameters.split('&')) {
            console.log(url, formattedParameter, 'formattedParameter');
            ...
            console.log(url, { parameters, nestedKeys, value }, nestedKeys, 'TOBEC pre');
            buildParameterFromNestedKeys(parameters, nestedKeys, value, null);
            console.log(url, { parameters, nestedKeys, value }, nestedKeys, 'TOBEC past');
        }
    }
