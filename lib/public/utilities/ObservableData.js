...
class ObservableDataBuilder {
    ...
    /**
     * Any time the source data value change it will be reflected to the created observable data
     *
    ...
    build() {
        ...
        if (this._source) {
            ...
            source?.observe(() => observableData.setCurrent(source.getCurrent.bind(source)()));
        }
        this._processors = [];
        this._initialValue = null;
        this._source = null;
