...
import { DataPassesPerLhcPeriodOverviewPage } from './views/DataPasses/PerAssociationOverview/DataPassesPerLhcPeriodOverviewView.js';
import { SimulationPassesPerLhcPeriodOverviewPage }
    from './views/SimulationPasses/AssociatedOverview/SimulationPassesPerLhcPeriodOverviewView.js';
import { SimulationPassesPerDataPassOverviewPage } from './views/SimulationPasses/AssociatedOverview/SimulationPassesPerDataPassOverviewView.js';
import { DataPassesPerSimulationPassOverviewPage } from './views/DataPasses/PerAssociationOverview/DataPassesPerSimulationPassOverviewView.js';
...
export default (model) => {
    const pages = {
        ...
        'simulation-passes-per-data-pass-overview': SimulationPassesPerDataPassOverviewPage,
