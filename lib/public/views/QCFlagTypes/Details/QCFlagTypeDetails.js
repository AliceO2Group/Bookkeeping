    ...
    name: {
        ...
        format: (name) => detailsModel.isEditModeEnabled
            ? h('input.form-control.w-60', {
                ...
                oninput: (e) => detailsModel.setPatchValue('name', e.target.value),
            })
            : name,
    },
    method: {
        ...
        format: (method) => detailsModel.isEditModeEnabled
            ? h('input.form-control.w-60', {
                ...
                // eslint-disable-next-line no-return-assign
                oninput: (e) => detailsModel.setPatchValue('method', e.target.value),
            })
            : method,
    },
    bad: {
                    ...
                    h('.switch#bad-toggle', [
                        h(
                            'input',
                            {
                                ...
                                onchange: () => {
                                    detailsModel.setPatchValue('bad', !detailsModel.patch.bad);
                                },
                                type: 'checkbox',
                            },
                        ),
                    ...
                    h('.switch#archive-toggle', [
                        h(
                            'input',
                            {
                                ...
                                onchange: () => {
                                    detailsModel.setPatchValue('archived', !detailsModel.patch.archived);
                                },
                                type: 'checkbox',
                            },
                        ),
    ...
    color: {
        ...
        format: (color) => detailsModel.isEditModeEnabled
            ? colorInputComponent(detailsModel.patch.color, (color) => {
                detailsModel.setPatchValue('color', color);
            })
...
export const qcFlagTypeDetailsList = (qcFlagTypeDetailsModel, qcFlagType) => detailsList(
    ...
    qcFlagType,
    { attributes: { class: 'flex-column g2' } },
);
