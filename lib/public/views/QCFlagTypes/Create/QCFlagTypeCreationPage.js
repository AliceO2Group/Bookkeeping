 ...
 */
const qcFlagTypeCreationForm = ({ data, badnessSelectionModel }) => {
    const { name, method, color } = data;
    ...
    const panel = [
        ...
        h(PanelComponent, [
            ...
            modeledCheckboxFilter(badnessSelectionModel),
        ]),
