...
export class QCFlagTypeCreationModel extends CreationModel {
     ...
     */
    isValid() {
        return this._data.name.length && this._data.method.length && this._data.bad !== null;
    }
}
...
class QCFlagTypeCreationFormData extends Observable {
    ...
    /**
     * Sets the bad information for the QC Flag Type creation screen to a newly provided bad information.
     *
     * @param {string} bad The newly inserted bad information.
     * @returns {void}
     */
    set bad(bad) {
        this._bad = bad;
