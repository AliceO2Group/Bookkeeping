...
export const formatRunDuration = (run, raw = false) => {
    ...
    if (timeTrgEnd || timeO2End) {
        ...
        if (missingTimeTrgStart && missingTimeTrgEnd) {
            ...
            warningPopover = 'Duration based on o2 start because of missing trigger information';
        } else if (missingTimeTrgEnd) {
            warningPopover = 'Duration based on o2 stop because of missing trigger information';
        }
