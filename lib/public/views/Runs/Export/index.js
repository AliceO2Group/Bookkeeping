...
const exportRunsScreen = (model) => {
    ...
    const selectedRunsFields = model.runs.getSelectedFields;
    ...
    return h('div#export-runs', [
        ...
        h('', {
            ...
            h('select#fields.form-control', {
                multiple: true,
                onchange: ({e}) => { model.runs.setSelectedFields(e.selectedOptions); console.log("selected fields", selectedRunsFields)},
            }, [
