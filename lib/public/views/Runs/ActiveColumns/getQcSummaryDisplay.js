 ...
 */
export const getQcSummaryDisplay = (summary, { mcReproducibleAsNotBad = false } = {}) => {
    const {
    ...
    } else if ((!explicitlyNotBadEffectiveRunCoverage || mcReproducibleAsNotBad) && mcReproducible) {
        qcSummaryDisplay = getQcSummaryDisplayWithColor(
            [
                notBadPercentageFormat,
