 ...
 * @param {string} [options.classes] additional CSS classes to add to the display element
 * @return {Component} display
 */
export const getQcSummaryDisplay = (summary, { classes } = {}) => {
    const {
    ...
    const invalidatedDisplay = invalidated
        ? h(
            '.d-inline-block.va-t-bottom',
            tooltip(h('.f7', iconClock()), 'Summary is invalid. New summary will be calculated shortly. Please wait and refresh the page.'),
        )
        : null;
