...
import { eorReasonsSelection } from '../../../components/Filters/RunsFilter/eorReasonsSelection.js';
...
export const runsActiveColumns = {
    ...
    eorReasons: {
         ...
         * @return {Component} the filter component
         */
        filter: (runsOverviewModel) => eorReasonsSelection(runsOverviewModel.filteringModel.get('eorReason')),
        balloon: true,
    },
