...
import { runQualitiesFilter } from '../../../components/Filters/RunsFilter/runQualitiesFilter.js';
...
import { fillNumbersFilter } from '../../../components/Filters/RunsFilter/fillNumbersFilter.js';
...
export const runsActiveColumns = {
    ...
    fillNumber: {
         ...
         * @return {Component} the filter component
         */
        filter: (runsOverviewModel) => fillNumbersFilter(runsOverviewModel.filteringModel.get('fillNumbers')),
    },
    lhcPeriod: {
        name: 'LHC Period',
        visible: true,
    ...
    runDuration: {
         ...
         */
        filter: (runsOverviewModel) => durationFilter(runsOverviewModel.filteringModel.get('runDuration')),
    ...
    environmentId: {
         ...
         */
        filter: (runsOverviewModel) => environmentIdsFilter(runsOverviewModel.filteringModel.get('environmentIds')),
    ...
    runQuality: {
         ...
         */
        filter: (runsOverviewModel) => runQualitiesFilter(runsOverviewModel.filteringModel.get('runQualities')),
    },
    nDetectors: {
        name: 'DETs #',
        visible: false,
    ...
    dd_flp: {
        ...
        /**
         * Filter on DD enabled/disabled
         *
         * @param {RunsOverviewModel} runsOverviewModel the runs overview model
         * @return {Component} the DD state filter
         */
        filter: (runsOverviewModel) => expandedSelectionFilter(runsOverviewModel.filteringModel.get('ddflp').selectionModel),
    },
    dcs: {
        name: 'DCS',
        visible: true,
        ...
        /**
         * Filter on DCS enabled/disabled
         *
         * @param {RunsOverviewModel} runsOverviewModel the runs overview model
         * @return {Component} the DCS state filter
         */
        filter: (runsOverviewModel) => expandedSelectionFilter(runsOverviewModel.filteringModel.get('dcs').selectionModel),
    },
    triggerValue: {
        name: 'TRG',
        visible: true,
        ...
        /**
         * Filter on trigger value
         *
         * @param {RunsOverviewModel} runsOverviewModel the runs overview model
         * @return {Component} the trigger value filter
         */
        filter: (runsOverviewModel) => expandedSelectionFilter(runsOverviewModel.filteringModel.get('triggerValues').selectionModel),
    ...
    epn: {
        ...
        /**
         * Filter on EPN enabled/disabled
         *
         * @param {RunsOverviewModel} runsOverviewModel the runs overview model
         * @return {Component} the EPN state filter
         */
        filter: (runsOverviewModel) => expandedSelectionFilter(runsOverviewModel.filteringModel.get('epn').selectionModel),
    },
    epnTopology: {
        name: 'EPN Topology',
        visible: false,
