...
export const runsActiveColumns = {
    ...
    timeO2Start: {
        ...
        visible: true,
        size: 'w-7 f6',
        information: 'Values that display the * have the "o2_start" time due to missing "trigger_start" value',
        ...
        profiles: {
            ...
            home: {
                ...
                size: 'w-30',
                format: (timestamp, run) => run.timeTrgStart
                    ? formatTimestamp(run.timeTrgStart, true)
    ...
    timeO2End: {
        ...
        visible: true,
        size: 'w-7 f6',
        information: 'Values that display the * have the "o2_stop" time due to missing "trigger_stop" value',
        ...
        profiles: {
            ...
            home: {
                name: 'Stop',
                size: 'w-30',
                format: (timestamp, run) => run.timeTrgEnd
                    ? formatTimestamp(run.timeTrgEnd, true)
                    : formatTimestamp(timestamp, true, '*'),
