...
import o2startEndFilter from '../../../components/Filters/RunsFilter/o2startEnd.js';
...
export const runsActiveColumns = {
    ...
    nEpns: {
        ...
        profiles: [profiles.none, 'lhcFill', 'environment'],
        size: 'w-2 f6 w-wrapped',
        format: (nEpns, run) => run.epn ? nEpns : 'OFF',
        filter: nEpnsFilter,
    },
    nFlps: {
        name: 'FLPs #',
    ...
    eorReasons: {
        ...
        size: 'w-15 f6',
        visible: true,
        format: (_, run) => run.eorReasons.length > 0 ? displayRunEorReasonsOverview(run.eorReasons) : '',
