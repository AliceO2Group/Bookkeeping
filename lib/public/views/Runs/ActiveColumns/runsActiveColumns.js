...
export const runsActiveColumns = {
    ...
    timeO2Start: {
        ...
        format: (timestamp, run) => run.timeTrgStart ?
            formatTimestamp(run.timeTrgStart, false) : formatTimestamp(timestamp, false, '*'),
    ...
    runDuration: {
        ...
        size: 'w-7 f6 w-wrapped',
        information: [
            h('', 'If the value has a "*" this will imply that the O2 stop is used.'),
            h('', '* values are calculated based on "o2_stop" - "o2_start"'),
            h('', '** values are calculated based on a combination of trigger and o2 times;'),
        ],
