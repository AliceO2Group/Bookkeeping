...
export const runsActiveColumns = {
    ...
    muInelasticInteractionRate: {
        ...
        visible: (runs) => runs.some((run) => run.pdpBeamType === 'pp'),
        format: formatFloat,
        profiles: {
    ...
    avgInelasticInteractionRate: {
        ...
        visible: (runs) => runs.some((run) => run.pdpBeamType === 'PbPb' || run.pdpBeamType === 'pp'),
        format: formatFloat,
        profiles: {
            runsPerLhcPeriod: { classes: 'f6' },
            runsPerDataPass: { classes: 'f6' },
    ...
    inelasticInteractionRateAtStart: {
        ...
        visible: (runs) => runs.some((run) => run.pdpBeamType === 'PbPb'),
        format: formatFloat,
        profiles: {
            runsPerLhcPeriod: { classes: 'f6' },
            runsPerDataPass: { classes: 'f6' },
