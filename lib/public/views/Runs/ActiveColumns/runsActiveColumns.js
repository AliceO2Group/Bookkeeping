...
export const runsActiveColumns = {
    ...
    nDetectors: {
        ...
        filter: ({ nDetectorsFilterModel }) => amountFilter(nDetectorsFilterModel, {
            operatorAttributes: {
    ...
    nEpns: {
        ...
        filter: ({ nEpnsFilterModel }) => amountFilter(nEpnsFilterModel, {
            operatorAttributes: {
                id: 'nEpns-operator',
            },
            operandAttributes: {
    ...
    nFlps: {
        ...
        profiles: [profiles.none, 'lhcFill', 'environment'],
        classes: 'w-2 f6 w-wrapped',
        filter: ({ nFlpsFilterModel }) => amountFilter(nFlpsFilterModel, {
            operatorAttributes: {
                id: 'nFlps-operator',
            },
            operandAttributes: {
