...
export const runsActiveColumns = {
    ...
    runQuality: {
         ...
         */
        filter: (runsOverviewModel) => checkboxes(runsOverviewModel.filteringModel.get('runQualities')),
    },
    nDetectors: {
        name: 'DETs #',
        visible: false,
    ...
    triggerValue: {
         ...
         */
        filter: ({ filteringModel }) => checkboxes(filteringModel.get('triggerValues'), { selector: 'triggerValue' }),
    ...
    pdpBeamType: {
        ...
        filterTooltip: 'As set by user in ECS GUI during an environment deployment.',
    },
    beamType: {
        name: 'Beam Type',
        visible: false,
        ...
        filterTooltip: 'As sent by LHC to Bookkeeping-LHC Plugin.',
    },
    readoutCfgUri: {
