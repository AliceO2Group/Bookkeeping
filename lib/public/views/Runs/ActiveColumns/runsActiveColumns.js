...
export const runsActiveColumns = {
    ...
    runQuality: {
         ...
         */
        filter: (runsOverviewModel) => expandedSelectionFilter(
            runsOverviewModel.filteringModel.get('runQualities').selectionModel,
            { selector: 'run-quality' },
        ),
    },
    nDetectors: {
        name: 'DETs #',
    ...
    dd_flp: {
         ...
         */
        filter: (runsOverviewModel) => expandedSelectionFilter(
            runsOverviewModel.filteringModel.get('ddflp').selectionModel,
            { selector: 'dd-flp' },
        ),
    },
    dcs: {
         ...
         */
        filter: (runsOverviewModel) => expandedSelectionFilter(
            runsOverviewModel.filteringModel.get('dcs').selectionModel,
            { selector: 'dcs' },
        ),
    },
    triggerValue: {
    ...
    epn: {
         ...
         */
        filter: (runsOverviewModel) => expandedSelectionFilter(
            runsOverviewModel.filteringModel.get('epn').selectionModel,
            { selector: 'epn' },
        ),
    },
    epnTopology: {
