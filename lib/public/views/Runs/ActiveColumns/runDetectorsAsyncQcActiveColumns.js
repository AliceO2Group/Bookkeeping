 ...
 */
const runDetectorAsyncQualityDisplay = (run, dplDetectorId, { dataPassId, simulationPassId }, qcSummary) => {
    ...
    if (!qcSummary?.[runNumber]?.[dplDetectorId]) { // If there is no QC flag assigned
        return runQualityWasChangedToBad
            ...
            : qcFlagCreationPanelLink(run, { dataPassId, simulationPassId }, dplDetectorId);
    }
