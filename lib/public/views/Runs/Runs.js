...
export default class RunModel extends Observable {
     ...
     * @param {number|string|undefined} [runIdentifier.runNumber]  the runNumber of the run to display
     * @param {number|string|undefined} [runIdentifier.id]  Usage of this paramter is deprecated, use runNumber if feasible,
     * @param {string|null|undefined} [panelKey=null] the key of the panel to display
     * @return {void}
     */
    loadDetails({ runNumber = null, id: runId = null }, panelKey = null) {
        ...
        if (this._detailsModel === null) {
            ...
            if (runNumber !== null) {
                ...
                // TODO https://alice.its.cern.ch/jira/browse/O2B-1056
