...
import { RunTypeFilterModel } from '../../components/Filters/RunsFilter/RunTypeFilterModel.js';
...
export default class RunModel extends Observable {
    ...
    constructor(model) {
        ...
        this._listingRunTypesFilterModel = new RunTypeFilterModel();
    ...
    isAnyFilterActive() {
        return (
            ...
            || !this._listingRunTypesFilterModel.isEmpty()
            || this._fillNumbersFilter !== ''
            || this.o2startFilterFrom !== ''
            || this.o2startFilterTo !== ''
            || this.o2startFilterToTime !== '23:59'
    ...
    getActiveFilters() {
        ...
        if(!this._listingRunTypesFilterModel.isEmpty()) {
     ...
     * @returns {RunTypeFilterModel} A run filter model used to get
     */
    ...
    _getFilterQueryParams() {
        return {
            ...
            ...!this._listingRunTypesFilterModel.isEmpty() && {
                'filter[runTypes][values]': this._listingRunTypesFilterModel.selected.join(),
                'filter[runTypes][operator]': this._listingRunTypesFilterModel.combinationOperator,
            },
        };
    }
