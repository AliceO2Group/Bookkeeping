...
export default class Overview extends Observable {
    ...
    isAnyFilterActive() {
        return (
            ...
            || this.o2endFilterTo !== ''
            || this.enviromentIdFilter !== ''
            || this.nDetectorsFilterValues !== 0
            || this.nFlpsFilterValues !== 0
            || this.ddflpFilter !== 0
            || this.dcsFilter !== 0
            || this.epnFilter !== 0
