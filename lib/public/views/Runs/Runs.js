...
export default class RunModel extends Observable {
    ...
    /**
     * Change whether to show the start or end time range
     *
     * @param {Boolean} showStart whether to show the start time range in the filters panel
     * @returns {void}
     */
    setShowO2Start(showStart) {
        this._showO2Start = showStart;
    ...
    /**
     * Get whether to show the start or end time range
     *
     * @returns {Boolean} whether to show the start time range in the filters panel
     */
    getShowO2Start() {
        return this._showO2Start;
    }
