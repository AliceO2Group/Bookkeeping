...
export default class RunModel extends Observable {
    ...
    async fetchAllRuns(clear = false) {
        const concatenateWith = !clear && this._pagination.isInfiniteScrollEnabled ? this._currentPageRuns.payload || [] : null;
        ...
        const params = {
            ...
            'page[offset]': this.pagination.isInfiniteScrollEnabled
        ...
        if (remoteData.isSuccess()) {
            this._pagination.pagesCount = pageCount;
