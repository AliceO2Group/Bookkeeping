...
export default class Overview extends Observable {
    ...
    isAnyFilterActive() {
        return (
            this.runFilterValues !== 0
            || this.tagFilterValues !== 0
            || this.o2startFilterFrom !== ''
            || this.o2startFilterTo !== ''
            || this.o2endFilterFrom !== ''
            || this.o2endFilterTo !== ''
    ...
    getActiveFilters() {
        ...
        if (this.runFilterValues !== 0) {
            this.activeFilters.push('Run Number');
        }
        if (this.tagFilterValues !== 0) {
            this.activeFilters.push('Tags');
        }
        if (this.o2startFilterFrom !== '') {
            this.activeFilters.push('o2start from');
        }
        if (this.o2startFilterTo !== '') {
            this.activeFilters.push('o2start to');
        }
        if (this.o2endFilterFrom !== '') {
            this.activeFilters.push('o2end from');
        }
     ...
     * @param {String} newTitle The environmentId substring to apply to the filter
     * @returns {undefined}
     */
     ...
     * @param {String} newTitle The amount of detectors to apply to the filter
     * @returns {undefined}
     */
     ...
     * @param {String} newTitle The amount of flps to apply to the filter
     * @returns {undefined}
     */
     ...
     * @param {String} newTitle The epnTopology substring to apply to the filter
     * @returns {undefined}
     */
    setEpnTopologyFilter(newTitle) {
        clearTimeout(this.epnTopologyDebounce);
        this.epnTopologyDebounce = setTimeout(() => {
            this.epnTopologyFilter = newTitle.trim();
            this.fetchAllRuns();
        }, 200);
    }
     ...
     * @param {String} newTitle The Detectors substring to apply to the filter
     * @returns {undefined}
     */
