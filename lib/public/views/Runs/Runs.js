...
export default class RunModel extends Observable {
    ...
    constructor(model) {
        ...
        this._eorReasonsFilterModel.observe(() => {console.log(this._eorReasonsFilterModel.newEorReason); this._applyFilters()});
     ...
     * @return {void}
     */
    loadDetails(runId, panelKey = null) {
        if (this._detailsModel === null) {
            this._detailsModel = new RunDetailsModel(runId, panelKey);
    ...
    isAnyFilterActive() {
        return (
            ...
            || this._runEORReasonFilter.length > 0
    ...
    getActiveFilters() {
        ...
        if (this._runEORReasonFilter.length > 0) {
     ...
     * @returns {String} The current runNumber substring filter
     */
    getRunEORReasonFilter() {
        console.log(this._runEORReasonFilter)
        console.log(this.detailsModel)
        return this._runEORReasonFilter;
    }
     ...
     * @returns {undefined}
     */
    setRunEORReasonFilter(reasons) {
        this._runEORReasonFilter = reasons;
        this._applyFilters();
    }
     ...
     * Return the model handling the filtering on run types
     *
     * @return {} the run type filtering model
     */
    ...
    _getFilterQueryParams() {
        console.log(this._eorReasonsFilterModel.newEorReason.category)
        return {
            ...this.runFilterValues && {
            ...
            ...!this._eorReasonsFilterModel.isEmpty() && {
                ...
                'filter[eor][category]': this._eorReasonsFilterModel.newEorReason.category
            },
            ...!this._detectorsFilterModel.isEmpty() && {
