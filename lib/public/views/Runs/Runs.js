...
export default class RunModel extends Observable {
     ...
     * @returns {undefined}
     */
    set lhcPeriodFilter(value) {
        this._lhcPeriodFilter = value;
        this._applyFilters();
    }
    ...
    _getFilterQueryParams() {
        return {
            ...
            ...this._lhcPeriodFilter && {
                'filter[lhcPeriod]': this._lhcPeriodFilter,
            },
            ...this.environmentIdsFilter && {
