...
class RunDetailsTabbedPanelModel extends TabbedPanelModel {
    ...
    /**
     * Retrieve the list of detectors for this run
     *
     * @returns {void}
     * @private
     */
        ...
        if (this._runNumber !== null) {
            try {
                ...
                this.currentPanelData = RemoteData.success(detectors.map((detector) => {
                    const nodeModel = new DetectorTreeNodeModel(detector, this._runNumber);
...
export class HostTreeNodeModel extends CollapsibleTreeNodeModel {
     ...
     * Constructor
     *
     * @param {Detector} value the current value of the node
...
/**
 * Store a detector tree node
 * @extends {CollapsibleTreeNodeModel<Detector, DplProcessTreeNodeModel>}
 */
export class DetectorTreeNodeModel extends CollapsibleTreeNodeModel {
    /**
     * Constructor
     *
     * @param {Detector} value the current value of the node
