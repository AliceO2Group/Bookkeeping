...
export class RunPatch extends Observable {
    ...
    toPojo() {
        ...
        if (this.formData.avgInelasticInteractionRate !== this._run.avgInelasticInteractionRate) {
            ret.avgInelasticInteractionRate = this.formData.avgInelasticInteractionRate;
        }
