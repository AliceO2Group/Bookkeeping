...
export class RunPatch extends Observable {
    ...
    toPojo() {
        ...
        if (this._patch.avgInelasticInteractionRate !== this._run.avgInelasticInteractionRate) {
            ret.avgInelasticInteractionRate = this._patch.avgInelasticInteractionRate;
        }
        if (this._patch.inelasticInteractionRateAtStart !== this._run.inelasticInteractionRateAtStart) {
            ret.inelasticInteractionRateAtStart = this._patch.inelasticInteractionRateAtStart;
        }
        if (this._patch.inelasticInteractionRateAtMid !== this._run.inelasticInteractionRateAtMid) {
            ret.inelasticInteractionRateAtMid = this._patch.inelasticInteractionRateAtMid;
        }
        if (this._patch.inelasticInteractionRateAtEnd !== this._run.inelasticInteractionRateAtEnd) {
            ret.inelasticInteractionRateAtEnd = this._patch.inelasticInteractionRateAtEnd;
        }
