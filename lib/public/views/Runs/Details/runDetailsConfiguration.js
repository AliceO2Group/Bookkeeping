...
export const runDetailsConfiguration = (runDetailsModel) => ({
    ...
    tags: {
        name: 'Tags',
        visible: true,
        format: (tags) => formatTagsList(tags, { flex: true, description: true }),
    },
    timeO2Start: {
        name: 'O2 Start',
        visible: true,
    ...
    muInelasticInteractionRate: {
        ...
        visible: (_, { pdpBeamType, definition }) => pdpBeamType === PdpBeamType.PROTON_PROTON && definition === RunDefinition.Physics,
        format: formatFloat,
    },
    ...
    inelasticInteractionRateAtStart: {
        ...
        visible: (_, { pdpBeamType, definition }) => pdpBeamType === PdpBeamType.LEAD_LEAD && definition === RunDefinition.Physics,
        format: () => formatEditableNumber(
            runDetailsModel.isEditModeEnabled,
