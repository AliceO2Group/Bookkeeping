    ...
    if (data.isSuccess()) {
        ...
        return [
            ...
            h('.flex-row.mv2', [
                ...
                h('label.form-check-label.f5.w-11.mh2', 
                'Add Log Entries to the Run',)
            ]),
            h('.flex-row.mv2', [
                ...
                h('label.align-bottom.form-check-label.f5.w-15.mh2', 
                'Add one or multiple Tags to the Run. ',
                '(CTRL + click to select multiple tags).'),
            ]),
            h('select#tags-control.form-control.w-40', {
                multiple: true,
