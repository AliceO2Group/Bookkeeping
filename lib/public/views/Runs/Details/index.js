            ...
            h('.flex-column.w-100', [
                ...
                h('.flex-row.w-100', [
                    ...
                    h('.flex-column.w-60', [
                        ...
                        }, !tagsAvailable ? h('option', { onclick: () => model.router.go('?page=tag-create'),
