...
import { runDetailsComponent } from '../../../components/RunDetail/runDetailsComponent.js';
    ...
    if (data.isSuccess()) {
        ...
        return [
            h('.flex-column.w-100', [
                            ...
                            [
                                ...
                                h('button.btn#edit-run', {
                                    onclick: () => {
                                        ...
                                        model.runs.detailsModel.runChanges = { key: 'eorReasons', value: data.payload.eorReasons };
                                    },
                                }, 'Edit Run'),
                            ]
                            : [
                ...
                h('.flex-row.w-100', [
                    h('.w-40.ph1', runDetailsComponent(model.runs.detailsModel, data.payload)),
