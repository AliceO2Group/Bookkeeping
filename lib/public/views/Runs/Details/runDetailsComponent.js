                        ...
                        h(PanelComponent, { class: 'flex-grow' }, [
                            ...
                            h('.flex-row.p2.items-center.g3', [
                                h('.flex-column.items-center.flex-grow', [
                                    ...
                                    formatFloat(run.aliceDipoleCurrent),
                                ]),
                                h('.flex-column.items-center.flex-grow', [
                                ...
                                h('.flex-column.items-center.flex-grow', [
                                    h('strong', 'L3 Current'),
                                    formatFloat(run.aliceL3Current),
                                ]),
                                h('.flex-column.items-center.flex-grow', [
                                    ...
                                    ? [
                                        ...
                                        h('.flex-column.p2.g2', [
                                            ...
                                            h('', [
                                                ...
                                                run.lhcBeamEnergy ? `${formatFloat(run.lhcBeamEnergy)} GeV` : '-',
                                            ]),
                                            h('', [
                                            ...
                                            h('.flex-row', [
                                                h('.flex-grow', [
                                                    ...
                                                    formatFloat(run.triggerAcceptance) ?? '-',
                                                ]),
                                                h('.flex-grow', [
                                                    h('strong', 'X-sec: '),
                                                    formatFloat(run.crossSection) ? `${formatFloat(run.crossSection)} µb` : '-',
                                                ]),
                                            ]),
                                            h('.flex-row', [
                                                h('.flex-grow', h('strong', 'B1 - Phase Shift: ')),
                                                h('.flex-grow', [
                                                    h('small', 'start: '),
                                                    formatFloat(run.phaseShiftAtStartBeam1) ?? '-',
                                                    h('strong', ' | '),
                                                    h('small', 'end: '),
                                                    formatFloat(run.phaseShiftAtEndBeam1) ?? '-',
                                                ]),
                                            ]),
                                            h('.flex-row', [
                                                h('.flex-grow', h('strong', 'B2 - Phase Shift: ')),
                                                h('.flex-grow', [
                                                    h('small', 'start: '),
