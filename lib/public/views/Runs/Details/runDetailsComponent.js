 ...
 */
export const runDetailsComponent = (runDetailsModel, router, roles) => runDetailsModel.runDetails.match({
    NotAsked: () => null,
    Loading: () => spinner(),
    Failure: (errors) => h('', [
    ...
    Success: (run) => [
        h('.flex-column.w-100', [
                        ...
                        : [
                            linkOrDisabledOrNull(
                                ...
                                null,
                                {
                                    ...
                                    id: 'save-run',
                                    onclick: () => {
                                        runDetailsModel.updateOneRun(); runDetailsModel.clearAllEditors();
                                    },
                                    isLink: false,
                                },
                            ),
            ...
            h('.flex-row.w-100', [
                h(
                    '.w-40.ph1',
                    detailsList(runDetailsConfiguration(runDetailsModel, roles), run, { selector: 'Run' }),
                ),
