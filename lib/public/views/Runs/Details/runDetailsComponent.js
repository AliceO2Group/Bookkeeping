...
import { getAliEcsEnvironmentLink } from '../../../components/common/externalLinks/getAliEcsEnvironmentLink.js';
...
export const runDetailsComponent = (runDetailsModel, router) => runDetailsModel.runDetails.match({
    ...
    Success: (run) => {
        ...
        const aliEcsEnvironmentLink = getAliEcsEnvironmentLink(run.environmentId);
        ...
        return [
            h('.flex-column.w-100', [
                ...
                (flpInfologgerLinkUrl || epnInfologgerLinkUrl) && h('h3.external-links.flex-row.w-100.g2.items-baseline.mb3', [
                    ...
                    isRunConsideredRunning(run) && aliEcsEnvironmentLink && [h('', '-'), aliEcsEnvironmentLink],
                ]),
