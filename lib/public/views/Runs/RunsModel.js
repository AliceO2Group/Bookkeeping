...
import { RunsPeriodPeriodOverviewModel } from './RunPerPeriod/RunsPerPeriodOverviewModel.js';
...
export class RunsModel extends Observable {
    ...
    constructor(model) {
        ...
        this._perPeriodOverviewModel = new RunsPeriodPeriodOverviewModel(model);
        this._perPeriodOverviewModel.bubbleTo(this);
    }
     ...
     * @return {void}
     */
    loadPerPeriodOverview({ lhcPeriodName }) {
        if (!this._perPeriodOverviewModel.pagination.isInfiniteScrollEnabled) {
            this._perPeriodOverviewModel.fetchRuns({ lhcPeriodName });
            this._perPeriodOverviewModel._fetchAllDetectors();
        }
    }

    /**
     * Returns the model for the overview page
     * @return {RunsPeriodPeriodOverviewModel} the overview model
     */
    get perPeriodOverviewModel() {
        return this._perPeriodOverviewModel;
    }
}
