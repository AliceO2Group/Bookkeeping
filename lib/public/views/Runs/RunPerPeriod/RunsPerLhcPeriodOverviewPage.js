...
import { createRunDetectorsSyncQcActiveColumns } from '../ActiveColumns/runDetectorsActiveColumns.js';
...
export const RunsPerLhcPeriodOverviewPage = ({ runs: { perLhcPeriodOverviewModel }, modalModel }) => {
    ...
    const { items: runs, detectors: remoteDetectors, lhcPeriodName } = perLhcPeriodOverviewModel;
    ...
    return h('', [
        ...
        h('.flex-column.w-100', [
            table(remoteDetectors.isSuccess() ? runs : remoteDetectors, activeColumns, null, { profile: 'runsPerLhcPeriod' }),
