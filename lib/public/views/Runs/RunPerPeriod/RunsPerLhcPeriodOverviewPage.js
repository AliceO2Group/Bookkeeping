...
export const RunsPerLhcPeriodOverviewPage = ({ runs: { perLhcPeriodOverviewModel }, modalModel }) => {
    ...
    const activeColumns = {
        ...
        ...(displaySync ? runDetectorsSyncQcActiveColumns : runDetectorsOnlineGeneralQcActiveColumns)(remoteDetectors.match({
    ...
    return h('', [
        h('.flex-row.justify-between', [
            ...
            h('input', {
                type: 'checkbox',
                checked: displaySync,
                onchange: () => { perLhcPeriodOverviewModel.displaySync = !displaySync; },
            }),
