...
import { tableDisplayOptionsDropdown } from '../../../components/common/table/tableDisplayOptionsDropdown.js';
...
export const RunsPerLhcPeriodOverviewPage = ({ runs: { perLhcPeriodOverviewModel }, modalModel }) => {
    ...
    return h('', [
        h('.flex-row.justify-between.items-center.g2', [
            ...
            tableDisplayOptionsDropdown(perLhcPeriodOverviewModel),
        ]),
        h('.flex-column.w-100', [
            table(
                ...
                null,
                {
                    ...
                    xScrollable: perLhcPeriodOverviewModel.xDisplayScrollable,
                },
            ),
