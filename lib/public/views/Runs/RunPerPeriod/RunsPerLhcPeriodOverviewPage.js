...
import { createDetectorsActiveColumns } from '../ActiveColumns/detectorsActiveColumns.js';
...
export const RunsPerLhcPeriodOverviewPage = ({ runs: { perLhcPeriodOverviewModel }, modalModel }) => {
    ...
    const activeColumns = {
        ...runsActiveColumns,
        ...createDetectorsActiveColumns(perLhcPeriodOverviewModel.detectors.match({
    ...
    return h('', [
        ...
        h('.flex-column.w-100', [
            table(perLhcPeriodOverviewModel.runs, activeColumns, null, { profile: 'runsPerLhcPeriod' }),
