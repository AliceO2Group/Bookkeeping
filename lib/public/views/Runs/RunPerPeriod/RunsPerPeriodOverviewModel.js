 ...
 */
export class RunsPeriodPeriodOverviewModel extends RunsOverviewModel {
    /**
     * Constructor
    ...
    constructor(model) {
        ...
        this._remoteDataSource.bubbleTo(this);
        this._detectorsProvider = detectorsProvider;
        this._detectorsProvider.getAll();
        // eslint-disable-next-line no-return-assign
        this._remoteDataSource.observe(() => this._pagination.itemsCount = this._remoteDataSource.totalCount);
    }
    ...
    async fetchRuns({ lhcPeriodName } = {}) {
        ...
        await this._remoteDataSource.fetch(endpoint);
    }
     ...
     */
    get runs() {
        return this._remoteDataSource.observableData.current;
    }
