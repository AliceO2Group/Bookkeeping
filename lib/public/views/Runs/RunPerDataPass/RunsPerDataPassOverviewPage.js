 ...
 *
 * @param {RunsPerDataPassOverviewModel} model the model of the runs overview
 * @returns {Component} the toggle switch
 */
export const toggleMcReproducibleAsNotBad = (model) => switchInput(
    model.mcReproducibleAsNotBad,
    () => model.setMcReproducibleAsNotBad(!model.mcReproducibleAsNotBad),
...
export const RunsPerDataPassOverviewPage = ({
    ...
    return h('', [
        h('.flex-row.justify-between.items-center.g2', [
            ...
            toggleMcReproducibleAsNotBad(perDataPassOverviewModel),
