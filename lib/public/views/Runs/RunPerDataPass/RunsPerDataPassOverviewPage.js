...
import { exportQcFlagsTriggerAndModal } from './exportQcFlagsTriggerAndModal.js';
...
export const RunsPerDataPassOverviewPage = ({
    ...
    return h('', { onremove: () => perDataPassOverviewModel.reset(false) }, [
        h('.flex-row.justify-between.items-center.g2', [
            ...
            exportQcFlagsTriggerAndModal(perDataPassOverviewModel, modalModel, { autoMarginLeft: false }),
        ]),
