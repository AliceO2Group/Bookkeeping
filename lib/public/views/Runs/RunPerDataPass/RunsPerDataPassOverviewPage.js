...
export const RunsPerDataPassOverviewPage = ({
    ...
    // The table drawing can be done without using mergeRemoteData, but that will redraw it each independent update to dataPass, detectors, or qcSummary.
    // While this wouldn't necessarly be noticable for users, it would would detach nodes from the document.
    // That would make writing integration test difficult and unreliable.
