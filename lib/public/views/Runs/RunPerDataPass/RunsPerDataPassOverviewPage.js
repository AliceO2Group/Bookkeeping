...
import { h, iconWarning, info, iconPlus } from '/js/src/index.js';
...
/**
 * Render QC summary tooltip
 * @return {Componenet} qc summary info tooltip
 */
const qcSummaryInfoTooltip = () => tooltip(info(), h('.flex-column.g3', [
