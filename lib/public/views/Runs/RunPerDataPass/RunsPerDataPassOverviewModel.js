...
export class RunsPerDataPassOverviewModel extends RunsOverviewModel {
     ...
     * @param {string} [params.dataPassId] data pass name which runs should be fetched
     * @return {void}
     */
    async fetchRuns({ dataPassId } = {}) {
    ...
    /**
     * Get id of current data pass which runs are fetched
     */
    get dataPassId() {
