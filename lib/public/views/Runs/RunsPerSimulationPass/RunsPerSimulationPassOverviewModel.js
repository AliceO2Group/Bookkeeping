...
import { filterOutLegacyDetectorsForNewerPeriods } from '../../../utilities/stringUtils.js';
...
export class RunsPerSimulationPassOverviewModel extends FixedPdpBeamTypeRunsOverviewModel {
    ...
    constructor(model, pageIdentifier) {
        ...
        this._detectors$ = this._setDetectorsObservable(
            ...
            ([detectors, simulationPass]) => {
                return filterOutLegacyDetectorsForNewerPeriods(detectors, simulationPass.name);
            },
        );
    }
