 ...
 * @param {(event: InputEvent) => void} oninput callback
 * @param {object} [options] additional options for the formatting
 ...
 * @param {string} [options.unit = null] unit to display
...
export const formatEditableNumber = (
    ...
    if (isEditionEnabled) {
        return h('.flex-row.g1.items-center', [
