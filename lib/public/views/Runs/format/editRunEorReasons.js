...
import { h, iconTrash } from '@aliceo2/web-ui/Frontend/js/src/index.js';
import { iconPlus } from '@aliceo2/web-ui/Frontend/js/src/index.js';
...
export const editRunEorReasons = (runDetailsModel) => {
    ...
    return eorReasonTypesRemoteData.match({
        ...
        Success: (eorReasonTypes) => {
            ...
            newEorReasonComponent = h('.flex-row.items-center', [
