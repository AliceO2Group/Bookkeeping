 ...
 */
export const formatDetectorQuality = (detectorQuality) => detectorQuality === undefined
    ? h('m2.badge', iconBan())
    : badge(detectorQuality, { color: `var(${OnlineGeneralQualityColors[detectorQuality] ?? ''})` });
