 ...
 * @param {number} [options.step] precision of input value
 * @param {number} [options.precision] precision of displayed value
...
export const formatEditableNumericValue = (
    ...
    propertyName,
    runDetailsModel,
    { inputPrecision = 0.001, precision: displayPrecision = 3 } = {},
) => {
    if (runDetailsModel.isEditModeEnabled) {
        ...
        return value !== null && value !== undefined ? h('', Number(run[propertyName]).toFixed(displayPrecision)) : '-';
    }
};
