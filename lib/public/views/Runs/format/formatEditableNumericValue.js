 ...
 */
export const formatEditableNumericValue = (run, propertyName, runDetailsModel, { step = 0.001, precision = 3 } = {}) => {
    if (runDetailsModel.isEditModeEnabled) {
        ...
        return value !== null && value !== undefined ? h('', Number(run[propertyName]).toFixed(precision)) : '-';
    }
};
