...
const exportForm = (runsOverviewModel, runs, modalHandler) => {
    ...
    const optionalTruncatedInfo = () => runsOverviewModel.areExportableItemsTruncated
        ? h(
...
const exportRunsModal = (runsOverviewModel, modalHandler) => {
    runsOverviewModel.loadExportableRuns();
    const runsRemoteData = runsOverviewModel.exportableItems;
