 ...
 * @param {boolean} [displayConfiguration.autoMarginLeft = true] if true `.mlauto` class is applied, otherwise not
 * @returns {Component} button
 */
export const exportRunsTriggerAndModal = (runsModel, modalModel, { autoMarginLeft = true } = {}) =>
