...
const exportModal = (model, modalHandler, activeColumns) => {
    const runsRemoteData = model.allRuns;
 ...
 */
export const exportTriggerAndModal = (model, modalModel, activeColumns) => h('button.btn.btn-primary.w-15.h2.mlauto#export-runs-trigger', {
