...
export class RunsWithQcModel extends RunsOverviewModel {
    ...
    constructor(model) {
        ...
        this._filteringModel
            .put('detectorsQcNotBadFraction', new MultiCompositionFilterModel({ mcReproducibleAsNotBad: this._mcReproducibleAsNotBad }));
    }
    ...
    registerDetectorsNotBadFractionFilterModels(detectors$) {
        const detectorsQcNotBadFraction = this._filteringModel.get('detectorsQcNotBadFraction');
