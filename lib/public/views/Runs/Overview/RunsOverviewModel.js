...
export class RunsOverviewModel extends OverviewPageModel {
    ...
    constructor(model) {
        ...
        this._muInelasticInteractionRateFilterModel
            .observe(() => !this._muInelasticInteractionRateFilterModel.isEmpty && this._applyFilters());
        ...
        this._inelasticInteractionRateAvgFilterModel
            .observe(() => !this._inelasticInteractionRateAvgFilterModel.isEmpty && this._applyFilters());
    ...
    getActiveFilters() {
        ...
        if (this._aliceL3AndDipoleCurrentFilter.selected.length !== 0) {
            this.activeFilters.push('Alice L3/dipole current');
        }
