...
export class RunsOverviewModel extends OverviewPageModel {
    ...
    constructor(model) {
        ...
        this._filteringModel = new FilteringModel({
            ...
            detectors: {
                model: new DetectorsFilterModel(detectorsProvider.dataTaking$),
                label: 'Detectors',
            },
            runTypes: {
                model: new RunTypesFilterModel(),
                label: 'Run Types',
            },
            eorReason: {
                model: new EorReasonFilterModel(),
                label: 'EOR Reason',
            },
        });
        ...
        return {
            ...
            ...Object.fromEntries(Object.entries(inelFilterModels)
                ...
                .map(([property, filterModel]) => [
                    `filter[${property}][${filterModel.value.operator}]`,
