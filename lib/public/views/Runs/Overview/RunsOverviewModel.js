...
export class RunsOverviewModel extends OverviewPageModel {
    ...
    constructor(model) {
        ...
        this._xDisplayScrollable = false;
    ...
    /**
     * Get info whether table should be styled to be scrollable horizontally
     */
    get xDisplayScrollable() {
        return this._xDisplayScrollable;
    }

    /**
     * Set info whether table should be styled to be scrollable horizontally
     * @param {Boolean} xDisplayScrollable whether display is scrollabe
     */
    set xDisplayScrollable(xDisplayScrollable) {
        this._xDisplayScrollable = Boolean(xDisplayScrollable);
    }
}
