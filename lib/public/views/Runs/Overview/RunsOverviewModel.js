...
export class RunsOverviewModel extends OverviewPageModel {
    ...
    constructor(model) {
        ...
        this._nEpnsFilterModel = new NumericFilterModel({ min: 0 });
        this._nEpnsFilterModel.observe(() => this._applyFilters());

        this._nDetectorsFilterModel = new NumericFilterModel({ min: 0 });
        this._nDetectorsFilterModel.observe(() => this._applyFilters());

        this._nFlpsFilterModel = new NumericFilterModel({ min: 0 });
    ...
    reset(fetch = true) {
        ...
        this._nDetectorsFilterModel.reset();

        this._nEpnsFilterModel.reset();

        this._nFlpsFilterModel.reset();
