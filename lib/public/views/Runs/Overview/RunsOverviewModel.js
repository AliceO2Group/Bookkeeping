...
export class RunsOverviewModel extends OverviewPageModel {
    ...
    _getFilterQueryParams() {
        return {
            ...
            ...!this._inelasticInteractionRateAvgFilterModel.isEmpty && {
                [`filter[inelasticInteractionRateAvg][${this._inelasticInteractionRateAvgFilterModel.current.operator}]`]:
                    this._inelasticInteractionRateAvgFilterModel.current.value,
            },
        };
    }
