...
export class RunsOverviewModel extends OverviewPageModel {
    ...
    constructor(model) {
        ...
        this._filteringModel = new FilteringModel(model.router, 
            ['home', 'run-overview', 'runs-per-lhc-period', 'runs-per-data-pass', 'runs-per-simulation-pass', 'run-detail'],
            {
    ...
    filterQuery2() {
            console.log();
            console.log();
            console.log('filterQuery normalizedFilter:', JSON.stringify(this._filteringModel.normalizedFilter));
            console.log();
            console.log();
            
            return { filter: this.filteringModel.normalizedFilter };
    }
     ...
     */
    getRootEndpoint() {
        // const normalizedFilter = this.filteringModel.normalizedFilter;
        // const filterParams = this._getFilterQueryParams();
        // const manuallyComputedQuery = { ...filterParams, filter: normalizedFilter };
        
        // const something =  this.filterQuery2();
        // console.log(something);
        // console.log(this._filteringModel.normalizedFilter);
        

        // console.log('normalizedFilter (captured early):', JSON.stringify(normalizedFilter));
        // console.log('normalizedFilter (read now):', JSON.stringify(this.filteringModel.normalizedFilter));
        // console.log('filterQuery:', JSON.stringify(this.filterQuery));

        return buildUrl('/api/runs', this.filterQuery2());
    }
    /**
