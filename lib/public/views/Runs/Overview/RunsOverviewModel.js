...
export class RunsOverviewModel extends OverviewPageModel {
    ...
    constructor(model) {
        ...
        // Exportable items
        this.exportModel = new ExportManager();
        ...
        this._exportItems = ObservableData.builder()
            ...
            .apply((current) => current.apply({ Success: (payload) => {
                this.exportModel.areExportItemsTruncated = payload.length < this.pagination.itemsCount;
                return payload;
            } }))
            .build();
