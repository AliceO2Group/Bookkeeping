 ...
 */
export default class RunsOverviewModel extends Observable {
    /**
    ...
    constructor(model) {
        ...
        this._pagination.observe(() => this.Runs());
        ...
        const updateDebounceTime = () => this._debouncedFetchAllRuns = debounce(this._fetchAllRuns.bind(this), model.inputDebounceTime);
     ...
     */
    async _fetchAllRuns(clear = false) {
    ...
    _applyFilters(now = false) {
        ...
        now ? this._fetchAllRuns() : this._debouncedFetchAllRuns(true);
    }
}
