...
export class RunsOverviewModel extends OverviewPageModel {
    ...
    constructor(model) {
        ...
        this._o2StartFilterModel.observe(() => this._applyFilters(true));
        this._o2StartFilterModel.visualChange$.bubbleTo(this);

        this._o2StopFilterModel = new TimeRangeInputModel();
        this._o2StopFilterModel.observe(() => this._applyFilters(true));
    ...
    _getFilterQueryParams() {
        ...
        return {
            ...
            ...!this._detectorsFilterModel.isEmpty() && {
                'filter[detectors][operator]': encodeURIComponent(this._detectorsFilterModel.combinationOperator),
            ...
            ...this.nDetectorsFilter && this.nDetectorsFilter.limit !== null && {
                'filter[nDetectors][operator]': encodeURIComponent(this.nDetectorsFilter.operator),
                'filter[nDetectors][limit]': this.nDetectorsFilter.limit,
            },
            ...this.nFlpsFilter && this.nFlpsFilter.limit !== null && {
                'filter[nFlps][operator]': encodeURIComponent(this.nFlpsFilter.operator),
                'filter[nFlps][limit]': this.nFlpsFilter.limit,
            },
            ...this.nEpnsFilter && this.nEpnsFilter.limit !== null && {
                'filter[nEpns][operator]': encodeURIComponent(this.nEpnsFilter.operator),
