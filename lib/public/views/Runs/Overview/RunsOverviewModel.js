...
export class RunsOverviewModel extends OverviewPageModel {
    ...
    constructor(model) {
        ...
        this._aliceL3CurrentFilter = new SelectionDropdownModel({
            multiple: false,
            availableOptions: [
                {
                    value: '-30kA',
        ...
        this._aliceL3CurrentFilter.observe(() => this._applyFilters());
        this._aliceL3CurrentFilter.visualChange$.bubbleTo(this);
     ...
     */
    getRootEndpoint() {
        const { aliceL3Current } = this._aliceL3CurrentFilter.selectedOptions[0]?.filteringParams ?? {};

        return buildUrl(buildUrl('/api/runs', this._getFilterQueryParams()), aliceL3Current ? { filter: { aliceL3Current } } : {});
    }
    ...
    reset(fetch = true) {
        ...
        this._aliceL3CurrentFilter.reset();
    ...
    isAnyFilterActive() {
        return (
            ...
            || this._aliceL3CurrentFilter.selected.length !== 0
            || this._fillNumbersFilter !== ''
            || this.o2startFilterFrom !== ''
            || this.o2startFilterTo !== ''
            || this.o2startFilterToTime !== '23:59'
    ...
    getActiveFilters() {
        ...
        if (this._aliceL3CurrentFilter.selected.length !== 0) {
    ...
    _getFilterQueryParams() {
        return {
            ...
            /*
             * ...this._aliceL3CurrentFilter.selected.length > 0 && {
             *     'filter[aliceL3Current]': this._aliceL3CurrentFilter.selectedOptions[0].filteringParams.aliceL3Current,
             *     // 'filter[aliceL3Current][>]': this._aliceL3CurrentFilter.selectedOptions[0].filteringParams.aliceL3Current['>'],
             *     // 'filter[aliceL3Current][<]': this._aliceL3CurrentFilter.selectedOptions[0].filteringParams.aliceL3Current['<'],
             * },
             */
