 ...
 * @param {RunsOverviewModel} runsModel global model to access functions
 * @param {ModelModel} modalModel global model to access functions
 * @returns {Component} with button
 */
export const exportRunsButton = (runsModel, modalModel) => h('button.btn.btn-primary.w-15.h2.mlauto#export-runs-trigger', {
    disabled: (runsModel.runs?.payload?.length ?? 0) === 0,
