...
export default class Overview extends Observable {
     ...
     * @returns {undefined}
     */
    toggleMainFilterExpanded() {
        if (this.isMainFilterExpanded === false) {
            this.expandedMainFilter = true;
        }
        this.notify();
    }
     ...
     * @returns {Boolean} Whether the provided filter is expanded or not
     */
    isMainFilterExpanded() {
        return this.expandedMainFilter;
    }
