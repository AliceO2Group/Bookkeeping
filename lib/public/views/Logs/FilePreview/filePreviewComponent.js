...
import { h, RemoteData, StatefulComponent } from '/js/src/index.js';
...
class FileDisplayComponent extends StatefulComponent {
     ...
     * @param {object} parameters.attrs the attributes
     * @param {Blob|File} parameters.attrs.file the file or blob to display
     * @param {string} parameters.attrs.fileName the display name of the file
     */
...
/**
 * States if the preview for the given mime type is scrollable
 *
 * @param {string} mimeType the mime type to look for scroll-ability
 * @return {boolean} true if the preview is scrollable
 */
export const isPreviewScrollable = (mimeType) => getFileType(mimeType) !== 'image';
