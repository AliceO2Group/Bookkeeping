...
import { FilePreviewModel } from '../FilePreview/FilePreviewModel.js';
...
export class LogTreeViewModel extends Observable {
    ...
    async _fetchLogTree(selectedLogId) {
        ...
        const isSingleTree = this._logTreeLeafs.isSuccess() ? this._logTreeLeafs.payload.length === 1 : false;
    ...
    /**
     * Returns the file preview model
     *
     * @returns {FilePreviewModel} the file preview model
     */
    get filePreviewModel() {
        return this._filePreviewModel;
    }
}
