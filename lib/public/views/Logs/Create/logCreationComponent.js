...
const attachmentsPanel = (logCreationModel) => {
    ...
    return labeledInput(
        ...
        h('.flex-column.p2.g2', [
            ...
            }, [...attachments].map((attachment) => [showFilePreview(attachment, logCreationModel)])),
        ]),
    );
};
 ...
 * @param {LogCreationModel} logCreationModel logs creation model for getting and setting the attachment previews
