 ...
 * @param {Object} opts component creation opts
 * @param {string} [opts.authenticationToken] token to authenticate the session with the api
 * @param {Object} [opts.parentLogMarkdownDisplayOpts] markdown display opts @see logText opts argument
        ...
        h('.w-60.flex-column.g3', [
            parentLog === null ? titlePanel(creationModel)
                : logComponent(
                    ...
                    { ...opts,
                        logMarkdownDisplayOpts: opts.parentLogMarkdownDisplayOpts,
