 ...
 */
const titlePanel = (logCreationModel, parentLog) => labeledInput(
    { for: 'title' },
    `${parentLog ? `Reply to log: ${parentLog.title}` : 'New log'}`,
    h('input#title.form-control.panel-body.bg', {
        placeholder: 'Enter the title of the log entry...',
        minlength: 3,
        maxlength: 140,
        value: logCreationModel.title,
        disabled: parentLog !== null,
        oninput: (e) => {
