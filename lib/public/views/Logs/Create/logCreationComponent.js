 ...
 * @param {Component} title title of the form
 * @param {Component|undefined} mainPane main form pane, of the left side of the screen
 * @param {Component|undefined} sidePane side form pane, on the right side of the screen
 */
            ...
            title: [
                ...
                h(
                    ...
                    [
                        ...
                        ...Object.keys(templates).map((key) => h('option', { key, value: key }, template?.label ?? key)),
                    ],
                ),
            ],
        }),
