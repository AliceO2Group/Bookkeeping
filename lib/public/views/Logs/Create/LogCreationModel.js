...
export class LogCreationModel extends Observable {
    ...
    constructor(onCreation, parentLogId, { runNumbers, lhcFillNumbers, environmentIds }) {
        ...
        this._dataDisplayDelimiter = ', ';
        this._runNumbers = runNumbers.join(this._dataDisplayDelimiter);
        this._lhcFills = lhcFillNumbers.join(this._dataDisplayDelimiter);
        this._environments = environmentIds.join(this._dataDisplayDelimiter);
    ...
    /**
     * Check whether calling instance was created with same set of arguments
     * @param {number|null} parentLogId optionally the id of log that will be the parent of the created one
     * @param {string[]} preFilledRelations.runNumbers the run numbers to link to the log being created
     * @param {string[]} preFilledRelations.lhcFillNumbers the fill numbers to link to the log being created
     * @param {string[]} preFilledRelations.environmentIds the environment ids to link to the log being created
     * @returns {boolean} true if calling instance was created with same set of arguments
     */
    areSameArguments(parentLogId, { runNumbers, lhcFillNumbers, environmentIds }) {
