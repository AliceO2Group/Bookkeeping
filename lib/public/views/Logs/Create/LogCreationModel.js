...
export class LogCreationModel extends Observable {
    ...
    constructor(onCreation, relations) {
        ...
        const { runNumbers = [], environmentIds = [], lhcFillNumbers = [], templateKey = '', issueDescription = '', detectorOrSubsystem = '' } = relations;
    ...
    async submit() {
        ...
        const { title, text, parentLogId, runNumbers, environments, lhcFills, attachments, templateKey, issueDescription, detectorOrSubsystem } = this;
