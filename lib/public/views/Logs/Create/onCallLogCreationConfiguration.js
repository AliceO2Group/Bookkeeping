...
export const onCallLogCreationConfiguration = (creationModel, template) => {
    ...
    return {
        mainPane: [
            h(PanelComponent, [
                h(LabelPanelHeaderComponent, 'Short description'),
            ...
            h('.flex-row.g3', [
                h(PanelComponent, [
                    h(LabelPanelHeaderComponent, 'Detector or subsystem to be called'),
                ...
                h(PanelComponent, { class: 'flex-grow' }, [
                    h(LabelPanelHeaderComponent, 'Severity level of the issue'),
                    h(
                        'select.form-control',
                ...
                h(PanelComponent, { class: 'flex-grow' }, [
                    h(LabelPanelHeaderComponent, 'Scope of the issue'),
                    h(
                        'select.form-control',
            ...
            h('.flex-row.g3', [
                h(PanelComponent, { class: 'flex-grow' }, [
                    h(LabelPanelHeaderComponent, 'Shifter name'),
                    h('input.form-control', { disabled: true, value: template.formData.shifterName }),
                ]),
                h(PanelComponent, { class: 'flex-grow' }, [
                    h(LabelPanelHeaderComponent, 'Shifter position'),
                    h(
                        'select.form-control',
            ...
            h(PanelComponent, [
                h(LabelPanelHeaderComponent, 'LHC Beam mode'),
                h(
            ...
            h(PanelComponent, { class: 'flex-column flex-grow' }, [
                h(LabelPanelHeaderComponent, 'Description of the issue'),
                markdownInput(
            ...
            h(PanelComponent, { class: 'flex-column flex-grow' }, [
                h(LabelPanelHeaderComponent, 'Reason to call this on-call'),
                markdownInput(
            ...
            h(PanelComponent, { class: 'flex-column flex-grow' }, [
                h(LabelPanelHeaderComponent, 'Actions already taken'),
                markdownInput(
