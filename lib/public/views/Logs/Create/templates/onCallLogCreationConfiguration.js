...
export const onCallLogCreationConfiguration = (creationModel, template) => {
    ...
    return {
        mainPane: [
            h(PanelComponent, [
                h(LabelPanelHeaderComponent, { required: true, for: 'shortDescription' }, 'Short description (between 4 and 30 characters)'),
                h('input#shortDescription.form-control', {
                    placeholder: 'Enter a short description of the issue',
                    pattern: '.{4,30}',
                    value: template.formData.shortDescription || creationModel._description,
                            ...
                            h(
                                ...
                                [
                                    ...
                                    ...systems.map((detectorOrSubsystem) => h(
                                        'option',
                                        { value: detectorOrSubsystem, selected: creationModel._system === detectorOrSubsystem },
                                        detectorOrSubsystem,
                                    )),
                                ],
                            ),
