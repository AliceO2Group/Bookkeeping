...
export class LogsOverviewModel extends Observable {
    ...
    _getFilterQueryParams() {
        ...
        const authorFilterQueryParams = this._authorFilter.filterQueryParams;
        ...
        return {
            ...
            ...authorFilterQueryParams.length > 0 && {
                'filter[author]': authorFilterQueryParams.join(),
            },
            ...this.createdFilterFrom && {
                'filter[created][from]':
