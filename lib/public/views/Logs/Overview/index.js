 ...
 * @param {Boolean} value Element to be checked.
 ...
 * @param {Object} logsColumns Columns of logs
 * @param {Array} options Array of possible options
 * @returns {vnode} Return the view of the table with the filtering options
 */
        ...
        h('.w-90', data.isSuccess() && h('.w-100.flex-column.mh3', [
            ...
            h('.flex-row.justify-between.mv3', [
                ...
                h('.w-15', amountSelector(() =>
                    ...
                    model.logs.setLogsPerPage(amount), amountDropdownVisible, AVAILABLE_AMOUNTS, logsPerPage, model.logs)),
                pageSelectorVisible
