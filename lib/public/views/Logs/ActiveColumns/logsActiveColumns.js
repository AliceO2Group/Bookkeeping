    ...
    title: {
        ...
        filter: ({ filteringModel }) =>
            rawTextFilter(
                ...
                { id: 'titleFilterText', classes: ['w-75 mt1'], placeholder: 'e.g. Report on runs: ...' },
            ),
        balloon: true,
        profiles: {
            embeded: true,
    ...
    text: {
        ...
        filter: ({ filteringModel }) =>
            rawTextFilter(
                ...
                { id: 'contentFilterText', classes: ['w-75 mt1'], placeholder: 'e.g. Quality of run 52...' },
            ),
    },
    author: {
        name: 'Author',
         ...
         * @return {Component} the filter component
         */
        filter: ({ filteringModel }) => authorFilter(filteringModel.get('author')),
        profiles: [profiles.none, 'embeded'],
    },
    createdAt: {
        name: 'Created',
