 ...
 */
const tagOverview = (model) => h('', { onremove: () => model.tags.overview.reset() }, showTagsTable(model, model.tags.overview.tagsList));
...
const showTagsTable = (model, tags) => [
    ...
    h('.flex-row', [
        h('.w-100.flex-column', [
            table(tags, tagsActiveColumns, { filterModel: model.tags.overview }, (entry) => ({
