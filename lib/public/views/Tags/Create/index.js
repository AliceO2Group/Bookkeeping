...
const tagCreationForm = ({ data }) => {
    const { text, description, email, mattermost, color } = data;

    return [
        h('label.form-check-label.f4.mt2', { for: 'text' }, 'Text (between 2 and 20 characters)'),
        ...
        h('textarea#description.v-resize.form-control.w-25.mb2', {
