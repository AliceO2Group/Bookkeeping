...
export default class AboutModel extends Observable {
     ...
     * @return {Object} Constructs the About model
     */
    constructor(model) {
        super();
        this.model = model;
    ...
    async fetchAppInfo() {
        ...
        try {
            ...
            this._appInfo = RemoteData.failure(error);
        }
        this.notify();
    }
    ...
    async fetchDbInfo() {
        ...
        try {
            ...
            this._dbInfo = RemoteData.failure(error);
        }
        this.notify();
    }
    ...
    /**
     * Get the app info
     * @return {RemoteData} information about the app service
     */
    get appInfo() {
     ...
     * @return {RemoteData} information about the database service
     */
    get dbInfo() {
        return this._dbInfo;
    }
