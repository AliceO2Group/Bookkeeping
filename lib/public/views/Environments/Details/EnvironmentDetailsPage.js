    ...
    Success: (environment) => {
        ...
        return h('.flex-column.g3', [
            h('.flex-row.items-center.g3', [
                ...
                h('#environment-status-badge.f3.badge.bg-primary.white', coloredEnvironmentStatusComponent(status)),
            ]),
...
const historyItemComponent = (historyItem, options) => {
    ...
    return [
        ...
        h(
            ...
            componentAttributes,
            [
                h(`.badge${emphasise ? '.bg-primary.white' : '.bg-gray-light'}`, coloredEnvironmentStatusComponent(status)),
