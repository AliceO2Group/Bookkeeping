...
import { formatEnvironmentDates } from '../format/formatEnvironmentDates.js';
...
export const environmentsActiveColumns = {
    ...
    updatedAt: {
        ...
        title: true,
        size: 'w-10',
        format: (_, environment) => formatEnvironmentDates(environment.updatedAt),
    },
    createdAt: {
        name: 'Created At',
        visible: true,
        ...
        title: true,
        size: 'w-10',
        format: (_, environment) => formatEnvironmentDates(environment.createdAt),
    },
    status: {
        name: 'Current Status',
        visible: true,
