 ...
 *
 * @param {{envs: EnvironmentModel}} envs The global model object.
 *
 * @returns {Object} Html page
 */
export const environmentOverviewComponent = (envs) => {
    const { environments: overviewEnvs, pagination } = envs.overviewModel;
    ...
    return [
        h('.w-100.flex-column', [
            ...
            table(overviewEnvs, environmentsActiveColumns(envs.overviewModel), { classes: getRowsClasses }),
