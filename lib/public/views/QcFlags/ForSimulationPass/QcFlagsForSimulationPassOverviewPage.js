...
export const QcFlagsForSimulationPassOverviewPage = ({
    ...
    detectorsUserHasAccessTo: remoteDplDetectorsUserHasAccessTo,
}) => {
    const {
        detector: remoteDplDetector,
    ...
    return h(
        ...
        [
            h('.flex-row.justify-between.items-center', [
                ...
                qcFlagCreationPanelLink({ simulationPassId }, remoteRun, detectorId, remoteDplDetectorsUserHasAccessTo),
