...
export const QcFlagsForSimulationPassOverviewPage = ({
    ...
    const activeColumns = {
        id: {
            name: 'Id',
            visible: true,
            format: (id, { simulationPassId, dplDetectorId, runNumber }) =>
                frontLink(id, 'qc-flag-details-for-simulation-pass', { id, simulationPassId, runNumber, dplDetectorId }),
            classes: 'w-5',
        },
        ...
        [
            ...
            h('.w-100.flex-column', [
                table(
                    ...
                    { classes: '.table-sm' },
                    null,
                    { sort: qcFlagsForSimulationPassOverviewModel.sortModel },
                ),
                paginationComponent(qcFlagsForSimulationPassOverviewModel.pagination),
            ]),
        ],
    );
};
