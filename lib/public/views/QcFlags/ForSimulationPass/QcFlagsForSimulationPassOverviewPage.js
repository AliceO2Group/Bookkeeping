    ...
    return h(
        ...
        [
            h('.flex-row.justify-between.items-center', [
                qcFlagsBreadcrumbs({ remoteSimulationPass, remoteRun, remoteDetector }),
                qcFlagCreationPanelLink({ simulationPassId }, remoteRun, detectorId, remoteDetectorsUserHasAccessTo),
