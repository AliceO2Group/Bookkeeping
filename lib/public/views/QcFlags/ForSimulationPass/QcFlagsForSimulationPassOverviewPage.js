...
import { remoteDetectorUserHasAccessTo } from '../../../services/detectors/remoteDetectorUserHasAccessTo.js';
...
export const QcFlagsForSimulationPassOverviewPage = ({
    ...
    return h(
        ...
        mergeRemoteData([
            ...
            remoteRun,
            remoteDetector,
            remoteDetectorUserHasAccessTo(detectorId, remoteDetectorsUserHasAccessTo),
        ])
            .match({
                NotAsked: () => null,
