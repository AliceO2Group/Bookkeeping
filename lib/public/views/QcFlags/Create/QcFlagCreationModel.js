...
export class QcFlagCreationModel extends CreationModel {
    ...
    setTimings(runs) {
        for (const run of runs) {
            ...
            if (!startTime) {
                this._startTimings.startTime = null;
            } if (!endTime) {
                this._endTimings.endTime = null;
            }
        ...
        this._timeRangeModel.fromTimeInputModel.setValue(this._startTimings.startTime);
        this._timeRangeModel.toTimeInputModel.setValue(this._endTimings.endTime);
