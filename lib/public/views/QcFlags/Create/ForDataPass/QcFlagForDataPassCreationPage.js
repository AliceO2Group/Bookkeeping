    ...
    return h('', {
        ...
        h('.flex-row.justify-between.items-center', [
            ...
            frontLink(h('.flex-row.items-center.g1', 'QC'), 'qc-flags-for-data-pass', {
                runNumber: qcFlagsForDataPassCreationModel.runNumber,
                dataPassId: qcFlagsForDataPassCreationModel.dataPassId,
                dplDetectorId: qcFlagsForDataPassCreationModel.dplDetectorId,
            }, {
