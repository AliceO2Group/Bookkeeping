...
export const qcFlagsActiveColumns = {
    id: {
        name: 'Id',
        visible: true,
        format: (id, { dataPassId, simulationPassId }) => dataPassId !== undefined
            ? frontLink(id, 'qc-flag-details-for-data-pass', { id, dataPassId })
            : frontLink(id, 'qc-flag-details-for-simulation-pass', { id, simulationPassId }),
        classes: 'w-5',
    },
