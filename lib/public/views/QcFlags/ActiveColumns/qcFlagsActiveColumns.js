...
import { fromatQcFlagStart } from '../format/formatQcFlagStart.js';
import { fromatQcFlagEnd } from '../format/formatQcFlagEnd.js';
...
export const qcFlagsActiveColumns = {
    ...
    from: {
        name: 'From',
        visible: true,
        format: (_, qcFlag) => fromatQcFlagStart(qcFlag),
    },

    to: {
        name: 'To',
        visible: true,
        format: (_, qcFlag) => fromatQcFlagEnd(qcFlag),
    },
