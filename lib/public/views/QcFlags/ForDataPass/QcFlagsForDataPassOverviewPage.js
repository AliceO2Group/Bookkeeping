 ...
 */
export const QcFlagsForDataPassOverviewPage = ({ qcFlagsModel: { overviewModel: qcFlagsForDataPassOverviewModel } }) => {
    /**
     ...
     */
    const linkFactory = (dataPass) =>
        h('h2', frontLink(dataPass.name, 'runs-per-Data-pass', { dataPassId: dataPass.id }));
    return QcFlagsOverviewComponenet(qcFlagsForDataPassOverviewModel, linkFactory);
};
