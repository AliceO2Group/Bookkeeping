 ...
 */
export const QcFlagsForDataPassOverviewPage = (model) => {
    const { qcFlags: { forDataPassOverviewModel: qcFlagsForDataPassOverviewModel } } = model;
    const {
        run: remoteRun,
    ...
    return h('', {
        ...
        QcFlagsOverviewComponenet(qcFlagsForDataPassOverviewModel, model),
    ]);
};
