...
export const QcFlagsForDataPassOverviewPage = ({ qcFlags: { forDataPassOverviewModel: qcFlagsForDataPassOverviewModel } }) => {
    ...
    return h('', {
        ...
        h('.flex-row.justify-between.items-center', [
            ...
            frontLink(h('.flex-row.items-center.g1', [h('small', iconPlus()), 'QC']), 'qc-flag-creation', {
                runNumber: qcFlagsForDataPassOverviewModel._runNumber,
                dataPassId: qcFlagsForDataPassOverviewModel._dataPassId,
                detectorId: qcFlagsForDataPassOverviewModel._dplDetectorId,
            }, {
