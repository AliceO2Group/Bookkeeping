        ...
        h('.flex-row.justify-between.items-center', [
            ...
            h('.flex-row', [
                h(
                    ...
                    detailsForDataPassModel.verificationEnabled ? 'Revert' : 'Verify',
                ),
            ...
            remoteQcFlag.match({
                Success: (qcFlag) =>
                    h('.flex-column.flex-grow.g3', [
                        ...
                        detailsForDataPassModel.verificationEnabled &&
                                ...
                                h(
                                    ...
                                    [
                                        h(LabelPanelHeaderComponent, 'Comment'),
                                        markdownInput(
                                            detailsForDataPassModel.formData.comment,
                                            {
                                                id: 'comment',
                                                placeholder: 'Your message...',
                                                oninput: (e) => detailsForDataPassModel.patchFormData({ comment: e.target.value }),
                                            },
                                            { height: '100%' },
                                        ),
                                    ],
                        ...
                        detailsForDataPassModel.verificationEnabled &&
                            h('.pv3', h('button#send-verification.btn.btn-success', {
                                onclick: () => detailsForDataPassModel.verify(),
                            }, 'Send')),
                    ]),
                Loading: () => spinner(),
