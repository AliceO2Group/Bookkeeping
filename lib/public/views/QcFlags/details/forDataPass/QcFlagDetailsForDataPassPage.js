        ...
        h('.flex-row.justify-between.items-center', [
            ...
            h('.flex-row.g3', [
                !verificationEnabled && h('.pv3', h(
                    ...
                    {
                        onclick: () => {
                            detailsForDataPassModel.verificationEnabled = true;
                        },
                    },
                    'Verify',
                )),
                    ...
                    h('.flex-grow.g3', [
                        ...
                        verificationEnabled &&
                            [
                                ...
                                h('.pv3.flex-row.g3', verificationCreationModel.creationResult.match({
                                    Loading: () => [
                                    ...
                                    Failure: () => [
                                        cancelButton(() => {
                                            detailsForDataPassModel.verificationEnabled = false;
                                        }, 'Cancel verification'),
