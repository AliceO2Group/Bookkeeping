...
export const QcFlagDetailsForDataPassPage = ({ qcFlags: { detailsForDataPassModel } }) => {
    const { qcFlag: remoteQcFlag, deleteResult, dataPass: remoteDataPass } = detailsForDataPassModel;
    const qcFlagDetailsDispayConfigration = qcFlagDetailsConfiguration(detailsForDataPassModel);
