...
export const QcFlagDetailsForDataPassPage = ({ qcFlags: { detailsForDataPassModel } }) => {
    const forDataPassQcFlagDatailsSpecificDisplayConfiguration = {
        dataPass: {
            name: 'Data pass',
            visible: true,
    ...
    return qcFlagDetailsComponenet(detailsForDataPassModel, forDataPassQcFlagDatailsSpecificDisplayConfiguration);
};
