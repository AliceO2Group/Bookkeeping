...
export class QcFlagDetailsModel extends Observable {
    ...
    constructor(
        ...
        this._verificationEnabled = true;
     ...
     * @param {boolean} verificationEnabled true if form should be displayed, false otherwise
     */
     ...
     * @return {boolean} true if form should be displayed, false otherwise
     */
...
class QcFlagVerificationCreationModel extends CreationModel {
     ...
     * @param {function} onSuccess function called when the verification is succesfully created
     */
