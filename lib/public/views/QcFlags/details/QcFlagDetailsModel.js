...
export class QcFlagDetailsModel extends Observable {
    ...
    constructor(
        ...
        detectorsProvider.dpl$.observe(() => this._getDetector());
    ...
    /**
     * Fetch detector which for QC flag is to be created
     *
     * @return {void}
     */
    _getDetector() {
        this._detector$.setCurrent(detectorsProvider.dpl$.getCurrent().match({
            Success: (detectors) => {
