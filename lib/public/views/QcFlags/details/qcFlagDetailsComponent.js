...
export const qcFlagDetailsComponenet = (qcFlagDetailsModel, additionalDetailsConfiguration = {}) => {
    ...
    /**
     * Function called when QC flag post verification button is clicked
     * @return {void}
     */
    const qcFlagPostVerificationOnclick = () => {
                                ...
                                h(
                                    ...
                                    verificationCreationModel.creationResult.match({
                                        ...
                                        Failure: () => [
                                            ...
                                            createButton(
                                                verificationCreationModel.isValid() ? qcFlagPostVerificationOnclick : null,
                                                'Post verification',
                                            ),
                                        ],
                                        NotAsked: () => [
