...
export const QcFlagDetailsForSimulationPassPage = ({ qcFlags: { detailsForSimulationPassModel } }) => {
    const forSimulationPassQcFlagSpecificConfiguration = {
        simulationPass: {
    ...
    return qcFlagDetailsComponenet(detailsForSimulationPassModel, forSimulationPassQcFlagSpecificConfiguration);
};
