...
import { qcFlagDetailsComponenet } from '../qcFlagDetailsComponent.js';
...
export const QcFlagDetailsForSimulationPassPage = ({ qcFlags: { detailsForSimulationPassModel } }) => {
    const forSimulationPassQcFlagDatailsSpecificDisplayConfiguration = {
        simulationPass: {
    ...
    return qcFlagDetailsComponenet(detailsForSimulationPassModel, forSimulationPassQcFlagDatailsSpecificDisplayConfiguration);
};
