...
const qcFlagDetailsComponent = (detailsModel) => {
    ...
    const rightPanel = [
        detailsModel.creationResult.match({
            Failure: (errors) => errorAlert(errors),
        }),
        commentPanel,
        h('.pv3', detailsModel.creationResult.match({
    ...
    return [
        ...
        h('.w-60.flex-column.g3', rightPanel(detailsModel)),
    ];
};
 ...
 */
export const QcFlagDetailPage = ({ qcFlags: { detailsModel } }) => h('', {
