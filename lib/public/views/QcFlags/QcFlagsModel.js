        ...
        this._creationForDataPassModel = new QcFlagCreationForDataPassModel(
            {
                ...
                runNumberDetectorMap: runNumberDetectorMap ? this.parseRunNumberDetectorMap(runNumberDetectorMap) : null,
            },
            () => this.model.router.go(buildUrl(
                '/',
                { page: 'qc-flags-for-data-pass', dataPassId, runNumberDetectorMap },
            )),
        );
