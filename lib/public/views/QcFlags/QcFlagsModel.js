...
export class QcFlagsModel extends Observable {
     ...
     * @param {string} parameters.pdpBeamTypes  the beam types of the runs to display
     * @returns {void}
     */
    loadCreationForDataPass({ dataPassId, runNumberDetectorsMap, pdpBeamTypes }) {
        ...
        this._creationForDataPassModel = new QcFlagCreationForDataPassModel(
            ...
            () => {
                this.model.router.go(buildUrl(
                    '/',
                    { page: 'runs-per-data-pass', dataPassId, pdpBeamTypes },
                ));
            },
        );
     ...
     * @param {number} parameters.dataPassId data pass id
     * @param {number} parameters.runNumber dpl detector id
     * @param {number} parameters.dplDetectorId dpl detector id
     * @returns {void}
     */
     ...
     * @returns {void}
     */
    loadCreationForSimulationPass({ simulationPassId, runNumberDetectorsMap, pdpBeamTypes }) {
        ...
        this._creationForSimulationPassModel = new QcFlagCreationForSimulationPassModel(
            ...
            () => {
                this.model.router.go(buildUrl(
                    '/',
                    { page: 'runs-per-simulation-pass', simulationPassId, pdpBeamTypes },
                ));
            },
        );
