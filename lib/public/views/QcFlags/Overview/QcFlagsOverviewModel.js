...
export class QcFlagsOverviewModel extends OverviewPageModel {
    ...
    /**
     * Pagination for QC flags overview is temporarily disabled, because it interferes with QC flag visualtion.
     * For now, only fetched flags are visualized and it may be misleading to have subset (because of pagination) of flags visualized.
     */
    // eslint-disable-next-line valid-jsdoc
    /**
     * @inheritdoc
