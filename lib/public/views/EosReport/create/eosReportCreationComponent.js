...
import { h, switchCase, iconWarning } from '/js/src/index.js';
        ...
        h('#from-previous-shifter.panel', [
            ...
            formData.infoFromPreviousShifter && !shiftData.infoFromPreviousShifter.errorMessage
                ...
                : h('.f7', h(
                    ...
                    [
                        h('.contextual-message-icon.br-pill.b-primary.flex-row.items-center.justify-center', iconWarning()),
                        h('.gray-darker', shiftData.infoFromPreviousShifter.errorMessage || ''),
                    ],
                )),
            markdownInput(
