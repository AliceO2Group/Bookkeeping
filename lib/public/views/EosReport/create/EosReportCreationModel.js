...
class EosReportCreationFormData extends Observable {
    ...
    _serializable() {
        ...
        delete seriazable.observers;
        delete seriazable._reportType;
        // Data processing specific to some EoS report types
        switch (this._reportType) {
            case ShiftTypes.SL:
                seriazable.typeSpecific.magnets.intermediates = seriazable.typeSpecific.magnets.intermediates.filter((item) => item !== null);
        }
