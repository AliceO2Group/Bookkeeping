 ...
 */
const lhcBeamEnergyToDisplay = (lhcBeamEnergy) => {
    ...
    return _lhcBeamEnergyToDisplay(
        lhcBeamEnergy,
        closestEnergy,
 ...
 */
export const formatDistinctEnergies = (distinctEnergies) =>
    distinctEnergies?.length > 0
        ? h('', distinctEnergies
            ?.map(lhcBeamEnergyToDisplay)
