...
import { PaginatableRemoteDataSource } from '../../../utilities/fetch/PaginatableRemoteDataSource.js';
...
export class LhcPeriodsOverviewModel extends Observable {
    ...
    constructor() {
        super();
        this._remoteDataFetcher = new PaginatableRemoteDataSource({
        ...
        const { observablePage } = this._remoteDataFetcher;
        // eslint-disable-next-line no-return-assign
        observablePage.observe(() => this._pagination.itemsCount = observablePage.current.totalCount);
     ...
     */
    reset() {
        this._remoteDataFetcher.observableData.current = RemoteData.NotAsked();
