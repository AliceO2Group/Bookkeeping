...
export class LhcPeriodsOverviewModel extends OverviewPageModel {
    ...
    get filterQuery() {
        return {
            filter: {
                names: this._namesFilterModel.normalizedFilter,
                years: this._yearsFilterModel.normalizedFilter,
                pdpBeamTypes: this._pdpBeamTypesFilterModel.normalizedFilter,
            },
        };
    }
     ...
     */
    getRootEndpoint() {
        return buildUrl('/api/lhcPeriodsStatistics', this.filterQuery);
    }
