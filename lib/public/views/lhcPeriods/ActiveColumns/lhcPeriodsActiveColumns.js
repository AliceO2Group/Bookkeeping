 ...
 */
export const collapseToClosestDefinedEnergyLevelIfApplies =
    (lhcBeamEnergy, wellDefinedEnergyLevels, acceptableEnergyMargin, notChangedEnergyPrecision = 2) => {
    ...
    distinctEnergies: {
        ...
        format: (distinctEnergies) =>
            distinctEnergies?.length > 0
                ? h('', distinctEnergies
                    ?.map((energy) =>
                        collapseToClosestDefinedEnergyLevelIfApplies(
                            energy,
