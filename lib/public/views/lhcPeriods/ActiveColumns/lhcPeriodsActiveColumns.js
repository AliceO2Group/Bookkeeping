...
import { formatLhcPeriodNameWithLinksToAssociations } from '../format/formatLhcPeriodNameWithLinksToAssociations.js';
...
export const lhcPeriodsActiveColumns = {
    name: {
        name: 'Name',
        visible: true,
        format: formatLhcPeriodNameWithLinksToAssociations,
        sortable: true,
