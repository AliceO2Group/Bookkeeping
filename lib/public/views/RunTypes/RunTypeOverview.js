...
import { fetchClient, Observable, RemoteData } from '@aliceo2/web-ui/Frontend/js/src/index.js';
...
export default class RunTypeOverview extends Observable {
    ...
    /**
     * Fetch all the relevant Run Types from the API
     *
    ...
    /**
     * Remote data representing all the relevant runType fetched from the API
     *
     * @returns {RemoteData[]} the remote data of runType
     */
    get runTypes() {
