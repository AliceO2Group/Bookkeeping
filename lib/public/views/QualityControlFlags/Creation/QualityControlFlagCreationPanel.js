...
const creationFormsPanel = (creationModel) => {
    ...
    const leftPanel = [
        creationModel.timeStart ? dateTimeInput(creationModel.timeStart) : null,
        creationModel.timeEnd ? dateTimeInput(creationModel.timeEnd) : null,
