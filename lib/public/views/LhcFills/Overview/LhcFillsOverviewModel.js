...
export class LhcFillsOverviewModel extends OverviewPageModel {
     ...
     */
    constructor(stableBeamsOnly = false, router) {
        super();

        this._filteringModel = new FilteringModel(router,
            ['home', 'lhc-fill-overview', 'lhc-fill-details'],
            {
     ...
     */
    getRootEndpoint() {
        return buildUrl('/api/lhcFills', this.filterQuery);
    }
