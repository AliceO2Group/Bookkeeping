...
import { BeamsModeFilterModel } from '../../../components/Filters/LhcFillsFilter/BeamsModeFilterModel.js';
...
export class LhcFillsOverviewModel extends OverviewPageModel {
    ...
    constructor(stableBeamsOnly = false) {
        ...
        this._filteringModel = new FilteringModel({
            ...
            beamsMode: new BeamsModeFilterModel(),
        ...
        beamsTypesProvider.items$.observe(() => {
            beamsTypesProvider.items$.getCurrent().apply({
                Success: (types) => {
                    this._beamsTypes = types.map((type) => ({ value: type }));
                    this._filteringModel.put('beamsType', new SelectionFilterModel({ availableOptions: this._beamsTypes }));
                },
            });
        });
        ...
        this.reset(false);
        this._filteringModel.get('beamsMode').setStableBeamsOnly(stableBeamsOnly);
    }
