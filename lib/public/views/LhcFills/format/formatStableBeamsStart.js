 ...
 * @param {number} [lhcFill.stableBeamStart] the time at which a beam would start
 ...
 */
export const formatStableBeamsStart = ({ stableBeamStart }, { inline = false } = {}) => {
    if (stableBeamStart == null) { // ... == null also checks for undefined because javascript 
        return '-';
    }
