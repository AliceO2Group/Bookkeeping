...
export default class LhcFills extends Observable {
     ...
     *
     * @param {number} lhcFillId the id of the fill for which model details must be instantiated
     *
     * @return {void}
     */
    loadDetails(lhcFillId) {
        this._detailsModel.lhcFillId = lhcFillId;
    }
     ...
     */
    clearDetails() {
        this._detailsModel.lhcFillId = null;
    }
