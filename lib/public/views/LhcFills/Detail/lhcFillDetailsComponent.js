 ...
 */
export const lhcFillDetailsComponent = (model) => model.lhcFills.detailsModel.lhcFillDetails.match({
    NotAsked: () => null,
    Loading: () => spinner(),
    Success: (lhcFill) => {
        ...
        return h('', [
            ...
            tabbedPanelComponent(
                model.lhcFills.detailsModel.tabbedPanelModel,
                {
                ...
                },
                {
                    [LHC_FILL_DETAILS_PANELS_KEYS.RUNS]: (panelData) => {
                        ...
                        const { runsTabModel } = model.lhcFills.detailsModel.tabbedPanelModel;
                        return [
                            ...
                            h('#runs', table(runs, runsActiveColumns(model.runs), null, { profile: 'lhcFill' })),
                        ];
                    },
