...
import { stableBeamFilter } from '../../../components/Filters/LhcFillsFilter/stableBeamFilter.js';
...
export const lhcFillsActiveColumns = {
    ...
    stableBeams: {
        ...
        filter: (lhcFillModel) => stableBeamFilter(lhcFillModel.filteringModel.get('beamsMode'), true),
    },
    stableBeamsDuration: {
        name: 'SB Duration',
        visible: true,
    ...
    beamType: {
        ...
        filter: (lhcFillModel) => lhcFillModel.getBeamsTypes().length === 0 ?
            undefined : beamsTypeFilter(lhcFillModel.filteringModel.get('beamsType')),
    },
    collidingBunches: {
