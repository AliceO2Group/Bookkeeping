...
import { formatStableBeamsStart } from '../format/formatStableBeamsStart.js';
import { formatStableBeamsEnd } from '../format/formatStableBeamsEnd.js';
...
export const lhcFillsActiveColumns = {
    ...
    stableBeamStart: {
        name: 'Stable Beam Start',
        visible: true,
        classes: 'w-7 f6',
        noEllipsis: true,
        format: (_, run) => formatStableBeamsStart(run),
        ...
        profiles: {
            ...
            home: {
                classes: 'w-10 f6',
                format: (_, run) => formatStableBeamsStart(run, { inline: true }),
            },
            runsPerLhcPeriod: {
    ...
    stableBeamEnd: {
        name: 'Stable Beam Stop',
        visible: true,
        classes: 'w-7 f6',
        noEllipsis: true,
        format: (_, run) => formatStableBeamsEnd(run),
        exportFormat: (timestamp) => formatTimestamp(timestamp),
        ...
        profiles: {
            ...
            home: {
                classes: 'w-10 f6',
                format: (_, run) => formatStableBeamsEnd(run, { inline: true }),
            },
            runsPerLhcPeriod: {
                classes: 'f6 w-wrapped',
            },
