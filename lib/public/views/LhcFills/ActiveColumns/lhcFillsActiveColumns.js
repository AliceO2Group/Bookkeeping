...
import { formatRunDurationEfficiency } from '../../../utilities/formatting/formatRunDurationEfficiency.js';
...
export const lhcFillsActiveColumns = {
    ...
    runsCoverage: {
        ...
        visible: true,
        size: 'w-8',
        format: (duration, lhcFill) => formatRunDurationEfficiency(duration, lhcFill.efficiency, formatDuration, formatPercentage),
    },
    beamType: {
        name: 'Beam Type',
        visible: true,
