...
export const lhcFillsActiveColumns = {
    ...
    stableBeamsStart: {
        ...
        filter: (lhcFillModel) => timeRangeFilter(lhcFillModel.filteringModel.get('sbStart').timeRangeInputModel),
    },
    stableBeamsEnd: {
        name: 'SB END',
        visible: true,
        ...
        filter: (lhcFillModel) => timeRangeFilter(lhcFillModel.filteringModel.get('sbEnd').timeRangeInputModel),
    },
    stableBeams: {
