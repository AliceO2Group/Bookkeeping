...
export class QcFlagTypesOverviewModel extends OverviewPageModel {
    ...
    getRootEndpoint() {
        ...
        if (this.isAnyFilterActive()) {
            params.filter = {
                ...
                bad: this._ofBeingBadFilterModel.selected.length === 2
                    ? undefined
                    : this._ofBeingBadFilterModel.selected[0],
            };
        }
    ...
    /**
     * Returns QC Flag Types of being bad filter model
     * @return {TextTokensFilterModel} QC Flag Types of being bad filter model
     */
    get ofBeingBadFilterModel() {
        return this._ofBeingBadFilterModel;
    }
     ...
     */
    isAnyFilterActive() {
        return !this._namesFilterModel.isEmpty() || !this._methodsFilterModel.isEmpty() || this._ofBeingBadFilterModel.selected.length;
    }
    ...
    reset() {
        ...
        this._ofBeingBadFilterModel.reset();
        super.reset();
    }
}
