...
export class QcFlagTypesModel extends Observable {
     ...
     *
     * @param {QueryRouter} router router model
     */
    constructor(router) {
        super();
        this.router = router;
        ...
        // Overview
        this._overviewModel = new QcFlagTypesOverviewModel(router);
     ...
     */
    loadCreation() {
        this._creationModel = new QcFlagTypeCreationModel(() => this.router.go('/?page=qc-flag-types-overview'));
