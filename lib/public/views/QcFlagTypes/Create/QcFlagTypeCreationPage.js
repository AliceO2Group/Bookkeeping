...
const qcFlagTypeCreationComponent = (qcFlagTypeCreationModel) => {
    ...
    return h('.flex-column.g3.mw-l', [
        h(PanelComponent, [
            h(LabelPanelHeaderComponent, { for: 'name' }, 'Name (between 1 and 50 characters)'),
        ...
        h(
            PanelComponent,
            [
                h(LabelPanelHeaderComponent, { for: 'method' }, 'Method (between 1 and 100 characters)'),
