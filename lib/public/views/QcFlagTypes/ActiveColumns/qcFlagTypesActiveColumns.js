...
import { checkboxesFilter } from '../../../components/Filters/common/filters/checkboxFilter.js';
...
export const qcFlagTypesActiveColumns = {
    ...
    bad: {
        ...
        visible: true,
        sortable: true,
        filter: ({ ofBeingBadFilterModel }) => checkboxesFilter(
            ofBeingBadFilterModel,
            { class: 'w-75 mt1', id: 'qc-flag-type-bad-filter' },
        ),
        classes: 'f6',
