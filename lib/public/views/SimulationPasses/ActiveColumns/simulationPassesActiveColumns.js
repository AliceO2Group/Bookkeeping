...
import { formatLongNumber } from '../../../utilities/formatting/formatLongNumber.js';
...
export const simulationPassesActiveColumns = {
    ...
    requestedEventsCount: {
        ...
        format: (requestedEventsCount) => requestedEventsCount ? formatLongNumber(requestedEventsCount) : '-',
        visible: true,
        sortable: true,
        classes: 'w-10 f6',
    },
    ...
    generatedEventsCount: {
        ...
        format: (generatedEventsCount) => generatedEventsCount ? formatLongNumber(generatedEventsCount) : '-',
        visible: true,
        sortable: true,
        classes: 'w-10 f6',
    },
    ...
    outputSize: {
        name: 'Output Size [B]',
        visible: true,
        format: (outputSize) => outputSize ? formatLongNumber(outputSize) : '-',
        sortable: true,
        classes: 'w-10 f6',
    },
