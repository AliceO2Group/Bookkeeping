...
export const AnchoredSimulationPassessOverviewPage = ({ simulationPasses: {
    ...
    return h('', {
        ...
        h('.flex-row.header-container.pv2', filtersPanelPopover(anchoredSimulationPassesOverviewModel, simulationPassesActiveColumns)),
        h('.w-100.flex-column', [
            table(
                anchoredSimulationPassesOverviewModel.items,
                simulationPassesActiveColumns,
                { classes: '.table-sm' },
                null,
                { sort: anchoredSimulationPassesOverviewModel.overviewSortModel },
            ),
            paginationComponent(anchoredSimulationPassesOverviewModel.pagination),
        ]),
    ]);
};
