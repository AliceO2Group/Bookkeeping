...
import { SimulationPassesAssociatedOverviewModel } from './AssociatedOverview/SimulationPassesAssociatedOverviewModel.js';
...
export class SimulationPassesModel extends Observable {
    ...
    constructor() {
        ...
        this._perLhcPeriodOverviewModel = new SimulationPassesAssociatedOverviewModel();
        this._perLhcPeriodOverviewModel.bubbleTo(this);

        this._perDataPassOverviewModel = new SimulationPassesAssociatedOverviewModel();
