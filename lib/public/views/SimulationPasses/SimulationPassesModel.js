...
export class SimulationPassesModel extends Observable {
    ...
    constructor(router) {
        ...
        this._perLhcPeriodOverviewModel = new SimulationPassesPerLhcPeriodOverviewModel(router);
        this._perLhcPeriodOverviewModel.bubbleTo(this);

        this._anchoredOverviewModel = new AnchoredSimulationPassesOverviewModel(router);
