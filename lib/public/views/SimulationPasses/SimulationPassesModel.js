...
export class SimulationPassesModel extends Observable {
    ...
    constructor(router) {
        ...
        this._perLhcPeriodOverviewModel = new SimulationPassesPerLhcPeriodOverviewModel(router, 'simulation-passes-per-lhc-period-overview');
        this._perLhcPeriodOverviewModel.bubbleTo(this);

        this._anchoredOverviewModel = new AnchoredSimulationPassesOverviewModel(router, 'anchored-simulation-passes-overview');
    ...
    loadAnchoredOverview({ dataPassId }) {
        ...
        this._anchoredOverviewModel.setFilterFromUrl(null, false);
