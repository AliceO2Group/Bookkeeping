                ...
                return remoteDataDisplay(panelModel.data, {
                    Success: (efficiencyPerDetectors) => [
                        h('.flex-row.g2.items-center', [
                            ...
                            h(
                                '.btn.btn-primary',
                                { onclick: () => panelModel.activeDetectors.length ? panelModel.hideAll() : panelModel.showAll() },
                                panelModel.activeDetectors.length ? 'Hide all' : 'Show all',
                            ),
                        ]),
