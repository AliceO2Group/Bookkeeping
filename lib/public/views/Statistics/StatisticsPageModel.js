...
class StatisticsTabbedPanelModel extends TabbedPanelModel {
    ...
    constructor() {
        ...
        this._remoteDataFetcher = new DataSourceBuilder()
            .addDataSource(new RemoteDataSource())
            .addDataSource(new DataSourceTransfomer((remoteData) =>
                remoteData.isSuccess()
                    ? RemoteData.success(remoteData.payload.data)
                    : remoteData))
            .get();
