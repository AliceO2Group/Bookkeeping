...
/**
 * Format the histogram offset as the corresponding time range
 *
 * @param {number} offset the histogram offset
 * @return {string} the corresponding formatted time range
 */
