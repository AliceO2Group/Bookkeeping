...
import { LogsOverviewListModel } from '../../Logs/Overview/LogsOverviewListModel.js';
...
export class HomePageModel extends Observable {
    ...
    constructor(model) {
        ...
        this._logsOverviewModel = new LogsOverviewListModel(model, true);
     ...
     * @return {LogsOverviewListModel} the overview model
     */
