...
import { formatDataPassVersionsNumbericalPropertiesSum } from '../format/formatDataPassVersionsNumbericalPropertiesSum.js';
...
export const dataPassesActiveColumns = {
    ...
    reconstructedEventsCount: {
        ...
        format: (_, { versions }) => formatDataPassVersionsNumbericalPropertiesSum(versions, 'reconstructedEventsCount', formatItemsCount),
        visible: true,
        sortable: true,
        classes: 'w-10',
    },
    ...
    outputSize: {
        name: 'Output Size (B)',
        visible: true,
        format: (_, { versions }) => formatDataPassVersionsNumbericalPropertiesSum(versions, 'outputSize', formatSizeInBytes),
        sortable: true,
        classes: 'w-10',
    },
};
