...
import { DataPassesPerAssociationOverviewModel } from './PerLhcPeriodOverview/DataPassesPerAssociationOverviewModel.js';
...
export class DataPassesModel extends Observable {
    ...
    loadPerSimulationPassOverview({ simulationPassId }) {
        this._perSimulationPassOverviewModel.load({ simulationPassId });
    }
