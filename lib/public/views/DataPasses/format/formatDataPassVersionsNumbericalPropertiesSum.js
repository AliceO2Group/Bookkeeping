 ...
 * @param {function<number, *>} formatter function which formats non-null sum
 * @return {Component} formatted sum of versions property
 */
export const formatDataPassVersionsNumbericalPropertiesSum = (versions, property, formatter) => {
    ...
    return notAllNull ? formatter(total) : null;
};
