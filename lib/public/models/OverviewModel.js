...
export class OverviewPageModel extends Observable {
    ...
    constructor() {
        ...
        this._defaultExportName = 'bokkeeping-export';
    }
    ...
    async export(items, exportFormats = {}) {
        ...
        const fileName = this._defaultExportName;
        ...
        this.getExportFormat() === 'CSV'
            ? createCSVExport(exportData, `${fileName}.csv`, 'text/csv;charset=utf-8;')
            : createJSONExport(exportData, `${fileName}.json`, 'application/json');
    }
