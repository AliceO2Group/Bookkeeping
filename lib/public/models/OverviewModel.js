...
export class OverviewPageModel extends Observable {
    ...
    constructor() {
        ...
        this._displayXScrollable = false;
    }
    ...
    /**
     * Get value stating whether table should be horizontally scrollable
     * @return {boolean} whether display is scrollable
     */
    get displayXScrollable() {
        return this._displayXScrollable;
    }

    /**
     * Set value stating whether table should be horizontally scrollable
     * @param {Boolean} displayXScrollable whether display is scrollabe
     */
    set displayXScrollable(displayXScrollable) {
        this._displayXScrollable = Boolean(displayXScrollable);
    }
}
