...
/**
 * @typedef JSONDataExportFormatFunction
 *
 * @type {(value, entity) => any}
 */

/**
 * @typedef CSVDataExportFormatFunction
 *
 * @type {(value, entity) => string|number}
 */

/**
 * @typedef FieldExportConfiguration
 *
 * @property {function|null|{'JSON': JSONDataExportFormatFunction|null, 'CSV': CSVDataExportFormatFunction|null}} exportFormat
 */
...
const DEFAULT_SELECTION_EXPORT_TYPE = DataExportTypes.JSON;
...
export class DataExportModel extends Observable {
    ...
    constructor(items$, dataExportConfiguration, onDataNotAskedAction) {
        ...
        this._selectedExportType = DEFAULT_SELECTION_EXPORT_TYPE;
