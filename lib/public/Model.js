...
export default class Model extends Observable {
    ...
    constructor(window, document) {
        ...
        this.qcFlagTypes = new QcFlagTypesModel(this.router);
    ...
    async handleLocationChange() {
        ...
        switch (this.router.params.page) {
            ...
            case 'lhc-fill-overview':
                this.lhcFills?.loadOverview(); // Optional chaining required because lhc fills activates a filter instantly after loading
                break;
