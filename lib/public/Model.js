...
export default class Model extends Observable {
    ...
    constructor(window, document) {
        ...
        this._detectorsUserHasAccessTo = ObservableData.builder()
            .source(detectorsProvider.physicalAndChecks$)
            ...
            .build();
        this.userRoleSelectionModel.observe(() => this._detectorsUserHasAccessTo.setCurrent(detectorsProvider.physicalAndChecks$.getCurrent()));
