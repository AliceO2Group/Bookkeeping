...
export default class Model extends Observable {
    ...
    constructor(window, document) {
        ...
        this.qcFlagsModel = new QcFlagsModel();
    ...
    async handleLocationChange() {
        ...
        switch (this.router.params.page) {
            ...
            case 'qc-flags-for-data-pass':
                this.qcFlagsModel.loadForDataPassOverview(this.router.params);
                break;
            case 'qc-flags-for-simulation-pass':
                this.qcFlagsModel.loadForSimulationPassOverview(this.router.params);
                break;
