...
import { LhcPeriodsModel } from './views/lhcPeriods/overview/LhcPeriodsModel.js';
...
export default class Model extends Observable {
    ...
    constructor(window, document) {
         ...
         * @type {LhcPeriodModel}
         */
        this.lhcPeriods = new LhcPeriodsModel();
    ...
    async handleLocationChange() {
        ...
        switch (this.router.params.page) {
            ...
            case 'lhc-period-overview':
                this.lhcPeriods.fetchLhcPeriods();
                break;
            case 'env-overview':
    ...
    /**
     * Extend nav bar with RCT pages
     * @returns {void}
     */
    toggleRunConditionTablePagesInNavBar() {
        this.runConditionTablePagesTabs = this.runConditionTablePagesTabs === 'opened' ? false : 'opened';
        this.notify();
    }
