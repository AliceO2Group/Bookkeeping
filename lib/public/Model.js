...
export default class Model extends Observable {
    ...
    constructor(window, document) {
        ...
        this._detectorsUserHasAccessTo = ObservableData.builder()
            ...
            .build();
        this.userRoleSelectionModel.observe(() => this._detectorsUserHasAccessTo.setCurrent(detectorsProvider.physical$.getCurrent()));
     ...
     *
     * @return {RemoteData<Detector[]>} dpl detectors remote data
     */
    get detectorsUserHasAccessTo() {
        return this._detectorsUserHasAccessTo.getCurrent();
    }
}
