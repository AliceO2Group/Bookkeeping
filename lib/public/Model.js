...
export default class Model extends Observable {
    ...
    constructor(window, document) {
        ...
        this._userDplDetectors = ObservableData.builder()
            ...
            .build();
        this.userRoleSelectionModel.observe(() => this._userDplDetectors.setCurrent(dplDetectorsProvider.physical$.getCurrent()));
     ...
     */
    get userDplDetectors() {
        return this._userDplDetectors.getCurrent();
    }
}
