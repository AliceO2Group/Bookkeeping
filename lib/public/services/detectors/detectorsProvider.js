...
import { DetectorType, DATA_TAKING_DETECTOR_TYPES } from '../../domain/enums/DetectorTypes.mjs';
...
export class DetectorsProvider extends Observable {
    ...
    /**
     * Return data taking (Any detector that might be used in AliECS configuration) detectors list obervable data
     *
    ...
    /**
     * Return physical and QC (meaning physical ones plus e.g. 'GLO') detectors list obervable data
     *
