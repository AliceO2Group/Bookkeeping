...
class APIDplProcessExecutionAdapter {
    ...
    toAPIEntity(entityObject) {
        ...
        return {
            ...entityObject,
            host: host ? this.hostAdapter.toAPIEntity(host) : host,
            process: process ? this.dplProcessAdapter.toAPIEntity(process) : process,
    ...
    toDomain(apiEntityObject) {
        ...
        return {
            ...apiEntityObject,
            host: host ? this.hostAdapter.toDomain(host) : host,
            process: process ? this.dplProcessAdapter.toDomain(process) : process,
