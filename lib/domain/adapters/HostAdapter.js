...
class APIHostAdapter {
    ...
    toAPIEntity(apiEntityObject) {
        ...
        return {
            ...apiEntityObject,
            processesExecutions: (processesExecutions ?? []).map(this.dplProcessExecutionAdapter.toAPIEntity),
        };
    }
    ...
    toDomain(apiEntityObject) {
        ...
        return {
            ...apiEntityObject,
            processesExecutions: (processesExecutions ?? []).map(this.dplProcessExecutionAdapter.toDomain),
        };
    }
}
