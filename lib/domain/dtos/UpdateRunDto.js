...
const BodyDto = Joi.object({
    ...
    avgInelasticInteractionRate: Joi.number().optional(),
    inelasticInteractionRateAtStart: Joi.number().optional(),
    inelasticInteractionRateAtMid: Joi.number().optional(),
    inelasticInteractionRateAtEnd: Joi.number().optional(),
});
