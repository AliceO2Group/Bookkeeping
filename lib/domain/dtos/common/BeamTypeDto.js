 ...
 */
const PDP_BEAM_TYPE_PATTERN = new RegExp(`^[A-Za-z]{${PDP_BEAM_TYPE_MIN_LENGTH},${PDP_BEAM_TYPE_MAX_LENGTH}}$`);
 ...
 * @description An array of PDP beam types represented as strings.
 * RUN3 has the following pdp beam types:
 * "pp"
 * "pPb"
 * "NeNe"
 * "OO"
