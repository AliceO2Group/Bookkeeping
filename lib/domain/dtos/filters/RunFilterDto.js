...
const { NonNegativeIntegerComparisonDto, OperatorToFloatLimitComparisonDto } = require('./NumericalComparisonDto.js');
...
exports.RunFilterDto = Joi.object({
    ...
    runDuration: NonNegativeIntegerComparisonDto,
    environmentIds: Joi.string().trim(),
    runQualities: CustomJoi.stringArray().items(Joi.string().trim().valid(...RUN_QUALITIES)),
    nDetectors: NonNegativeIntegerComparisonDto,
    nEpns: NonNegativeIntegerComparisonDto,
    nFlps: NonNegativeIntegerComparisonDto,
    ddflp: Joi.boolean(),
    dcs: Joi.boolean(),
    epn: Joi.boolean(),
    ...
    aliceL3Current: OperatorToFloatLimitComparisonDto,
    aliceDipoleCurrent: OperatorToFloatLimitComparisonDto,
