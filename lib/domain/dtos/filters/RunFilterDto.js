...
const { IntegralComparisonDto, FloatComparisonDto } = require('./NumericalComparisonDto.js');
...
exports.RunFilterDto = Joi.object({
    ...
    runDuration: IntegralComparisonDto,
    environmentIds: Joi.string().trim(),
    runQualities: CustomJoi.stringArray().items(Joi.string().trim().valid(...RUN_QUALITIES)),
    nDetectors: IntegralComparisonDto,
    nEpns: IntegralComparisonDto,
    nFlps: IntegralComparisonDto,
    ddflp: Joi.boolean(),
    dcs: Joi.boolean(),
    epn: Joi.boolean(),
    ...
    aliceL3Current: FloatComparisonDto,
