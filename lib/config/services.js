...
exports.services = {
    ...
    gaq: {
        ...
        recalculationPeriod: Number(process.env?.GAQ_RECALCULATION_PERIOD) || 30 * 1000, // 30s in milliseconds
        batchSize: Number(process.env?.GAQ_RECALCULATION_BATCH_SIZE) || 10,
    },
};
