...
exports.services = {
    ...
    gaq: {
        ...
        recalculationPeriod: Number(process.env?.GAQ_RECALCULATION_PERIOD) || 30 * 1000, // 30s default
        minBatchSize: Number(process.env?.GAQ_RECALCULATION_MIN_BATCH_SIZE) || 1,
        maxBatchSize: Number(process.env?.GAQ_RECALCULATION_MAX_BATCH_SIZE) || 100,
    },
};
