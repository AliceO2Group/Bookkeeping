 ...
 * @returns {LinkWithText} return object describing link with text
 */
...
exports.services = {
    ...
    aliFlp: {
        ...
        other: ALI_FLP_SUBPAGES_URLS ? ALI_FLP_SUBPAGES_URLS.split(LINKS_WITH_TEXT_SEPARATOR).map(linkWithTextToObject) : [],
    },
};
