...
module.exports = (sequelize) => {
    ...
    class QueryBuilder {
         ...
         *
         * @param {string|function|Object} subject the subject on which where condition must be applied
         * @param {Object} criteria the criteria of the where condition
         *
        ...
        andWhere(subject, criteria) {
            ...
            if (typeof subject === 'string') {
                ...
                fullCriteria = sequelize.where(subject(sequelize), criteria);
            } else {
