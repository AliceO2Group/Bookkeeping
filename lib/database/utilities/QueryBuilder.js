...
class WhereAssociationQueryBuilder extends WhereQueryBuilder {
    ...
    _op(operation) {
        this.queryBuilder.include({
            model: this._sequelize.models[this.associationName],
            as: this.association,
            required: true,
            through: {
                where: {
...
class QueryBuilder {
    ...
    /**
     * Add attributes given bt sequelize litera
     * @param {SqlExpression} expression sequelize.fn or literal with alias
     * @param {string} alias expression alias
     * @returns {QueryBuilder} The current QueryBuilder instance.
     */
    addAttribute(expression, alias) {
        this.options.attributes = this.options.attributes ?? { include: [] };
        this.options.attributes.include.push([expression, alias]);
        return this;
    }
    ...
    /**
     * Set grouping of elements.
     * @param {string|function} column The column to group by.
     * @returns {QueryBuilder} The current QueryBuilder instance.
     */
    groupBy(column) {
        if (typeof column === 'function') {
        ...
        this.options.group.push(column);
        return this;
    }
