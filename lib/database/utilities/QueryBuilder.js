...
class QueryBuilder {
    ...
    /**
     * Add given association to given query
     *
    ...
    include(expression) {
        ...
        this.options.include.push(expression?.call(this._sequelize) ?? expression);
        return this;
    }
    ...
    groupBy(expression) {
        ...
        this.options.group.push(expression?.call(this._sequelize) ?? expression);
        return this;
    }
    ...
    includeAttribute({ query, alias }) {
        ...
        this.options.attributes.include.push([this._sequelize.literal(query), alias]);
        return this;
    }
