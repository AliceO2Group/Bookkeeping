...
class QueryBuilder {
     ...
     * @param {string} attributeDefinition sql definition of attribute, e.g. function or subquery
     * @param {string} attributeAlias alias for the attribute
     * @return {QueryBuilder} this
     */
    includeAttribute(attributeDefinition, attributeAlias) {
        this.options.attributes = this.options.attributes ?? { include: [] };
        this.options.attributes.include.push([this._sequelize.literal(attributeDefinition), attributeAlias]);
        return this;
    }
