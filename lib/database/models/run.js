...
module.exports = (sequelize) => {
    const Run = sequelize.define('Run', {
        ...
        runDuration: {
            ...
            get() {
                ...
                const startTime = timeTriggerStart || o2Start || null;
                const endTime = timeTriggerEnd || o2End || new Date().getTime();
                if (!startTime) {
                    return null;
                }
    ...
    Run.associate = (models) => {
        ...
        Run.belongsToMany(models.Detector, { through: 'run_detectors', as: 'detectors', foreignKey: 'runNumber' });
    };
