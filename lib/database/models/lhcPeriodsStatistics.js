...
module.exports = (sequelize) => {
    ...
    LhcPeriodStatistics.associate = (models) => {
        ...
        LhcPeriodStatistics.hasMany(models.DataPass, { foreignKey: 'lhc_period_id', as: 'dataPass' });
        LhcPeriodStatistics.hasMany(models.Run, { foreignKey: 'lhc_period_id', as: 'run' });
    };
