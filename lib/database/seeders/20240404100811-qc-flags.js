            ...
            Promise.all([
                queryInterface.bulkInsert('quality_control_flags', [
                    ...
                    /** Flags for runNumber: 106, LHC22b_apass1, CPV */
                    {
                        ...
                        updated_at: new Date(1707825436000),
                    },

                    {
                        ...
                        run_number: 106,
                        dpl_detector_id: 1, // CPV
                        created_at: new Date(1707825437000),
                        updated_at: new Date(1707825437000),
                    },

                    {
                        ...
                        run_number: 106,
                        dpl_detector_id: 1, // CPV
                        created_at: new Date(1707825438000),
                        updated_at: new Date(1707825438000),
                    },
                    ...
                    /** Flags for runNumber: 1, LHC22b_apass2, CPV */
                    {
                        ...
                        run_number: 1,
                        dpl_detector_id: 1, // CPV
                        created_at: new Date(1707825439000),
                        updated_at: new Date(1707825439000),
                    },

                    {
                        ...
                        run_number: 106,
                        dpl_detector_id: 1, // CPV
                        created_at: new Date(1707825440000),
                        updated_at: new Date(1707825440000),
                    },
                ], { transaction }),
