            ...
            Promise.all([
                queryInterface.bulkInsert('quality_control_flags', [
...

                    {
                        ...
                        run_number: 106,
                        detector_id: 22, // VTX
                        created_at: '2024-02-13 12:58:20',
                        updated_at: '2024-02-13 12:58:20',
                    },
                ...
                queryInterface.bulkInsert('quality_control_flag_effective_periods', [
                    ...
                    // Asynchronous for AOT-GLO
                    {
                        id: 300,
                        from: null,
                        to: '2019-08-08 22:43:20',
                        flag_id: 300,
                ...
                queryInterface.bulkInsert('data_pass_quality_control_flag', [
                    ...
                    {
                        data_pass_id: 1,
                        quality_control_flag_id: 300,
                    },
                    {
                        data_pass_id: 1,
                        quality_control_flag_id: 301,
                    },
                ], { transaction }),
