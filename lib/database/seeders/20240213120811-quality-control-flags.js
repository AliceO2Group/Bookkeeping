...
module.exports = {
            ...
            Promise.all([
                ...
                queryInterface.bulkInsert('quality_control_flags', [
                    ...
                    { // Run trg time middle point: 1565314200, radius: 45000
                        id: 1,
                        time_start: new Date(1565314200 - 10000),
                        time_end: new Date(1565314200 + 10000),
                    ...
                    { // Run trg time middle point: 1565314200, radius: 45000
                        id: 2,
                        time_start: new Date(1565314200 + 15000),
                        time_end: new Date(1565314200 + 20000),
                    ...
                    { // Run trg time middle point: 1565314200, radius: 45000
                        id: 3,
                        time_start: new Date(1565314200 + 25000),
                        time_end: new Date(1565314200 + 30000),
                    ...
                    { // Run trg time middle point: 1647914400, radius: 46800
                        id: 4,
                        time_start: new Date(1647914400 + 10000),
                        time_end: new Date(1647914400 + 10000),
                ...
                queryInterface.bulkInsert('quality_control_flag_verifications', [
                    {
                        ...
                        created_at: new Date(1707825436010),
                    },
                    {
                        id: 2,
                        comment: 'Accepted: Some qc comment 1',
    ...
    down: async (queryInterface) =>
        queryInterface.sequelize.transaction((transaction) =>
            Promise.all([
                queryInterface.bulkDelete('quality_control_flag_verifications', null, { transaction }),
