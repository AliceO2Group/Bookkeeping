...
module.exports = {
        ...
        queryInterface.sequelize.transaction((transaction) =>
            Promise.all([
                ...
                queryInterface.bulkInsert('quality_control_flags', [
                    ...
                    { // Run trg middle: 1565314200, rad: 45000
                        id: 1,
                    ...
                    { // Run trg middle: 1647914400, rad: 46800
                        id: 4,
    ...
    down: async (queryInterface) =>
        queryInterface.sequelize.transaction((transaction) =>
            Promise.all([queryInterface.bulkDelete('quality_control_flag_reasons', null, { transaction })])),
};
