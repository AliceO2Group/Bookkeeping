...
class Repository {
     ...
     * Returns all entities.
     *
     * @param {QueryBuilder} [findQuery] The QueryBuilder to use.
     * @returns {Promise} Promise object representing the full mock data
     */
    async findAndCountAll(findQuery) {
        return this.model.findAndCountAll(findQuery instanceof QueryBuilder ? findQuery.toImplementation() : findQuery);
    }
