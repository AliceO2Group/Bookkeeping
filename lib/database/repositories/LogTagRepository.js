...
const { LogTagAdapter } = require('../adapters');
const {
    models: {
        LogTag,
    },
...
/**
 * Sequelize implementation of the LogTagRepository.
 */
class LogTagRepository extends Repository {
    /**
     * Creates a new `LogTagRepository` instance.
     */
    constructor() {
        super(LogTag, LogTagAdapter);
    }
...
module.exports = new LogTagRepository();
