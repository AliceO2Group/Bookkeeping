...
/**
 * @typedef GaqSubSummary aggregation of QC flags information by QcFlagType property `bad`
 *
 * @property {number} runNumber
 * @property {number} bad
...
class QcFlagRepository extends Repository {
    ...
    /**
     * Get GAQ sub-aggregations for given data pass
     *
     * @param {number} dataPassId id of data pass id
     * @return {Promise<GaqSubSummary[]>} Resolves with the GAQ sub-aggregations
     */
    async getGaqSubSummarys(dataPassId) {
