...
class QcFlagRepository extends Repository {
     ...
     * @return {Promise<GaqFlagIdentifiers>} promise resolvesd once periods are calculated
     */
    async findGaqFlagsIdentifiers({ dataPassId, runNumbers }) {
