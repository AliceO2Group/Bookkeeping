    ...
    async getGaqSummary(dataPassId) {
        const effectivePeriodsWithTypeSubQuery = `
            SELECT
                ...
                GROUP_CONCAT( DISTINCT qcf.id ) AS missingVerificationsCount
        ...
        const query = `
            SELECT
                ...
                GROUP_CONCAT(effectivePeriods.missingVerificationsCount) AS missingVerificationsCount,
        ...
        return rows.map(({
            ...
            bad,
            effectiveRunCoverage,
            missingVerificationsCount: [...new Set(missingVerificationsCount.split(','))].length,
