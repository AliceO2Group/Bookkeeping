...
const QualityControlFlagReasonRepository = require('./QualityControlFlagReasonRepository.js');
const QualityControlFlagRepository = require('./QualityControlFlagRepository.js');
const QualityControlFlagVerificationRepository = require('./QualityControlFlagVerificationRepository.js');
...
module.exports = {
    ...
    DataPassRepository,
    QualityControlFlagReasonRepository,
