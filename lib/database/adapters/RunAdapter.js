...
const LHC_REVOLUTION = 11245; // The LHC revolution frequency: 11.245kHz (~ c/26.7km).
    ...
    toEntity(databaseObject) {
        ...
        if (lhcFill && avgInelasticInteractionRate !== null) {
            entityObject.muInelasticInteractionRate =
                avgInelasticInteractionRate / (extractNumberOfCollidingLhcBunchCrossings(lhcFill.fillingSchemeName) * LHC_REVOLUTION);
        } else {
