...
class RunAdapter {
    ...
    toEntity(databaseObject) {
        ...
        entityObject.lhcPeriod = lhcPeriod ? this.lhcPeriodAdapter.toEntity(lhcPeriod).name : lhcPeriod;
    ...
    toDatabase(entityObject) {
        return {
            ...
            lhcPeriod: this.lhcPeriodAdapter.toDatabase({ name: entityObject.lhcPeriod }),
