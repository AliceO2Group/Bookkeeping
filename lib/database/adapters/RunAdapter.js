...
class RunAdapter {
    ...
    toEntity(databaseObject) {
        ...
        const muInel = (inelStart ?? 0 + inelMid ?? 0 + inelEnd ?? 0) / ((
            inelStart !== null ? 1 : 0 +
            inelMid !== null ? 1 : 0 +
            inelEnd !== null ? 1 : 0
        ) || 1);
    ...
    toDatabase(entityObject) {
        return {
            ...
            muTvx: entityObject.muTvx,
            inelStart: entityObject.inelStart,
            inelMid: entityObject.inelMid,
            inelEnd: entityObject.inelEnd,
        };
    }
