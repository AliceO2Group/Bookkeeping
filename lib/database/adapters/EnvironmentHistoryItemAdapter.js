...
class EnvironmentHistoryItemAdapter {
    ...
    toEntity(databaseObject) {
        ...
        const actualTimestamp = new Date(timestamp);

        // Timestamp is rounded to seconds
        actualTimestamp.setMilliseconds(timestampNano / 1e6);
    ...
    toDatabase(entityObject) {
        return {
            ...
            timestampSeconds: entityObject.timestamp,
            timestampNano: entityObject.timestampNano,
