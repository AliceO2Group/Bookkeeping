...
class QcFlagAdapter {
    ...
    constructor() {
        ...
        this.qcFlagIneffectivenessPeriodAdapter = null;
    ...
    toEntity(databaseObject) {
        ...
        const effectivePart = sumOfIneffectivenessPeriods !== undefined
            ? 1 - sumOfIneffectivenessPeriods / (to - from)
            : null;
        ...
        return {
            ...
            ineffectivenessPeriods: (ineffectivenessPeriods ?? []).map(this.qcFlagIneffectivenessPeriodAdapter.toEntity),
        };
    }
}
