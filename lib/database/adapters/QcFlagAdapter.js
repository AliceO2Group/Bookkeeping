...
class QcFlagAdapter {
    ...
    toEntity(databaseObject) {
        ...
        const sumOfEffectivePeriods = effectivePeriods?.reduce((summedPeriodsTime, { from, to }) => summedPeriodsTime + (to - from), 0);
        const effectivePart = sumOfEffectivePeriods !== undefined
            ? sumOfEffectivePeriods / (to - from)
            : null;
