...
class DplDetectorAdapter {
    ...
    /**
     * Adapts the dpl detector entity to a minified version.
     * @param {SequelizeDplDetector} databaseObject run object
     * @returns {MinifiedDplDetector} minified version of the dpl detector entity
     */
