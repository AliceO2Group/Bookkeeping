...
class DplProcessExecutionAdapter {
    ...
    toEntity(databaseObject) {
        const { id, hostId, processId, detectorId, runNumber, args, createdAt, updatedAt, detector, host, process, run } = databaseObject;
        ...
        return {
            ...
            detector: detector ? this.detectorAdapter.toEntity(detector) : null,
    ...
    toDatabase(entityObject) {
        const { id, hostId, processId, detectorId, runNumber, args, detector, host, process, run } = entityObject;
        ...
        return {
            ...
            runNumber,
            args,
            detector: detector ? this.detectorAdapter.toDatabase(detector) : null,
