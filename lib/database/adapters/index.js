...
const { DataPassVersionStatusAdapter } = require('./DataPassVersionStatusAdapter.js');
...
const { GaqSummaryInvalidationAdapter } = require('./GaqSummaryInvalidationAdapter.js');
...
const dataPassVersionStatusAdapter = new DataPassVersionStatusAdapter();
...
const gaqSummaryInvalidationAdapter = new GaqSummaryInvalidationAdapter();
...
// Fill dependencies
dataPassVersionAdapter.dataPassVersionStatusAdapter = dataPassVersionStatusAdapter;
