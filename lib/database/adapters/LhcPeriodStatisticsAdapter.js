...
class LhcPeriodStatisticsAdapter {
    ...
    toEntity(databaseObject) {
        const { id, avgCenterOfMassEnergy, distinctCenterOfMassEnergies, lhcPeriod } = databaseObject;
        const entity = { id, avgCenterOfMassEnergy, distinctCenterOfMassEnergies };
