...
class LhcPeriodStatisticsAdapter {
    ...
    toEntity(databaseObject) {
        const { id, name, runsCount, avgEnergy } = databaseObject.dataValues;
        return { id, name, runsCount, avgEnergy };
    }

    /**
     * Converts the given entity object to a database object.
     *
     * @param {LhcPeriodStatistics} entityObject Object to convert.
     * @returns {SequelizeLhcPeriodStatistics} Converted database object.
     */
    toDatabase({ id, name }) {
        return { id, name };
    }
