...
const _updateEffectivePeriodForScopeAndPeriod = async (
    ...
    const intersectingPeriodFrom = timestampToMysql(intersectingPeriodFromTimestamp);
    const intersectingPeriodTo = timestampToMysql(intersectingPeriodToTimestamp);
