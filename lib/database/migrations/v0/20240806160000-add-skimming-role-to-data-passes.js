...
module.exports = {
    up: async (queryInterface) => queryInterface.sequelize.transaction(async (transaction) => {
        ...
        `, { transaction, replacements: { skimmingStage: SkimmingStage.SKIMMING }, type: QueryTypes.UPDATE });
        ...
        `, { transaction, replacements: { skimmingStage: SkimmingStage.SKIMMED }, type: QueryTypes.UPDATE });
        ...
        SET dp.skimming_stage = :skimmingStage
    `, { transaction, replacements: { skimmingStage: SkimmingStage.POST_SKIMMED }, type: QueryTypes.UPDATE });
    }),
