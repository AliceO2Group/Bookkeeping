...
module.exports = {
    up: async (queryInterface) => queryInterface.sequelize.transaction(async (transaction) => {
        ...
        for (const { CONSTRAINT_NAME, TABLE_NAME } of constraints) {
            ...
            await queryInterface.sequelize.query(`ALTER TABLE ${TABLE_NAME} RENAME COLUMN dpl_detector_id TO detector_id`, { transaction, type: QueryTypes.RAW });
        }
    ...
    down: async (queryInterface) => queryInterface.sequelize.transaction(async (transaction) => {
        ...
        for (const { CONSTRAINT_NAME, TABLE_NAME } of constraints) {
            ...
            await queryInterface.sequelize.query(`ALTER TABLE ${TABLE_NAME} RENAME COLUMN detector_id TO dpl_detector_id`, { transaction, type: QueryTypes.RAW });
        }
