...
module.exports = {
    up: async (queryInterface) => queryInterface.sequelize.transaction(async (transaction) => {
         ...
         */
        const useDefaultGaqDetectorsForRunsWithGivenPdpBeamType = async (beamType, detectorsNames) =>
            queryInterface.sequelize.query(`
                ...
                SELECT dpr.data_pass_id, r.run_number, d.id
                    ...
                    INNER JOIN detectors AS d
                        ...
                        AND d.name IN (:detectorsNames)
            `, { transaction, replacements: { beamType, detectorsNames }, type: QueryTypes.INSERT });

        await useDefaultGaqDetectorsForRunsWithGivenPdpBeamType('pp', DEFAULT_GAQ_DETECTORS_FOR_PROTON_PROTON_RUNS);
        await useDefaultGaqDetectorsForRunsWithGivenPdpBeamType('PbPb', DEFAULT_GAQ_DETECTORS_FOR_LEAD_LEAD_RUNS);
    }),
