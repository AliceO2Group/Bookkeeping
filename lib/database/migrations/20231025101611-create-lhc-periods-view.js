...
const CREATE_RUNS_LHC_PERIODS_INDEX = `
    CREATE INDEX runs_lhc_period_ids
        ON runs(lhc_period_id)
;
`;

const DELETE_RUNS_LHC_PERIODS_INDEX = `
    DROP INDEX runs_lhc_period_ids
        ON runs
;
`;
...
module.exports = {
    up: async (queryInterface, Sequelize) => queryInterface.sequelize.transaction(async (transaction) => {
        ...
        await queryInterface.sequelize.query(CREATE_RUNS_LHC_PERIODS_INDEX, { transaction });
    }),
