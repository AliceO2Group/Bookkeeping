...
const BASIC_PARTICLES_PROPERTIES = { // 2 * sqrt(ATOMIC_MASS / ATOMIC_NUMBER)
...
SELECT  
    ...
    GROUP_CONCAT(DISTINCT(r.lhc_beam_energy)) AS distinct_energies
...
module.exports = {
    up: async (queryInterface, Sequelize) => queryInterface.sequelize.transaction(async (transaction) => {
        ...
        VALUES ${Object.entries(BASIC_PARTICLES_PROPERTIES)
