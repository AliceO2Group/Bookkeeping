...
const CREATE_qc_flag_block_significance_AGGREGATE_FUNCTION = `
...
const DROP_qc_flag_block_significance_AGGREGATE_FUNCTION = 'DROP FUNCTION qc_flag_block_significance';

const CREATE_qc_flag_block_significance_COVERAGE_AGGREGATE_FUNCTION = `
...
const DROP_qc_flag_block_significance_COVERAGE_AGGREGATE_FUNCTION = 'DROP FUNCTION qc_flag_block_significance_coverage';

/** @type {import('sequelize-cli').Migration} */
module.exports = {
    up: async (queryInterface) => queryInterface.sequelize.transaction(async (transaction) => {
        await queryInterface.sequelize.query(CREATE_GAQ_PERIODS_VIEW, { transaction });
        await queryInterface.sequelize.query(CREATE_qc_flag_block_significance_AGGREGATE_FUNCTION, { transaction });
        await queryInterface.sequelize.query(CREATE_qc_flag_block_significance_COVERAGE_AGGREGATE_FUNCTION, { transaction });
    }),

    down: async (queryInterface) => queryInterface.sequelize.transaction(async (transaction) => {
        await queryInterface.sequelize.query(DROP_GAQ_PERIODS_VIEW, { transaction });
        await queryInterface.sequelize.query(DROP_GAQ_PERIODS_VIEW, { transaction });
        await queryInterface.sequelize.query(DROP_qc_flag_block_significance_AGGREGATE_FUNCTION, { transaction });
        await queryInterface.sequelize.query(DROP_qc_flag_block_significance_COVERAGE_AGGREGATE_FUNCTION, { transaction });
    }),
};
