...
module.exports = {
    up: async (queryInterface) => queryInterface.sequelize.transaction(() =>
        queryInterface.sequelize.query(CREATE_QCF_BOUNDARIES_TRIGGER, { type: QueryTypes.RAW })),

    down: async (queryInterface) => queryInterface.sequelize.transaction(() =>
        queryInterface.sequelize.query(DROP_QCF_BOUNDARIES_TRIGGER, { type: QueryTypes.RAW })),
};
