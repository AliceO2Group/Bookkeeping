...
module.exports = {
    up: async (queryInterface) => queryInterface.sequelize.transaction(async (transaction) =>
        await queryInterface.sequelize.query(CREATE_QCF_BOUNDARIES_TRIGGER, { transaction })),

    down: async (queryInterface) => queryInterface.sequelize.transaction(async (transaction) => {
        await queryInterface.sequelize.query(DROP_QCF_BOUNDARIES_TRIGGER, { transaction });
    }),
};
