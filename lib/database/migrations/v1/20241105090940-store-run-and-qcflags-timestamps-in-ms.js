...
module.exports = {
    up: async (queryInterface, Sequelize) => queryInterface.sequelize.transaction(async (transaction) => {
        ...
        await queryInterface.sequelize.query(TIME_START_END_TO_DATETIME_3, { transaction, type: QueryTypes.RAW });
    }),
    ...
    down: async (queryInterface, Sequelize) => queryInterface.sequelize.transaction(async (transaction) => {
        ...
        await queryInterface.sequelize.query(TIME_START_END_TO_DATETIME, { transaction, type: QueryTypes.RAW });
    }),
};
