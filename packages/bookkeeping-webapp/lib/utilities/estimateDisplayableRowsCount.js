 ...
 * @param {number} [minRows=5] The minimum number of rows to be displayed
 *
 * @returns {number} The number of rows to be displayed with a minimum number of rows
 */
export const estimateDisplayableRowsCount = (rowHeight, usedPageHeight, minRows = 5) => Math.max(
    minRows,
