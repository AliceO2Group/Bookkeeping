...
void ArrayOfTagsResponse::validate()
{
    // TODO: implement validation
}

web::json::value ArrayOfTagsResponse::toJson() const
{
...
bool ArrayOfTagsResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ArrayOfTagsResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ArrayOfTagsResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
bool ArrayOfTagsResponse::dataIsSet() const
{
    return m_DataIsSet;
}

void ArrayOfTagsResponse::unsetData()
{
    m_DataIsSet = false;
}
}
