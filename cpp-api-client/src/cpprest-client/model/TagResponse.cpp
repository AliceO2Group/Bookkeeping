...
bool TagResponse::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("data"))))
    {
        ...
        {
            std::shared_ptr<Tag> refVal_data;
...
void TagResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TagResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<Tag> TagResponse::getData() const
{
    return m_Data;
}

void TagResponse::setData(const std::shared_ptr<Tag>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool TagResponse::dataIsSet() const
{
    return m_DataIsSet;
}

void TagResponse::unsetData()
{
    m_DataIsSet = false;
}
}
