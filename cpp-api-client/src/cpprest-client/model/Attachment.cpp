...
web::json::value Attachment::toJson() const
{
    ...
    {
        val[utility::conversions::to_string_t(U("originalName"))] = ModelBase::toJson(m_OriginalName);
    }
    if(m_PathIsSet)
    {
...
bool Attachment::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("originalName"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(U("originalName")));
        if(!fieldValue.is_null())
        {
...
void Attachment::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_OriginalNameIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("originalName")), m_OriginalName));
    }
    if(m_PathIsSet)
    {
...
bool Attachment::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    {
        utility::string_t refVal_encoding;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("encoding"))), refVal_encoding );
        setEncoding(refVal_encoding);
    }
    ...
    {
        int64_t refVal_logId;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("logId"))), refVal_logId );
        setLogId(refVal_logId);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(U("mimeType"))))
    {
        utility::string_t refVal_mimeType;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("mimeType"))), refVal_mimeType );
        setMimeType(refVal_mimeType);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(U("originalName"))))
    {
        utility::string_t refVal_originalName;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("originalName"))), refVal_originalName );
        setOriginalName(refVal_originalName);
    }
