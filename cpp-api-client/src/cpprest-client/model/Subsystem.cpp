...
int32_t Subsystem::getCreatedAt() const
{
    return m_CreatedAt;
}

void Subsystem::setCreatedAt(int32_t value)
{
    m_CreatedAt = value;
...
int32_t Subsystem::getUpdatedAt() const
{
    return m_UpdatedAt;
}

void Subsystem::setUpdatedAt(int32_t value)
{
    m_UpdatedAt = value;
