...
pplx::task<std::shared_ptr<AttachmentResponse>> LogApi::getLogAttachment(int32_t logId, int32_t attachmentId) const
{
    ...
    std::shared_ptr<const ApiConfiguration> localVarApiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t localVarPath = utility::conversions::to_string_t("/logs/{logId}/attachments/{attachmentId}");
    boost::replace_all(localVarPath, utility::conversions::to_string_t("{") + utility::conversions::to_string_t("logId") + utility::conversions::to_string_t("}"), ApiClient::parameterToString(logId));
boost::replace_all(localVarPath, utility::conversions::to_string_t("{") + utility::conversions::to_string_t("attachmentId") + utility::conversions::to_string_t("}"), ApiClient::parameterToString(attachmentId));
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("LogApi->getLogAttachment does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("LogApi->getLogAttachment does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response localVarResponse)
    {
        ...
        {
            throw ApiException(localVarResponse.status_code()
                , utility::conversions::to_string_t("error calling getLogAttachment: ") + localVarResponse.reason_phrase()
                , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
        }
        ...
        if(localVarResponse.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling getLogAttachment: unexpected response type: ") + localVarContentType
                    , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=](utility::string_t localVarResponse)
    {
        std::shared_ptr<AttachmentResponse> localVarResult(new AttachmentResponse());
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling getLogAttachment: unsupported response type"));
        }
...
pplx::task<std::shared_ptr<LogResponse>> LogApi::getLogById(int32_t logId) const
{
    ...
    std::shared_ptr<const ApiConfiguration> localVarApiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t localVarPath = utility::conversions::to_string_t("/logs/{logId}");
    boost::replace_all(localVarPath, utility::conversions::to_string_t("{") + utility::conversions::to_string_t("logId") + utility::conversions::to_string_t("}"), ApiClient::parameterToString(logId));
...
pplx::task<std::shared_ptr<LogTreeResponse>> LogApi::getLogTree(int32_t logId) const
{
    ...
    std::shared_ptr<const ApiConfiguration> localVarApiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t localVarPath = utility::conversions::to_string_t("/logs/{logId}/tree");
    boost::replace_all(localVarPath, utility::conversions::to_string_t("{") + utility::conversions::to_string_t("logId") + utility::conversions::to_string_t("}"), ApiClient::parameterToString(logId));
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("LogApi->getLogTree does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("LogApi->getLogTree does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response localVarResponse)
    {
        ...
        {
            throw ApiException(localVarResponse.status_code()
                , utility::conversions::to_string_t("error calling getLogTree: ") + localVarResponse.reason_phrase()
                , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
        }
        ...
        if(localVarResponse.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling getLogTree: unexpected response type: ") + localVarContentType
                    , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=](utility::string_t localVarResponse)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling getLogTree: unsupported response type"));
        }
...
pplx::task<std::shared_ptr<ArrayOfAttachmentsResponse>> LogApi::listLogAttachments(int32_t logId) const
{
    ...
    std::shared_ptr<const ApiConfiguration> localVarApiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t localVarPath = utility::conversions::to_string_t("/logs/{logId}/attachments");
    boost::replace_all(localVarPath, utility::conversions::to_string_t("{") + utility::conversions::to_string_t("logId") + utility::conversions::to_string_t("}"), ApiClient::parameterToString(logId));
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("LogApi->listLogAttachments does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("LogApi->listLogAttachments does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response localVarResponse)
    {
        ...
        {
            throw ApiException(localVarResponse.status_code()
                , utility::conversions::to_string_t("error calling listLogAttachments: ") + localVarResponse.reason_phrase()
                , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
        }
        ...
        if(localVarResponse.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling listLogAttachments: unexpected response type: ") + localVarContentType
                    , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=](utility::string_t localVarResponse)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling listLogAttachments: unsupported response type"));
        }
...
pplx::task<std::shared_ptr<ArrayOfTagsResponse>> LogApi::listTagsByLogId(int32_t logId) const
{
    ...
    std::shared_ptr<const ApiConfiguration> localVarApiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t localVarPath = utility::conversions::to_string_t("/logs/{logId}/tags");
    boost::replace_all(localVarPath, utility::conversions::to_string_t("{") + utility::conversions::to_string_t("logId") + utility::conversions::to_string_t("}"), ApiClient::parameterToString(logId));
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("LogApi->listTagsByLogId does not produce any supported media type"));
    }
    ...
    .then([=](web::http::http_response localVarResponse)
    {
        ...
        {
            throw ApiException(localVarResponse.status_code()
                , utility::conversions::to_string_t("error calling listTagsByLogId: ") + localVarResponse.reason_phrase()
                , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
        }
        ...
        if(localVarResponse.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling listTagsByLogId: unexpected response type: ") + localVarContentType
                    , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=](utility::string_t localVarResponse)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling listTagsByLogId: unsupported response type"));
        }
