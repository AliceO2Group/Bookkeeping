...
#include "BookkeepingApiCpp/BookkeepingApi.h"
#include "BookkeepingApiCpp/CreateLogParameters.h"
...
int main(int argc, char const *argv[])
{
    ...
    std::string apiToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MCwidXNlcm5hbWUiOiJBbm9ueW1vdXMiLCJhY2Nlc3MiOjAsImlhdCI6MTYxNzkxMjc1NSwiZXhwIjoxNjQ5NDcwMzU1LCJpc3MiOiJvMi11aSJ9.fRqXPBasKMxJuvH0C31sMmAsn3GeMyOChO6OoOYLvpM";
