...
{
GrpcDplProcessExecutionClient::GrpcDplProcessExecutionClient(const std::shared_ptr<::grpc::ChannelInterface>& channel, const std::shared_ptr<::grpc::ClientContext>& clientContext)
{
  ...
  std::string detector)
{
  ...
  auto status = mStub->Create(mClientContext.get(), *request, response.get());
