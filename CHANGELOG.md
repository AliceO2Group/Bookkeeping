...
* Notable changes for users:
  * DPL processes executions can be inserted concurrently in bookkeeping
  ...
  * Further improves the style of the log details page, following from [O2B-927](https://github.com/AliceO2Group/Bookkeeping/pull/1061) Hide duplicated and verbose information in log tree view #1061
