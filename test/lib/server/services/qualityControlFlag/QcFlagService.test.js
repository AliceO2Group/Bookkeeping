...
module.exports = () => {
    ...
    describe('Creating Quality Control Flag for data pass', () => {
        ...
        it('should fail to create quality control flag due to qc flag `from` timestamp is smaller than run.startTime', async () => {
            const qcFlagCreationParameters = {
        ...
        it('should fail to create quality control flag due to qc flag `to` timestamp is greater than run.stopTime', async () => {
            const qcFlagCreationParameters = {
