...
const { run: { GetRunUseCase } } = require('../../../../backend/usecases/index.js');
const { dtos: { GetRunDto } } = require('../../../../backend/domain/index.js');
...
module.exports = () => {
    ...
    it('should return an object that has the `id` property and includes tags, eorReasons and detectors qualities', async () => {
        ...
        expect(result.lhcPeriod).to.be.eql({ id: 2, name: 'LHC22b' });
