...
const { subsystem: { CreateSubsystemUseCase, DeleteSubsystemUseCase } } = require('../../../../backend/usecases/index.js');
const { dtos: { CreateSubsystemDto } } = require('../../../../backend/domain/index.js');
