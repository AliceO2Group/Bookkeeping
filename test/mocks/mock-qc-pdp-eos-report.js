...
### COMMISSIONING
- [200](http://localhost:4000?page=run-detail&runNumber=108) - 01:02:03 - good
    * Detectors: -
    * Detectors QC bad: -
    * EOR:
...
### TECHNICAL
- [201](http://localhost:4000?page=run-detail&runNumber=109) - 01:02:03 - good
    * Detectors: \`ITS\`, \`TST\`
    * Detectors QC bad: \`TST\`
- [202](http://localhost:4000?page=run-detail&runNumber=110) - 01:02:03 - bad
    * Detectors: \`FT0\`, \`TST\`
