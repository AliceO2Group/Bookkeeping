...
### COMMISSIONING
- [200](http://localhost:4000?page=run-detail&runNumber=200) - 00:00:00 - good
    * Detectors: -
    * Detectors QC bad: -
    * EOR:
...
### TECHNICAL
- [201](http://localhost:4000?page=run-detail&runNumber=201) - 00:00:00 - good
    * Detectors: \`ITS\`, \`TST\`
    * Detectors QC bad: \`TST\`
- [202](http://localhost:4000?page=run-detail&runNumber=202) - 00:00:00 - bad
    * Detectors: \`FT0\`, \`TST\`
