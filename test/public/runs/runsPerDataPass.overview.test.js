...
module.exports = () => {
    ...
    it('should successfuly apply EPNs filter', async () => {
        await goToPage(page, 'runs-per-data-pass', { queryParameters: { dataPassId: 2 } });
        await pressElement(page, '#openFilterToggle');
    ...
    it('should successfuly apply FLPs filter', async () => {
        await goToPage(page, 'runs-per-data-pass', { queryParameters: { dataPassId: 2 } });
        await pressElement(page, '#openFilterToggle');

        await page.select('.FLPs-filter select', '>=');
        await fillInput(page, '.FLPs-filter input[type=number]', '11');
        await expectColumnValues(page, 'runNumber,', ['55']);
    ...
    it('should successfuly apply dd_flp filter', async () => {
        await goToPage(page, 'runs-per-data-pass', { queryParameters: { dataPassId: 2 } });
        await pressElement(page, '#openFilterToggle');

        await pressElement(page, '.dd_flp-filter #ddFlpFilterRadioON');
        await expectColumnValues(page, 'runNumber,', ['55']);
    ...
    it('should successfuly apply DCS filter', async () => {
        await goToPage(page, 'runs-per-data-pass', { queryParameters: { dataPassId: 2 } });
        await pressElement(page, '#openFilterToggle');

        await pressElement(page, '.DCS-filter #dcsFilterRadioOFF');
        await expectColumnValues(page, 'runNumber,', ['2']);

        await pressElement(page, '#reset-filters');
        await expectColumnValues(page, 'runNumber', ['55', '2', '1']);
    });

    it('should successfuly apply odcTopologyFullName filter', async () => {
        await goToPage(page, 'runs-per-data-pass', { queryParameters: { dataPassId: 2 } });
        await pressElement(page, '#openFilterToggle');

        await fillInput(page, '.odcTopologyFullName-filter input', 'hash');
    ...
    it('should successfuly apply eorReasons filter', async () => {
        await goToPage(page, 'runs-per-data-pass', { queryParameters: { dataPassId: 2 } });
        await pressElement(page, '#openFilterToggle');

        await page.select('.eorReasons-filter select', 'DETECTORS');
        await expectColumnValues(page, 'runNumber,', ['1']);
