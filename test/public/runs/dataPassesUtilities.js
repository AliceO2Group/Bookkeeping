...
exports.navigateToRunsPerDataPass = async (page, lhcPeriodId, dataPassId, expectedRowsCount) => {
    ...
    const pdpBeamTypes = await getInnerText(await page.waitForSelector(`#row${lhcPeriodId}-pdpBeamTypes`));
    ...
    expectUrlParams(page, { page: 'runs-per-data-pass', dataPassId, pdpBeamTypes });
