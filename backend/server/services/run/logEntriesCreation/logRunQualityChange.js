 ...
 * @param {string} changeReason the reason of the run quality change
 * @param {string} lhcPeriodName the LHC period of the run
 * @return {Promise<void>} resolve when log has been created
 * @private
 */
exports.logRunQualityChange = async (
    runNumber,
    previousQuality,
    newQuality,
    transaction,
    ...
    const textParts =
        [`The run quality for run ${runNumber} from period ${lhcPeriodName} has been changed from ${previousQuality} to ${newQuality}`];
